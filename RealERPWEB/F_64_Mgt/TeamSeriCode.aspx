<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="TeamSeriCode.aspx.cs" Inherits="RealERPWEB.F_64_Mgt.TeamSeriCode" %>
                ...
                <div class="contentPart">
                    ...
                    <div class="row">
                        <asp:GridView ID="grvacc" runat="server" AllowPaging="True"
                            ...
                            OnRowUpdating="grvacc_RowUpdating" Width="572px" ShowFooter="True" CssClass="table-striped table-hover table-bordered grvContentarea" PageSize="15">
                                ...
                                <asp:TemplateField HeaderText=" ">
                                    <ItemTemplate>
                                        <asp:Label ID="lblgrcode" runat="server"
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "teamcode2"))+"-" %>'
                                ...
                                <asp:TemplateField HeaderText="Team Head">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtteamhead" runat="server" BorderStyle="None"
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "teamhdesc")) %>'
                                            Width="150px"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
