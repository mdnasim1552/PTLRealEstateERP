<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="ActivitiesCode.aspx.cs" Inherits="RealERPWEB.F_64_Mgt.ActivitiesCode" %>
                ...
                <div class="contentPart">
                    ...
                    <div class="row">
                        <asp:GridView ID="grvacc" runat="server" AllowPaging="True"
                            ...
                            OnRowUpdating="grvacc_RowUpdating" Width="572px" ShowFooter="True" CssClass="table-striped table-hover table-bordered grvContentarea" PageSize="15" OnPageIndexChanging="grvacc_PageIndexChanging" OnRowDataBound="grvacc_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Duration" Visible="false">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtgvduration" runat="server" 
