<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptInterMatTransStatus.aspx.cs" Inherits="RealERPWEB.F_12_Inv.RptInterMatTransStatus" %>
            ...
            <div class="container moduleItemWrpper">
                <div class="contentPart">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="grvacc" runat="server" AllowPaging="false" CssClass=" table-striped table-hover table-bordered grvContentarea"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Qty.">
                               ...
                               <asp:TemplateField HeaderText="Rate.">
                                ...
                                <FooterTemplate>
                                    <asp:Label ID="lblFrate" runat="server" Font-Size="11px" Height="16px"
