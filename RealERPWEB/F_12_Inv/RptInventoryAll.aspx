<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="RptInventoryAll.aspx.cs" Inherits="RealERPWEB.F_12_Inv.RptInventoryAll" %>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlReport" runat="server" CssClass="custom-select  chzn-select">
                                    <asp:ListItem Value="amtbasis">Inventory Report-Amount Basis</asp:ListItem>
                                    <asp:ListItem Value="qtybasis">Inventory Report-Quantity Basis</asp:ListItem>
                                    <asp:ListItem Value="amtbasisp">Inventory Report-Amount Basis(Periodic)</asp:ListItem>
                            ...
                            <asp:GridView ID="gvMatStock" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvMatStock_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Budgeted <br/> Consumption">
                                        <ItemTemplate>
                                            <asp:Label ID="lgvbgdconuamt" runat="server"
                                                Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "bgdconamt")).ToString("#,##0;(#,##0); ")%>'
                                                Width="85px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Budgeted Stock">
                                        <ItemTemplate>
                                            <asp:Label ID="lgvbgdstkamt" runat="server"
                                                Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "bgdstock")).ToString("#,##0;(#,##0); ")%>'
                                                Width="85px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Variance">
                                        <ItemTemplate>
                                            <asp:Label ID="lgvvaramt" runat="server"
                                                Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "varamt")).ToString("#,##0;(#,##0); ")%>'
                                    ...
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlnkqtyBasis" runat="server" BorderColor="#99CCFF" BorderStyle="none"
                                                Font-Size="11px" Style="background-color: Transparent;" Font-Underline="false" Target="_blank" Width="50px">Qty Basis                                                
                                            </asp:HyperLink>
                                        </ItemTemplate>
