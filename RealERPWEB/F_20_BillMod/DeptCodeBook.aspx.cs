...
namespace RealERPWEB.F_20_BillMod
{
    ...
    public partial class DeptCodeBook : System.Web.UI.Page
    {
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "GETBILLCODEBOOK",
                                "", "", "", "", "", "", "", "", "");
        ...
        protected void gvPaySch_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            if (((TextBox)gvPaySch.Rows[e.RowIndex].FindControl("txtgrcode")).Text.Trim().Length == 3)
            {
                //Hashtable hst = (Hashtable)Session["tblLogin"];
                ...
                bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "INSERTUPBILLGINF", tgcod,
                               gdesc, "", "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "SHOWBILLDATA", tempddl1,
                            tempddl2, "", "", "", "", "", "", "");
