...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="UserLoginfrm.aspx.cs" Inherits="RealERPWEB.F_41_GAcc.UserLoginfrm" %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:CheckBox ID="chkShowall" runat="server" Font-Bold="True" Font-Size="12px" 
                                                        ...
                                                        oncheckedchanged="chkShowall_CheckedChanged" Width="70px" />
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblModNmae" runat="server" Font-Bold="True" Font-Size="12px" 
                                                        style="color: #FFFFFF; text-align: right;" Text="Module Name:" 
                                                        Width="80px"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlModName" runat="server" Font-Bold="True" 
                                                        Font-Size="12px" Width="210px" AutoPostBack="True" 
                                                        onselectedindexchanged="ddlModName_SelectedIndexChanged">
                                                        <asp:ListItem Value="00">All</asp:ListItem>
                                                        <asp:ListItem Value="30">Accounts</asp:ListItem>
                                                        <asp:ListItem Value="31">MIS</asp:ListItem>
                                                        <asp:ListItem Value="32">Management</asp:ListItem>
                                            ...
                                            <asp:TemplateField HeaderText="Description">
                                                <ItemTemplate>
                                                    <asp:Label ID="lgvDescription" runat="server" 
                                                      Text='<%# "<B>"+ Convert.ToString(DataBinder.Eval(Container.DataItem, "modulename")) + "</B>"+
                                            ...
                                            <asp:TemplateField HeaderText="View/Show">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkPermit" runat="server" 
                                                        Checked='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "chkper"))=="True" %>' Width="50px"/>
                                                </ItemTemplate>
                                                <FooterStyle Font-Bold="True" HorizontalAlign="Left" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Entry/Edit">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkEntry" runat="server" 
                                                        Checked='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "entry"))=="True" %>' Width="50px"/>
                                                </ItemTemplate>
                                                <FooterStyle Font-Bold="True" HorizontalAlign="Left" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Print">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkPrint" runat="server" 
                                                        Checked='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "printable"))=="True" %>' Width="50px"/>
                                                </ItemTemplate>
                                                <FooterStyle Font-Bold="True" HorizontalAlign="Left" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            </asp:TemplateField>
