<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="TasGenCodeBook.aspx.cs" Inherits="RealERPWEB.F_07_Ten.TasGenCodeBook" %>
                ...
                <div class="contentPart">
                    <div class="row">
                        ...
                        <asp:GridView ID="grvacc" runat="server" AllowPaging="True"
                            ...
                            OnRowUpdating="grvacc_RowUpdating" ShowFooter="True" CssClass="table table-striped table-hover table-bordered grvContentarea" Width="476px">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Unit">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblunit" runat="server" Font-Size="12px"
                                            Style="font-size: 12px"
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "gunit")) %>'
                                ...
                                <asp:TemplateField HeaderText="%">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtgvamt" runat="server" Font-Size="12px" MaxLength="100"
                                            Style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none; font-size: 12px; border-left-color: midnightblue; border-bottom-color: midnightblue; border-top-color: midnightblue; border-right-color: midnightblue;"
