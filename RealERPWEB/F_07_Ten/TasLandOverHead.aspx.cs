...
{
    public partial class TasLandOverHead : System.Web.UI.Page
    {
        ...
        protected void GetMainBudgetData()
        {
            ...
            string filter = (this.txtSearch.Text.Trim() == "") ? "%" : "%" + this.txtSearch.Text.Trim() + "%";
            DataSet ds1 = accData.GetTransInfo(comcod, "SP_ENTRY_ACCOUNTS_BUDGET", "GETMAINTASINFO", filter, "", "", "", "", "", "", "", "");
