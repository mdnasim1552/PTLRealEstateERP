...
{
    public partial class TasQuotEntry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Tender-Quotation";
        ...
        private void ShowProWSalRate()
        {
            ...
            ds1 = ImpleData.GetTransInfo(comcod, "SP_ENTRY_BILLMGT", "GETTASQUOTATION", PrjCod, "", "", "", "", "", "", "", "");
        ...
        protected void ImgbtnFindProject_OnClick(object sender, EventArgs e)
        {
            ...
            string srchTxt = (qprjcode.Length > 0 ? qprjcode  : ("%" + this.txtProjectSearch.Text.Trim()))+ "%";
            string calltype;
            ...
            DataSet ds1 = ImpleData.GetTransInfo(comcod, "SP_ENTRY_PRJ_BUDGET", "TASPRJLIST", srchTxt, "", "", "", "", "", "", "", "");
        ...
        private void SaveValue()
        {
            ...
            for (int i = 0; i < gvRptResBasis.Rows.Count; i++)
            {
                ...
                double qty = Convert.ToDouble("0" + ((TextBox)this.gvRptResBasis.Rows[i].FindControl("txtgvqty")).Text.Trim());
                double rate = Convert.ToDouble("0" + ((TextBox)this.gvRptResBasis.Rows[i].FindControl("txtbillrate")).Text.Trim());
                string sdetails = ((TextBox)this.gvRptResBasis.Rows[i].FindControl("txtgvdetdesc")).Text.Trim();
                ...
                dt1.Rows[TblRowIndex]["sdetails"] = sdetails;
        ...
        protected void lnkfinalup_Click(object sender, EventArgs e)
        {
            ...
            bool result = ImpleData.UpdateXmlTransInfo(comcod, "SP_ENTRY_BILLMGT", "INSERTORUPDATETASQUOTINF", ds1, null, null,
                   pactcode, "", "", "", "", "", "", "", "", "", "", "");
        ...
        protected void gvRptResBasis_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            if (gvRow.RowType == DataControlRowType.Header)
            {
                ...
                TableCell cell02a = new TableCell();
                cell02a.Text = "Details";
                cell02a.HorizontalAlign = HorizontalAlign.Center;
                cell02a.RowSpan = 2;

                TableCell cell03 = new TableCell();
                cell03.Text = "Catagory";
