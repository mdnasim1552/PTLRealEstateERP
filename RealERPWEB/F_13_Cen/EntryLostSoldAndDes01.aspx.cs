...
{
    public partial class EntryLostSoldAndDes01 : System.Web.UI.Page
    {
        ...
        private void GetProjectName()
        {
            ...
            DataSet ds2 = purData.GetTransInfo(comcod, "SP_ENTRY_REQ_CENSTORE", "GETPROJECT01", Srchname, "", "", "", "", "", "", "", "");
            if (ds2 == null)
                return;
        ...
        {
            string comcod = this.GetCompCode();
            string ProjectCode = this.ddlProject.SelectedValue.ToString().Trim();
            string FindResDesc = this.txtResSearch.Text.Trim() + "%";
            string curdate = this.txtCurDate.Text.ToString().Trim();

            DataSet ds1 = purData.GetTransInfo(comcod, "SP_ENTRY_REQ_CENSTORE", "GETMETERIALS", ProjectCode, curdate, FindResDesc, "", "", "", "", "", "");
            Session["Matlist"] = ds1.Tables[0];
        ...
        private void SaveValue()
        {
            ...
            for (int i = 0; i < this.grvacc.Rows.Count; i++)
            {
                ...
                double rate = Convert.ToDouble("0" + ((TextBox)this.grvacc.Rows[i].FindControl("lblgvstkrate")).Text.Trim());
                ...
                //Added
                dt1.Rows[rowindex]["stkrate"] = rate;
            }
        ...
        protected void lbtnSelect_Click(object sender, EventArgs e)
        {
            ...
            if (dr2.Length == 0)
            {
                ...
                DataTable tbl2 = (DataTable)Session["Matlist"];
                ...
                dr1["stkqty"] = dr3[0]["balqty"];
                dr1["stkrate"] = dr3[0]["rate"]; ;
                dr1["lqty"] = 0;
                dr1["sqty"] = 0;
                dr1["dqty"] = 0;
                dr1["lsdam"] = 0;
