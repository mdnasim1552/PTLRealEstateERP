<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptBgdPrjojectNew.aspx.cs" Inherits="RealERPWEB.F_04_Bgd.RptBgdPrjojectNew" %>
                            ...
                            <fieldset class="scheduler-border fieldset_A">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class=" col-md-2  pading5px" runat="server" visible="false" id="rptgrp">

                                            <asp:Label ID="Label2" CssClass="smLbl_to" runat="server" Text="Report"></asp:Label>
                                            <asp:DropDownList ID="ddlReport" runat="server" CssClass="ddlPage" AutoPostBack="true" OnSelectedIndexChanged="ddlReport_SelectedIndexChanged">
