...
{
    public partial class RptBgdPrjoject : System.Web.UI.Page
    {
        ...
        private void GetProjectName()
        {
            ...
            this.ddlProjectName.SelectedValue = this.Request.QueryString["prjcod"];
        }
        ...
        private void showMstrBgdGrWise()
        {
            ...
            if (ds2.Tables[1].Rows.Count > 0)
            {
                this.lblConAreagrwise.Text = txtconarea + Convert.ToDouble(ds2.Tables[1].Rows[0]["conarea"]).ToString("#,##0; (#,##0); ") + " " + ds2.Tables[1].Rows[0]["conunit"].ToString();
                this.lblSalAreagrwise.Text = "Saleable Area: " + Convert.ToDouble(ds2.Tables[1].Rows[0]["salarea"]).ToString("#,##0; (#,##0); ") + " " + ds2.Tables[1].Rows[0]["salunit"].ToString();
            }
            else
            {
                this.lblConAreagrwise.Text = txtconarea;
                this.lblSalAreagrwise.Text = "Saleable Area:";
            }
