<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="BgdPrjAna.aspx.cs" Inherits="RealERPWEB.F_04_Bgd.BgdPrjAna" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function pageLoaded() {
            ...
            try {
                ...
                $('#<%=this.gvSpRpt.ClientID%>').tblScrollable();
                $('#<%=this.gvResInfo.ClientID%>').tblScrollable();
                $('#<%=this.gvAnalysis.ClientID%>').tblScrollable();
                ...
                <div class="card-header mt-2 mb-0 pb-0">
                        ...
                        <div class="col-md-2">
                            <div class="input-group input-group-alt">
                                <div class="input-group-prepend ">
                                    <asp:Label ID="Label6" runat="server" CssClass="btn btn-secondary btn-sm">Project Name:</asp:Label>
                                </div>
                                <asp:TextBox ID="txtProjectSearch" Style="height: 29px" runat="server" CssClass="form-control" placeholder="Search.."></asp:TextBox>
                                ...
                                <asp:LinkButton ID="ImgbtnFindProject" runat="server" OnClick="ImgbtnFindProject_Click" CssClass="btn btn-primary btn-sm" Style="float: left; margin-left: 1px"><i class="fa fa-search"></i></asp:LinkButton>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="input-group input-group-alt">
                                <asp:DropDownList ID="ddlProject" data-placeholder="Choose Information.." ClientIDMode="Static" runat="server" CssClass="select2 form-control" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="input-group input-group-alt">
                                <asp:LinkButton ID="lbtnOk1" runat="server" CssClass="btn  btn-primary  btn-sm float-left" OnClick="lbtnOk1_Click" Text="OK"></asp:LinkButton>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <asp:CheckBox ID="ChkCopyTender" runat="server" AutoPostBack="True" Text="Copy Tender" CssClass="btn btn-primary primaryBtn chkBoxControl"
                    ...
                    <div class="row form-group mt-0">
                        ...
                        <asp:RadioButtonList ID="rbtnList1" runat="server" AutoPostBack="True"
                            Font-Bold="True" Font-Size="12px" ForeColor="Black" Visible="false" CssClass="rbtResponsive"
                    ...
                    <fieldset class="scheduler-border fieldset_A">
                        ...
                        <asp:Panel ID="pnlspclrpt02" runat="server" Visible="false">
                            <div class="row form-group">
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddldetails" runat="server" CssClass="select2 form-control" ClientIDMode="Static">
                                        <asp:ListItem Value="Main" Text="Main"></asp:ListItem>
                                        <asp:ListItem Value="Sub" Text="Sub"></asp:ListItem>
                                        <asp:ListItem Value="Details" Text="Details" Selected="True"></asp:ListItem>
                                    </asp:DropDownList>
                                ...
                                <div class="col-md-1">
                                    <asp:LinkButton ID="lbtnshow" runat="server" CssClass="btn btn-success btn-sm" OnClick="lbtnshow_OnClick">Show</asp:LinkButton>
                                </div>
                            </div>
                        </asp:Panel>
                        <asp:Panel ID="PnlCopyProject" runat="server" Visible="False">
                            <div class="form-group">
                                ...
                                <div class="col-md-1 pading5px">
                                    <asp:CheckBox ID="chkwithoutqty" runat="server" Text="Without Qty" CssClass="btn btn-primary primaryBtn chkBoxControl" />
                                </div>
                            </div>
                        </asp:Panel>
                        <asp:Panel ID="PnlCopyTender" runat="server" Visible="False">
                            <div class="form-group">
                                ...
                                <div class="col-md-1 pading5px">
                                    <asp:CheckBox ID="Chknoqty" runat="server" Text="Without Qty" CssClass="btn btn-primary primaryBtn chkBoxControl" />
                                </div>
                            </div>
                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        <asp:View ID="View1Floor" runat="server">
                            <div class="row form-group">
                                <div class="input-group input-group-alt">
                                    <div class="input-group-prepend ">
                                        <asp:Label ID="lblFPhaseTitle" runat="server" CssClass="btn btn-secondary" Text="Catagory Selection"></asp:Label>
                                    </div>
                                    <asp:CheckBox ID="chkFlrShowSelected" runat="server" AutoPostBack="True" CssClass="btn btn-secondary chkBoxControl rbtResponsive"
                        ...
                        <asp:View ID="View2Item" runat="server">
                            <div class="row form-group">
                                <div class="col-md-3">
                                    <div class="input-group input-group-alt">
                                        <asp:Label ID="lblTitle1" runat="server" CssClass="btn btn-success primaryBtn" Text="Item Selection (All Catagory)"></asp:Label>
                                        <asp:HyperLink ID="lnkbtnAnalysis" runat="server" CssClass="btn  btn-primary primaryBtn" Style="margin: 0 5px;" NavigateUrl="~/F_04_Bgd/BgdStdAna.aspx" Target="_blank"><span class="flaticon-edit26">Analysis</span> 
                                        </asp:HyperLink>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col-md-1">
                                    <asp:Label ID="lblgroupwrk" runat="server" CssClass="form-control" Style="height: 30px">Groups </asp:Label>
                                </div>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlgroupwrk" runat="server" CssClass="select2 form-control" AutoPostBack="True" OnSelectedIndexChanged="dddlgroupwrk_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-2">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="Label9" runat="server" CssClass="btn btn-secondary btn-sm">Desc. of Items</asp:Label>
                                        </div>
                                        <asp:TextBox ID="txtItemSearch" runat="server" Style="height: 29px" CssClass="form-control" placeholder="Search.."></asp:TextBox>
                                        <asp:LinkButton ID="ImgbtnFindItem" CssClass="btn btn-primary btn-sm" runat="server" OnClick="ImgbtnFindItem_Click" Style="float: left; margin-left: 1px"><i class="fa fa-search"></i></asp:LinkButton>

                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlItem" runat="server" CssClass="select2 form-control">
                                    </asp:DropDownList>
                                ...
                                <div class="col-md-2">
                                    <asp:LinkButton ID="lbtnSelectItem" runat="server" CssClass="btn btn-primary primaryBtn" OnClick="lbtnSelectItem_Click" Style="height: 30px">Select Item</asp:LinkButton>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="Label8" runat="server" CssClass="btn btn-secondary btn-sm">Page Size :</asp:Label>
                                        </div>
                                        <asp:DropDownList ID="ddlpagesizeen" runat="server" AutoPostBack="True" CssClass="ddlpage"
                                            OnSelectedIndexChanged="ddlpagesizeen_SelectedIndexChanged">
                            ...
                            <div id="divGridView">
                                <div class="table-responsive">
                                    <asp:GridView ID="gvAnalysis" runat="server" AllowPaging="false"
                                        ...
                                        <Columns>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="hlbtntbCdataExel" runat="server"
                                                                    CssClass="btn btn-success btn-xs" ToolTip="Export Excel">
                                            ...
                                            <asp:TemplateField HeaderText="Description of Item" SortExpression="isirdesc">
                                                <HeaderTemplate>
                                                    <asp:TextBox ID="txtSearchItmDesc" BackColor="Transparent" BorderStyle="None" runat="server" Width="350px" placeholder="Description of Item" onkeyup="Search_Gridview(this,2)"></asp:TextBox>
                                                    <br />
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Ref. No.">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtgvgvItmRef" runat="server" BorderColor="#99CCFF"
                                                                                    ...
                                                                                    Width="80px" Font-Size="12px" Style="text-align: left">
                                                                                </asp:TextBox>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:LinkButton ID="lbtngvgvRefresh" runat="server" Font-Bold="True"
                                                                                    Font-Size="12px" OnClick="lbtngvgvRefresh_Click">
                                                ...
                                                <HeaderTemplate>
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:LinkButton ID="ImgbtngrdFindItem" runat="server" CssClass="btn btn-primary btn-sm" OnClick="ImgbtngrdFindItem_Click" TabIndex="2"><i class="fa fa-search"></i></span></asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </HeaderTemplate>
                        ...
                        <asp:View ID="View3Item" runat="server">
                            <div class="row form-group">
                                ...
                                <div class="col-md-1 text3-right">
                                    <asp:Label ID="lblItem7" runat="server" CssClass="btn btn-secondary btn-sm float-right">Floor</asp:Label>
                                </div>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlFloorList" runat="server" CssClass="select2 form-control"></asp:DropDownList>
                                </div>
                                <div class="col-md-2">
                                    <asp:LinkButton ID="lbtnSelectFloor" runat="server" CssClass="btn btn-primary btn-sm" OnClick="lbtnSelectFloor_Click">Select Floor P/U</asp:LinkButton>
                                </div>
                                <div class="col-md-1">
                                    <asp:CheckBox ID="ChkCopy" runat="server" AutoPostBack="True" OnCheckedChanged="ChkCopy_CheckedChanged" Text="Copy"
                                        Visible="False" CssClass="btn btn-primary btn-sm float-right" />
                                </div>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlFloorListToCopy" runat="server" CssClass="select2 form-control">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-1">
                                    <asp:LinkButton ID="lbtnCopyData" runat="server" CssClass="btn btn-primary btn-sm float-left" OnClick="lbtnCopyData_Click">Copy Data </asp:LinkButton>
                                </div>
                            </div>

                            <div class="row form-group">
                                <div class="col-md-2">
                                    <asp:Label ID="lblItem2" runat="server" CssClass="btn btn-success btn-sm">Description of Items</asp:Label>
                                </div>
                                <div class="col-md-1">
                                    <div class="input-group input-group-alt">
                                        <asp:TextBox ID="txtItemSearch2" Style="height: 29px" runat="server" CssClass="form-control" placeholder="Search.."></asp:TextBox>
                                        <asp:LinkButton ID="ImgbtnFindItem2" runat="server" OnClick="ImgbtnFindItem_Click" CssClass="btn btn-primary btn-sm" Style="float: left; margin-left: 1px"><i class="fa fa-search"></i></asp:LinkButton>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <asp:DropDownList ID="ddlItem2" runat="server" CssClass="select2 form-control">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-2">
                                    <asp:LinkButton ID="lbtnSelectItem2" runat="server" CssClass="btn btn-primary btn-sm" OnClick="lbtnSelectItem2_Click">Select Item</asp:LinkButton>
                                </div>
                        ...
                        <asp:View ID="View4Resource" runat="server">
                            <div class="row form-group">
                                <div class="col-md-3">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="lblTitle2" runat="server" CssClass="btn btn-secondary btn-sm">Resource Rate Input:</asp:Label>
                                        </div>
                                        <asp:TextBox ID="txtSearchItem" Style="height: 29px" runat="server" CssClass="form-control" placeholder="Search.."></asp:TextBox>
                                        <asp:LinkButton ID="lbtnSelectFloorRes" runat="server" OnClick="lbtnSelectFloorRes_Click" CssClass="btn btn-primary btn-sm">Show</asp:LinkButton>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvResInfo" runat="server" AllowPaging="false" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ...
                                    Width="16px" ShowFooter="True" OnRowDataBound="gvResInfo_RowDataBound" OnRowUpdating="gvResInfo_RowUpdating">
                                    <RowStyle />
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sl.No.">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Est.Qty" SortExpression="tresqty">
                                            <FooterTemplate>
                                                <asp:LinkButton ID="lbtnSameValue" runat="server" OnClick="lbtnSameValue_Click" CssClass="btn btn-danger btn-sm">Put Same Val</asp:LinkButton>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvResQty" runat="server"
                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "tresqty")).ToString("#,##0.00;(#,##0.00); ") %>'
                                                    Width="110px" Style="text-align: right"></asp:Label>
                                            </ItemTemplate>
                                            <FooterStyle HorizontalAlign="Right" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:TemplateField>
                        ...
                        <asp:View ID="View5Report" runat="server">
                            <div class="row form-group">
                                <div class="col-md-4">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="lblTitle4" runat="server" CssClass="btn btn-secondary" Text="Analysis Reports"></asp:Label>
                                        </div>
                                        <asp:DropDownList ID="ddlReports" runat="server" AutoPostBack="True" CssClass="form-control"
                                ...
                                <div class="col-md-2">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="lblRptGroup" runat="server" CssClass="btn btn-secondary" Text="Groups"></asp:Label>
                                        </div>
                                ...
                                <div class="col-md-2">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="lblFloor" runat="server" CssClass="btn btn-secondary" Text="Category"></asp:Label>
                                        </div>
                                ...
                                <div class="col-md-2">
                                    <asp:LinkButton ID="lbtnShowReport" runat="server" CssClass="btn btn-primary" OnClick="lbtnShowReport_Click">Show Report</asp:LinkButton>
                                </div>
                            ...
                            <asp:Panel ID="PnlRptItmList" runat="server" Visible="False">
                                <div class="row form-group">
                                    <div class="col-md-3">
                                        <div class="input-group input-group-alt">
                                            <div class="input-group-prepend ">
                                                <asp:Label ID="lblItem9" runat="server" CssClass="btn btn-secondary btn-sm">Items :</asp:Label>
                                            </div>
                                            <asp:TextBox ID="txtRptItemSearch" Style="height: 29px" runat="server" CssClass="form-control" placeholder="Search.."></asp:TextBox>
                                            <asp:LinkButton ID="ImgbtnRptFindItem" runat="server" OnClick="ImgbtnRptFindItem_Click" CssClass="btn btn-primary btn-sm" Style="float: left; margin-left: 1px"><i class="fa fa-search"></i></asp:LinkButton>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <asp:DropDownList ID="ddlRptItem" runat="server" CssClass="select2 form-control">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            ...
                            <asp:Panel ID="PnlRptResList" runat="server" Visible="False">
                                <div class="row form-group">
                                    <div class="col-md-3">
                                        <div class="input-group input-group-alt">
                                            <div class="input-group-prepend ">
                                                <asp:Label ID="lblItem12" runat="server" CssClass="btn btn-secondary btn-sm">Resource:</asp:Label>
                                            </div>
                                            <asp:TextBox ID="txtRptResSearch" Style="height: 29px" runat="server" CssClass="form-control" placeholder="Search.."></asp:TextBox>
                                            <asp:LinkButton ID="ImgbtnRptFindRes" runat="server" OnClick="ImgbtnRptFindRes_Click" CssClass="btn btn-primary btn-sm" Style="float: left; margin-left: 1px"><i class="fa fa-search"></i></asp:LinkButton>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <asp:DropDownList ID="ddlRptRes" runat="server" CssClass="select2 form-control">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </asp:Panel>
                        ...
                        <asp:View ID="SpReport" runat="server">
                            <div class="row form-group">
                                <div class="col-md-2">
                                    <asp:Label ID="lblTitle5" runat="server" CssClass="btn btn-success" Text="Special Reports"></asp:Label>
                                </div>
                                <div class="col-md-2">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="Label1" runat="server" CssClass="btn btn-secondary">Floor : </asp:Label>
                                        </div>
                                        <asp:DropDownList ID="ddlFlrlstspr" runat="server" Font-Bold="True" Font-Size="12px" Style="text-transform: capitalize" CssClass="form-control">
                                        </asp:DropDownList>
                                ...
                                <div class="col-md-2">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="Label2" runat="server" CssClass="btn btn-secondary">Group :</asp:Label>
                                        </div>
                                        <asp:DropDownList ID="ddlRptGroupspr" runat="server" Font-Bold="True" Font-Size="12px" Style="text-transform: capitalize" CssClass="form-control">
                                            <asp:ListItem>Main</asp:ListItem>
                                            <asp:ListItem>Sub-1</asp:ListItem>
                                            <asp:ListItem>Sub-2</asp:ListItem>
                                            <asp:ListItem>Sub-3</asp:ListItem>
                                ...
                                <div class="col-md-1">
                                    <asp:LinkButton ID="lbtnShowSpRpt" runat="server" CssClass="btn btn-primary" OnClick="lbtnShowSpRpt_Click">Show</asp:LinkButton>
                                </div>

                                <div class="col-md-2">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="Label3" runat="server" CssClass="btn btn-secondary">Work : </asp:Label>
                                        </div>
                                        <asp:DropDownList ID="ddlRptWork" runat="server" Font-Bold="True" Font-Size="12px" Style="text-transform: capitalize" CssClass="form-control">
                                ...
                                <div class="col-md-2">
                                    <div class="input-group input-group-alt">
                                        <div class="input-group-prepend ">
                                            <asp:Label ID="Label5" runat="server" CssClass="btn btn-secondary">Page Size : </asp:Label>
                                        </div>
                                        <asp:DropDownList ID="ddlpagesize" runat="server" AutoPostBack="True" BackColor="#CCFFCC" Font-Bold="True" Font-Size="12px" ForeColor="#3366FF"
                            ...
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="gvSpRpt" runat="server" AllowPaging="false"
                                        AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        ShowFooter="True">
                                        <%--OnPageIndexChanging="gvSpRpt_PageIndexChanging"--%>
                                        <Columns>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="style169">
                                                        <asp:Label ID="Label2" runat="server" Font-Size="12px"
                                                            Font-Underline="False" Style="font-weight: 700; text-align: right"
                                                            Text="Group :" Width="80px" ForeColor="#000"></asp:Label>
                                                    </td>
                                                    <td class="style170">
