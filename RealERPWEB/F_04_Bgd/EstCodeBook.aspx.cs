...
{
    public partial class EstCodeBook : System.Web.UI.Page
    {
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "GETESTCODE", "",
                                "", "", "", "", "", "", "", "");
                this.ddlOthersBook.DataTextField = "estdesc";
                this.ddlOthersBook.DataValueField = "estcod";
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK", "INSERTUPESTINF", tgcod,
                           gdesc, Unit, "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "SHOWESTCODEDETAILS", tempddl1,
                            tempddl2, "", "", "", "", "", "", "");
