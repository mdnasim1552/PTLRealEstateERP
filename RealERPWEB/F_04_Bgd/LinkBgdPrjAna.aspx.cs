...
{
    public partial class LinkBgdPrjAna : System.Web.UI.Page
    {
        ...
        private void Print_InResource()
        {
            ...
            // Hashtable hst = (Hashtable)Session["tblLogin"]; //nayan
            // string comcod = hst["comcod"].ToString();
            // string comnam = hst["comnam"].ToString();
            // string compname = hst["compname"].ToString();
            // string username = hst["username"].ToString();
        ...
        private void Print_Resource()
        {
            ...
            ////string workbasis = ((Label)this.gvRptResBasis.FooterRow.FindControl("lblgvFTotalCost")).Text;
            //// ((Label)this.gvRptResBasis.FooterRow.FindControl("lblgvFPercent")).Text
            ...
            //TextObject txtTotal = rptResource.ReportDefinition.ReportObjects["txtTotal"] as TextObject;
            //txtTotal.Text = ((Label)this.gvRptResBasis.FooterRow.FindControl("lblgvFTotalCost")).Text;

            //TextObject txtpercent = rptResource.ReportDefinition.ReportObjects["txtpercent"] as TextObject;
            //txtpercent.Text = ((Label)this.gvRptResBasis.FooterRow.FindControl("lblgvFPercent")).Text;
        ...
        protected void ImgbtnFindProject_Click(object sender, EventArgs e)
        {
            ...
            string srchTxt = (this.Request.QueryString["prjcode"].ToString()).Length == 0 ? "%" + this.txtProjectSearch.Text.Trim() + "%" : this.Request.QueryString["prjcode"].ToString() + "%";
        ...
        protected void Report_Resource_Basis(DataTable TptTable)
        {
            ...
            //  DataView dv = dt.DefaultView();
            DataView dv = dt.DefaultView;
            dv.RowFilter = ("rptcod<>'4111AAAAAAAA'");
            dt = dv.ToTable();
        ...
        {
            DataTable dt = (DataTable)Session["tblItmCod"];
