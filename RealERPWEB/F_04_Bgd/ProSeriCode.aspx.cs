...
{
    public partial class ProSeriCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Catagory Code";
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "GETPROCATCODE", "",
                                "", "", "", "", "", "", "", "");
                this.ddlOthersBook.DataTextField = "catdesc";
                this.ddlOthersBook.DataValueField = "catcode";
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "INSERTUPPROCATINF", tgcod,
                           gdesc, theaddesc, "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "GETPROCATINFO", tempddl1,
                            tempddl2, "", "", "", "", "", "", "");
