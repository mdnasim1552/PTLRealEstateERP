<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EstWorkBook.aspx.cs" Inherits="RealERPWEB.F_04_Bgd.EstWorkBook" %>
                                ...
                                <asp:TemplateField HeaderText=" ">
                                    <ItemTemplate>
                                        <asp:Label ID="lblgrcode" runat="server"
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "wrkcode2"))+"-" %>'
                                ...
                                <asp:TemplateField HeaderText="Code">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtgrcode" runat="server" Font-Size="12px" Height="16px"
                                            ...
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "wrkcode3")) %>'
