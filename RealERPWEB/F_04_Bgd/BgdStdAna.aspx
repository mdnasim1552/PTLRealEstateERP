                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-lg-3">
                            <div class="form-group">
                                <asp:Label ID="lblItem" runat="server" CssClass="control-label" Text="Description of Items"></asp:Label>
                        ...
                        <div class="col-md-1 col-sm-1 col-lg-1" style="margin-top: 20px;">
                            <asp:LinkButton ID="lbtnOk1" runat="server" CssClass="btn btn-primary btn-sm okBtn" OnClick="lbtnOk1_Click" TabIndex="4">Select Item</asp:LinkButton>
                        ...
                        <div class="col-md-1 col-sm-1 col-lg-1">
                            <div class="form-group">
                                <asp:Label ID="lblItem3" runat="server" CssClass="control-label" Text="Std Qty"></asp:Label>
                                <asp:Label ID="lblStdQtyF" runat="server" CssClass="form-control form-control-sm" Text=""></asp:Label>
                            </div>
                        </div>
                        <div class="col-md-1 col-sm-1 col-lg-1">
                            <div class="form-group">
                                <asp:Label ID="lblItem8" runat="server" CssClass="control-label" Text="Unit"></asp:Label>
                                <asp:Label ID="lblUnitFPS" runat="server" CssClass="form-control form-control-sm" Text=""></asp:Label>
                            </div>
                        </div>
                        <div class="col-md-1 col-sm-1 col-lg-1">
                            <div class="form-group">
                                <asp:Label ID="lblFloor1" runat="server" CssClass="control-label" Text="Catagory"></asp:Label>
                                <asp:DropDownList ID="ddlFloor1" runat="server" CssClass="form-control form-control-sm custom-select">
                                </asp:DropDownList>
                            </div>
                        </div>
                        ...
                        <%-- <div class="row mt-3">--%>
                        <%--<div class="col-md-1" style="margin-top: 20px;">
                            <asp:TextBox ID="" AutoCompleteType="Disabled" runat="server" CssClass="form-control form-control-sm" TabIndex="1"></asp:TextBox>
                        </div>
                        <div class="col-md-0" style="margin-top: 20px;">
                            <asp:LinkButton ID="" CssClass="btn btn-sm btn-primary" runat="server" OnClick=""><span class="fa fa-search"> </span></asp:LinkButton>
                        </div>--%>
                        <%--<div class="col-md-3">
                            <asp:Label ID="" runat="server" Font-Size="11px" CssClass="form-label"></asp:Label>
                            <asp:DropDownList ID="" runat="server" CssClass="chzn-select form-control form-control-sm">
                            </asp:DropDownList>
                            <asp:Label ID="" runat="server" Visible="false" CssClass="form-control form-control-sm "></asp:Label>
                        </div>--%>
                        <%-- <div class="col-md-1 ml-2" style="margin-top: 20px;">
                            <asp:LinkButton ID="" runat="server" CssClass="btn btn-sm btn-primary" OnClick="" Text=""></asp:LinkButton>
                        </div>--%>

                        <%-- <div class="col-md-1">
                                <asp:Label ID="" runat="server" CssClass="smLbl_to" Text=""></asp:Label>
                                <asp:Label ID="" runat="server" Text=" " CssClass="form-control form-control-sm"></asp:Label>
                            </div>--%>
                        <%-- <div class="col-md-1">
                                <asp:Label ID="" runat="server" CssClass="smLbl_to" Text=""></asp:Label>
                                <asp:Label ID="" runat="server" CssClass="form-control form-control-sm" Text=" "></asp:Label>
                            </div>--%>
                        <%-- <div class="col-md-2" style="position: relative">
                                <div style="position: absolute; top: 0; left: 0">
                                    <asp:Label ID="" runat="server" CssClass="form-label" Text=":"></asp:Label>
                                    <asp:DropDownList ID="" runat="server" Font-Bold="True" CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                </div>
                            </div>--%>
                    ...
                    <asp:Panel ID="PnlAnalysis" runat="server" Visible="False">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-3 col-lg-3">
                                <div class="form-group">
                                    <asp:Label ID="Label1" runat="server" CssClass="control-label" Text="Desc of Resources"></asp:Label>
                                    <asp:LinkButton ID="ImgbtnFindResource" CssClass="srearchBtn" runat="server" OnClick="ImgbtnFindResource_Click" TabIndex="2"><i class="fas fa-search"></i></asp:LinkButton>
                                    <asp:TextBox ID="txtResSearch" runat="server" CssClass="form-control form-control-sm" TabIndex="1" Visible="false"></asp:TextBox>
                                    <asp:DropDownList ID="ddlResource" runat="server" CssClass="chzn-select form-control form-control-sm chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlResource_SelectedIndexChanged">
                                    </asp:DropDownList>
                            ...
                            <%--<div class="col-md-1" style="margin-top: 20px;">
                                ...
                                <div class="col-md-0" style="margin-top: 20px;">
                                    <asp:LinkButton ID="" CssClass="btn btn-sm btn-primary" runat="server" OnClick="" TabIndex="2"><span class="fa fa-search"> </span></asp:LinkButton>
                                </div>
                                <div class="col-md-3">
                                    <asp:Label ID="Label2" runat="server" Font-Size="11px" CssClass="form-label"></asp:Label>
                                    <asp:DropDownList ID="" runat="server" CssClass="form-control form-control-sm chzn-select" >
                                    </asp:DropDownList>
                                </div>--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-lg-4">
                                <div class="row">
                                    <div class="col-md-8 col-sm-8 col-lg-8">
                                        <div class="form-group">
                                            <asp:Label ID="lblToCopy" runat="server" CssClass="control-label" Text="Description of Items" Visible="false"></asp:Label>
                                            <asp:LinkButton ID="ImgbtnFindItemToCopy" CssClass="srearchBtn" runat="server" OnClick="ImgbtnFindItemToCopy_Click" Visible="false"><i class="fas fa-search"></i></asp:LinkButton>
                                            <asp:TextBox ID="txtItemSearchToCopy" runat="server" CssClass="form-control form-control-sm"  Visible="false"></asp:TextBox>
                                            <asp:DropDownList ID="ddlItemToCopy" runat="server" CssClass="chzn-select form-control form-control-sm chzn-select" Visible="false">
                                            </asp:DropDownList>

                                        </div>
                                    </div>
                                    <div class="col-md-1 col-sm-1 col-lg-1" style="margin-top: 20px;">
                                        <asp:LinkButton ID="lbtnCopyData" runat="server" CssClass="btn btn-primary btn-sm okBtn" OnClick="lbtnCopyData_Click" Visible="false">Copy Data</asp:LinkButton>
                        ...
                        <%--  <div class="row" style="margin-bottom: 90px;">
                            ...
                            <div class="col-md-1">
                                <asp:TextBox ID="" AutoCompleteType="Disabled" Visible="false" runat="server" CssClass="form-control form-control-sm" TabIndex="1"></asp:TextBox>
                            </div>
                            <div class="col-md-0">
                                <asp:LinkButton ID="" CssClass="btn btn-primary btn-sm" Visible="false" runat="server" OnClick="" TabIndex="2"><span class="fa fa-search"> </span></asp:LinkButton>
                            </div>
                            <div class="col-md-3">
                                <asp:DropDownList ID="" runat="server" CssClass="form-control form-control-sm chzn-select" Visible="false">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-1 pading5px">
                                <asp:LinkButton ID="" runat="server" CssClass="btn btn-primary primaryBtn" Visible="false"
