<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="AdvertisementCode.aspx.cs" Inherits="RealERPWEB.F_22_Sal.AdvertisementCode" %>
        ...
        <ContentTemplate>
            <div class="container moduleItemWrpper">
                <div class="contentPart">
                    ...
                    <asp:GridView ID="gvAddCode" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea"
                        Font-Size="12px" OnRowCancelingEdit="gvAddCode_OnRowCancelingEdit" OnRowEditing="gvAddCode_OnRowEditing"
                        OnRowUpdating="gvAddCode_OnRowUpdating" PageSize="15" Width="284px" ShowFooter="True" OnPageIndexChanging="gvAddCode_OnPageIndexChanging">
