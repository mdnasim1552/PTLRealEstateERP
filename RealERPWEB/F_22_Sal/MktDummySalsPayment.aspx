<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="MktDummySalsPayment.aspx.cs" Inherits="RealERPWEB.F_22_Sal.MktDummySalsPayment" %>
                        ...
                        <asp:View ID="ViewSchedule" runat="server">
                                        ...
                                        <asp:Panel ID="pnlgenMrr" runat="server" Visible="False">
                                            <div class=" form-group">
                                                <div class="col-md-12 pading5px">
                                                    ...
                                                    <asp:Label ID="lblbooking" runat="server" CssClass=" smLbl_to">Booking</asp:Label>
                                                    <asp:TextBox ID="txtbooking" runat="server" CssClass=" smltxtBox60px txtAlgRight"></asp:TextBox>


                                                    <asp:Label ID="lblbookdate" runat="server" CssClass="smLbl_to">Booking Date</asp:Label>
                                                    <asp:TextBox ID="txtbookdate" runat="server" CssClass="inputTxt inpPixedWidth"></asp:TextBox>
                                                    <cc1:CalendarExtender ID="txtbookdate_CalendarExtender1" runat="server"
                                                    ...
                                                    <asp:Label ID="lblinsamt" runat="server" CssClass="smLbl_to" Text="Ins. Amount"></asp:Label>
                                                    <asp:TextBox ID="txtinsamt" runat="server" CssClass=" smltxtBox60px txtAlgRight"></asp:TextBox>
                            ...
                            <div class="row">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lbtnAdddsch" OnClick="lbtnAdddsch_Click" ToolTip="Add Installment" runat="server"><span  class="glyphicon glyphicon-plus"></span> </asp:LinkButton>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lbtnDelacsch" ToolTip="Delete Installment" OnClick="lbtnDelacsch_Click" OnClientClick="javascript:return FunConfirm();" runat="server"><span style="color:red" class="glyphicon glyphicon-floppy-remove"></span> </asp:LinkButton>
                             ...
                             <div class="row">
                                ...
                                CssClass="table table-striped table-hover table-bordered grvContentarea" Width="639px">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Cummulative Due" Visible="false">
                                        <ItemTemplate>
