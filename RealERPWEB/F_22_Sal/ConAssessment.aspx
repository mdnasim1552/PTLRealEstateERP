<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="ConAssessment.aspx.cs" Inherits="RealERPWEB.F_22_Sal.ConAssessment" %>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                <div class="col-md-3 pading5px asitCol3">
                                    ...
                                    <asp:LinkButton ID="ibtnFindProject" CssClass="btn btn-primary srearchBtn" runat="server" TabIndex="2" OnClick="ibtnFindProject_OnClick"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>


                                </div>
                                <div class="col-md-4 pading5px asitCol4">
                                    <asp:DropDownList ID="ddlprjlist" runat="server" Width="320" CssClass="chzn-select form-control  inputTxt" TabIndex="3"></asp:DropDownList>
                            ...
                            <div class="form-group">
                                <div class="col-md-3 pading5px asitCol3">
                                    ...
                                    <asp:LinkButton ID="ibtnFindSubConName" CssClass="btn btn-primary srearchBtn" runat="server" TabIndex="2" OnClick="ibtnFindSubConName_OnClick"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>


                                </div>
                                <div class="col-md-4 pading5px asitCol4">
                                    <asp:DropDownList ID="ddlcontractorlist" runat="server" Width="320" CssClass="chzn-select form-control  inputTxt" TabIndex="3"></asp:DropDownList>
