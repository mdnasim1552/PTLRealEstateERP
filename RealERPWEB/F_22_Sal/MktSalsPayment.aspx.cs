        ...
        private void PaymentGridVisible()
        {
            ...
            switch (comcod)
            {
                ...
                case "3352": //p2p 360
                    ...
                    this.gvPayment.Columns[16].Visible = true;
                    break;
        ...
        protected void lUpdatpayment_Click(object sender, EventArgs e)
        {
            ...
            if (a == b)
            {
                ...
                for (int i = 0; i < this.gvPayment.Rows.Count; i++)
                {
                    ...
                    //if (Amount != 0)
                    //{
                    MktData.UpdateTransInfo(comcod, "SP_ENTRY_SALSMGT", "INSERTORUPDATEPAYMENTINF", PactCode, Usircode, Gcode, schDate, Amount.ToString(), "", Gdesc, percent.ToString(), jobcode, jobdesc, "", "", "", "", "");
                    //}
