<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="RptSalInterest.aspx.cs" Inherits="RealERPWEB.F_22_Sal.RptSalInterest" %>
        ...
        <ContentTemplate>
            ...
            <div class="card card-fluid mt-4 mb-1">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:LinkButton ID="imgbtnFindProject" runat="server" OnClick="imgbtnFindProject_Click" TabIndex="4"><i class="fa fa-search" aria-hidden="true"></i></asp:LinkButton>
                                <asp:TextBox ID="txtSrcProject" runat="server" TabIndex="3" CssClass="form-control form-control-sm" Visible="false"></asp:TextBox>
                                <asp:DropDownList ID="ddlProjectName" runat="server" AutoPostBack="True" CssClass="form-control form-control-sm chzn-select" OnSelectedIndexChanged="ddlProjectName_SelectedIndexChanged"
                                    TabIndex="5">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-3  ml-2" id="divCust" runat="server">
                            <div class="form-group">
                                <asp:Label ID="lblCustName" runat="server" CssClass="lblTxt lblName" Text="Customer Name:"></asp:Label>
                                <asp:LinkButton ID="imgbtnFindCustomer" runat="server" OnClick="imgbtnFindCustomer_Click" TabIndex="4"><i class="fa fa-search" aria-hidden="true"></i></asp:LinkButton>
                         ...
                         <div class="col-md-2 ml-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDate" runat="server" CssClass="form-control form-control-sm" TabIndex="8"></asp:TextBox>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <asp:LinkButton ID="lbtnOk" runat="server" Text="Ok" OnClick="lbtnOk_Click" CssClass="btn btn-sm btn-primary okBtn mt20" TabIndex="9"></asp:LinkButton>
                            </div>
                        </div>
                    ...
                    <div class="row">                        
                        <div class="col-md-2" id="divinterest" runat="server">
                            <div class="form-group">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <asp:LinkButton ID="lbtnupdateb" runat="server" CssClass="btn btn-success btn-sm primaryBtn mt20" OnClick="lbtnupdateb_OnClick">Update</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <asp:GridView ID="gvDueCollAll" runat="server" AllowPaging="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Unit Description" >
                                                <FooterTemplate>
                                                    <asp:Label ID="lblgvTotal" runat="server" CssClass="grvFooterTotal">Total</asp:Label>
                                                </FooterTemplate>
                                                <ItemTemplate>
