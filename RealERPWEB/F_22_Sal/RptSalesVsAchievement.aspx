        ...
        function pageLoaded() {
          ...
          <%--  $('#<%=this.gvsupstatus.ClientID%>').tblScrollable();--%>
            $(function () {
                ...
                var gvsalesvscoll = $('#<%=this.gvsalesvscoll.ClientID %>');
                            ...
                            <asp:GridView ID="gvsalesvscoll" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Type">
                                       ...
                                       <FooterTemplate>
                                                    <asp:Label ID="lblFUdesc" runat="server" Font-Bold="True" Font-Size="12px"
                                     ...
                                     <asp:TemplateField HeaderText="Size (sft)">
                                       ...
                                       <FooterTemplate>
                                                    <asp:Label ID="lblFsize" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right">Total :</asp:Label>
                                         </FooterTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblgvsize" runat="server"
                                                Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "usize")) %>'
                                                Width="130px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="left" />
                                        <HeaderStyle HorizontalAlign="center" />
