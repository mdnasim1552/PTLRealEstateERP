<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkMktSalsPayment.aspx.cs" Inherits="RealERPWEB.F_22_Sal.LinkMktSalsPayment" %>
                                        ...
                                        <asp:Panel ID="Panel2" runat="server">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:LinkButton ID="lbtnUpdateCAST" runat="server" CssClass="btn  btn-danger primaryBtn ml-4" OnClick="lbtnUpdateCAST_Click">Update</asp:LinkButton>
                                ...
                                <div class="col-md-6">
                                    <div class=" table-responsive">
                                        <asp:GridView ID="gvPayment" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                            ShowFooter="True" OnRowDeleting="gvPayment_RowDeleting">
                                            <RowStyle />
                                            <Columns>
                                                <asp:TemplateField HeaderText="Sl.No.">
                                                    <ItemTemplate>
