<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="MktEntryUnit.aspx.cs" Inherits="RealERPWEB.F_22_Sal.MktEntryUnit" %>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px ">
                                        <asp:DropDownList ID="ddlProjectName" runat="server" Width="280px" CssClass="chzn-select  inputTxt" TabIndex="3" >
                                        </asp:DropDownList>
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="Label1" runat="server" CssClass="lblTxt lblName"  Text="Type Name"></asp:Label>
                                        <asp:TextBox ID="txtType" runat="server" CssClass="inputTxt inpPixedWidth" TabIndex="1"></asp:TextBox>

                                        <div class="colMdbtn">
                                            <asp:LinkButton ID="btnType" CssClass="btn btn-primary srearchBtn" OnClick="btnType_Click" runat="server"  TabIndex="2"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
                                        </div>
                                    </div>
                                    <div class="col-md-3 pading5px ">
                                        <asp:DropDownList ID="ddlUnitType" runat="server" CssClass="form-control inputTxt chzn-select" AutoPostBack="true"  TabIndex="4" OnSelectedIndexChanged="ddlUnitType_SelectedIndexChanged">
                                        </asp:DropDownList>
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px ">
                                        <asp:DropDownList ID="ddlGroup" runat="server" CssClass="form-control inputTxt  chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlGroup_SelectedIndexChanged" TabIndex="4">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="Label2" runat="server" CssClass="lblTxt lblName"  Text="Category Name"></asp:Label>
                                        <asp:TextBox ID="txtsrchfloor" runat="server" CssClass="inputTxt inpPixedWidth" TabIndex="1"></asp:TextBox>
                                    ...
                                    <div class="col-md-3 pading5px ">
                                        <asp:DropDownList ID="ddlFloor" runat="server" CssClass="form-control inputTxt  chzn-select" OnSelectedIndexChanged="ddlFloor_SelectedIndexChanged" TabIndex="6" AutoPostBack="true">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 pading5px">
                                        ...
                                        <asp:Label ID="lbldateto" runat="server" CssClass="smLbl_to" Text="Total No"  Style="display:none;"></asp:Label>

                                        <asp:TextBox ID="txttotalno" runat="server" CssClass=" smLbl_to" Width="100px" Style="display:none;"></asp:TextBox>
