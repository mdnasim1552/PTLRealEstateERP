                            ...
                            <asp:GridView ID="gvySalbgd" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Unit Size">
                                        <FooterTemplate>
                                            <asp:Label ID="lgvFsize" runat="server"></asp:Label>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblgvsize" runat="server" BorderColor="#99CCFF"
                                                BorderStyle="Solid" BorderWidth="0px" Font-Size="11px"
                                    ...
                                    <asp:TemplateField HeaderText="Total Unit">
                                        <FooterTemplate>
                                            <asp:Label ID="lgvFtunit" runat="server"></asp:Label>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblgvtunit" runat="server" BorderColor="#99CCFF"
                                                BorderStyle="Solid" BorderWidth="0px" Font-Size="11px"
                                                Style="text-align: right; background-color: Transparent"
                                    ...
                                    <asp:TemplateField HeaderText="Sold">
                                        <FooterTemplate>
                                            <asp:Label ID="lgvFsqty" runat="server"></asp:Label>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblgvsqty" runat="server" BorderColor="#99CCFF"
                                                BorderStyle="Solid" BorderWidth="0px" Font-Size="11px"
                                                Style="text-align: right; background-color: Transparent"
                                    ...
                                    <asp:TemplateField HeaderText="UnSold">
                                        <FooterTemplate>
                                            <asp:Label ID="lgvFusqty" runat="server"></asp:Label>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblgvusqty" runat="server" BorderColor="#99CCFF"
                                                BorderStyle="Solid" BorderWidth="0px" Font-Size="11px"
                                                Style="text-align: right; background-color: Transparent"
