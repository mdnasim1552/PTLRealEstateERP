...
{
    public partial class RptMonthConAss : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //((Label)this.Master.FindControl("lblTitle")).Text = "CONTRACTOR MONTHLY ASSESSMENT";
            }
        ...
        private void ShowConPerformance()
        {
            ...
            DataSet ds2 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_ENTRY_APPOINTMENT_LETTER", "CONASSPOSITION", "", "", fromdate, todate, "", "", "", "", "");
            if (ds2 == null)
            {
                this.gvConper.DataSource = null;
                this.gvConper.DataBind();
                return;
            }
        ...
        protected void lbtnPrint_Click(object sender, EventArgs e)
        {
            ...
            string title = "Contractor Monthly Assessment";


            DataTable dt = (DataTable)Session["tblper"];
            var lst = dt.DataTableToList<RealEntity.C_22_Sal.EClassSales_02.MonthlyConAss>();
            LocalReport Rpt1 = new LocalReport();
            Rpt1 = RealERPRDLC.RptSetupClass1.GetLocalReport("R_22_Sal.RptConMonthlyAss", lst, null, null);
