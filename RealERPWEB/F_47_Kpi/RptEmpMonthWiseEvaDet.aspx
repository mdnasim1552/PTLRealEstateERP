<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptEmpMonthWiseEvaDet.aspx.cs" Inherits="RealERPWEB.F_47_Kpi.RptEmpMonthWiseEvaDet" %>
                       ...
                       <div class="clearfix"></div>
                        <asp:GridView ID="gvSales" runat="server" AllowPaging="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Unit Size">
                                                                        <ItemTemplate>
                                        <asp:Label ID="lblgvunitsize" runat="server"
                                ...
                                <asp:TemplateField HeaderText="Sales Amount">
                                    <FooterTemplate>
                                        <asp:Label ID="lblgvFSaleamt" runat="server" Width="80px"></asp:Label>
                                    </FooterTemplate>
                                    <ItemTemplate>
                            ...
                            <Columns>
                               ...
                               <asp:TemplateField HeaderText="MR Date">
                                ...
                                <asp:TemplateField HeaderText="MR Amount">
                                    <FooterTemplate>
                                        <asp:Label ID="lblgvFMramtcoll" runat="server" Width="80px"></asp:Label>
                                    </FooterTemplate>
                                    <ItemTemplate>
                        ...
                        <asp:GridView ID="gvOffer" runat="server" AllowPaging="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Followup" HeaderStyle-Width="100px">
                                    <ItemTemplate>
