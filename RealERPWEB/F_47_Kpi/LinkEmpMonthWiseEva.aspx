...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkEmpMonthWiseEva.aspx.cs" Inherits="RealERPWEB.F_47_Kpi.LinkEmpMonthWiseEva" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var name = '<%=Request.QueryString["empid"].ToString()%>';
        ...
        function displayTable(tblmoneeva) {
            var i = 0, selper=0.00, collper=0.00, offper=0.00, visitper=0.00, callper=0.00, othper=0.00
            var ttamt1 = 0.00;
            var ttamt2 = 0.00;
            var ttamt3 = 0.00;
            var ttamt4 = 0.00;
            ...
            $("#grvMonthempeva").append(" <thead class=grvHeader style=" + "font-weight:bolder;" + ">" +
                "<tr><th style='width:30px;'></th><th style='width:70px;'></th><th  colspan='6' >Target</th>" +
                 "<th colspan='6' >Actual</th><th style='width:70px;'></th><th style='width:70px;'></th></tr>" +
                 "<tr><th style='width:30px;'>SL</th><th style='width:70px;'>MONTH</th><th style='width:80px;'>SALES</th><th style='width:80px;'>COLLECTION</th>" +
                        "<th style='width:70px;'>Offer</th><th style='width:70px;'>Visit</th><th style='width:70px;'>CALL</th><th style='width:70px;'>Others</th> "+
                        "<th style='width:80px;'>SALES</th><th style='width:80px;'>COLLECTION</th><th style='width:70px;'>Offer</th><th style='width:70px;'>Visit</th><th style='width:70px;'>CALL</th><th style='width:70px;'>Others</th>"+
            ...
            $.each(tblmoneeva, function (index, arval) {
                ...
                offper = (ttamt3 == 0) ? 0.00 : ((taamt3 / ttamt3) * 100).toFixed(2);
                visitper = (ttamt4 == 0) ? 0.00 : ((taamt4 / ttamt4) * 100).toFixed(2);
                callper = (ttamt5 == 0) ? 0.00 : ((taamt5 / ttamt5) * 100).toFixed(2);
                othper = (ttamt6 == 0) ? 0.00 : ((taamt6 / ttamt6) * 100).toFixed(2);
            ...
            $("#grvMonthempeva").append(" <tfoot class=grvHeader><tr><td style=text-align:center;></td>" + "<td style=text-align:right;font-weight:bold;>"
                    ...
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtamt3 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtamt4 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtamt5 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtamt6 + "</td>"
                    ...
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtaamt3 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtaamt4 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtaamt5 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtaamt6 + "</td><td></td><td></td></tr>"
                    +"<tr><td style=text-align:center;></td>" + "<td style=text-align:right;font-weight:bold;>"
                    + "%" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">"  + "</td>"
                    ...
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + selper + " %" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + collper + " %" + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + offper + " %" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + visitper + " %" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + callper + " %" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + othper + " %" + "</td><td></td><td></td></tr>"
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            <div class="form-horizontal">
                                <div class="form-group">
                                      ...
                                      <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="lblSalesTeam" runat="server" CssClass="lblTxt lblName" Text="Employee Name:"></asp:Label>
                                          <asp:Label ID="lblvalsalteam" runat="server" CssClass=" lblVal" ></asp:Label>
                                    </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <asp:Label ID="lblvaldate" runat="server" CssClass=" smLbl_to" ></asp:Label>
