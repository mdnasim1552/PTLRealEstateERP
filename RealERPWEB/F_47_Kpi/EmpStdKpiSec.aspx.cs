...
{
    public partial class EmpStdKpiSec : System.Web.UI.Page
    {
        ...
        private void Save_Value()
        {
            ...
            for (int i = 0; i < gvStdKpi.Rows.Count; i++)
            {
                double star1 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvsalTarget")).Text.Trim());
                double star2 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvcollTarget")).Text.Trim());
