<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EmpStdKpiCR.aspx.cs" Inherits="RealERPWEB.F_47_Kpi.EmpStdKpiCR" %>
            ...
            <div class="row">
                ...
                <fieldset class="scheduler-border fieldset_B">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-md-5 pading5px ">
                                <asp:CheckBox ID="chkUpload" runat="server" TabIndex="10" Text="Upload From Marketing" CssClass="btn btn-primary checkBox" />
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvStdKpi" runat="server" AllowPaging="True" Width="200px" OnRowDeleting="gvStdKpi_RowDeleting"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Target<br/>Current Dues">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvtarcurdue" runat="server"
                                ...
                                <FooterTemplate>
                                    <asp:Label ID="lblFtarcurdue" runat="server" Style="text-align: right; color: black;" Width="70px"></asp:Label>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Target<br/>Over Dues">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvtaroverdue" runat="server"
                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem,"star2")).ToString("#,##0;(#,##0); ") %>'
                                        Width="70px"
                                        Style="text-align: right" BackColor="Transparent" BorderStyle="None" AutoCompleteType="Disabled"></asp:TextBox>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Label ID="lblFtaroverdue" runat="server" Style="text-align: right; color: black;" Width="70px"></asp:Label>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            </asp:TemplateField>

                             <asp:TemplateField HeaderText="Target<br/>Return">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvtarreturn" runat="server"
                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem,"star3")).ToString("#,##0;(#,##0); ") %>'
                                        Width="50px"
                                        Style="text-align: right" BackColor="Transparent" BorderStyle="None" AutoCompleteType="Disabled"></asp:TextBox>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Label ID="lblFtarreturn" runat="server" Style="text-align: right; color: black;" Width="50px"></asp:Label>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            </asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="Target<br/>Advanced Collection">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvtaradvcoll" runat="server"
                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem,"star4")).ToString("#,##0;(#,##0); ") %>'
                                        Width="50px"
                                        Style="text-align: right" BackColor="Transparent" BorderStyle="None" AutoCompleteType="Disabled"></asp:TextBox>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Label ID="lblFtaradvcoll" runat="server" Style="text-align: right; color: black;" Width="50px"></asp:Label>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="right" />
                             ...
                             <asp:TemplateField HeaderText="Target<br/>Others">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Index<br/>Current Dues">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvindcurdue" runat="server"
                            ...
                            <asp:TemplateField HeaderText="Index<br/>Over Dues">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvindoverdue" runat="server"
                             ...
                             <asp:TemplateField HeaderText="Index<br/>Return">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvindreturn" runat="server"
                            ...
                            <asp:TemplateField HeaderText="Index<br/>Advanced Collection">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvindadvcoll" runat="server"
                             ...
                             <asp:TemplateField HeaderText="Actual<br/>Others">
                                <ItemTemplate>
