...
{
    public partial class EmpStdKpi : System.Web.UI.Page
    {
        ...
        private void ShowEmpData()
        {
            ...
            DataSet ds = KpiData.GetTransInfo(comcod, "dbo_kpi.SP_ENTRY_EMP_KPI_SETUP", "SHOWSTDKPI", "", YmonID, upload, deptcode);
        ...
        private void FooterCal()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFsTarget")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star1)", "")) ?
                                   0 : dt.Compute("sum(star1)", ""))).ToString("#,##0;(#,##0); ");
                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFCollTarget")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star2)", "")) ?
                                  0 : dt.Compute("sum(star2)", ""))).ToString("#,##0;(#,##0); ");

                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFtaroffer")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star3)", "")) ?
                                  0 : dt.Compute("sum(star3)", ""))).ToString("#,##0;(#,##0); ");

                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFtarvisit")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star4)", "")) ?
                                  0 : dt.Compute("sum(star4)", ""))).ToString("#,##0;(#,##0); ");
                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFtarcall")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star5)", "")) ?
                                  0 : dt.Compute("sum(star5)", ""))).ToString("#,##0;(#,##0); ");
                ...
                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFstar7")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star7)", "")) ?
                                 0 : dt.Compute("sum(star7)", ""))).ToString("#,##0;(#,##0); ");
                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFstar8")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star8)", "")) ?
                                 0 : dt.Compute("sum(star8)", ""))).ToString("#,##0;(#,##0); ");
            }
        }
        ...
        private void Save_Value()
        {
            ...
            for (int i = 0; i < gvStdKpi.Rows.Count; i++)
            {
                double star1 = Convert.ToDouble("0" + ((Label)this.gvStdKpi.Rows[i].FindControl("txtgvsalTarget")).Text.Trim());
                double star2 = Convert.ToDouble("0" + ((Label)this.gvStdKpi.Rows[i].FindControl("txtgvcollTarget")).Text.Trim());
                double star3 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvtaroffer")).Text.Trim());
                double star4 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvtarvisit")).Text.Trim());
                double star5 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvtarcall")).Text.Trim());
                double star6 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvtarothers")).Text.Trim());
                double star7 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvstar7")).Text.Trim());
                double star8 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvstar8")).Text.Trim());
                double sval1 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindsale")).Text.Trim());
                double sval2 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindColl")).Text.Trim());
                double sval3 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindoffer")).Text.Trim());
                double sval4 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindVisit")).Text.Trim());
                double sval5 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindCall")).Text.Trim());
                double sval6 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindothers")).Text.Trim());
                double sval7 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvsval7")).Text.Trim());
                double sval8 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvsval8")).Text.Trim());
                ...
                dt.Rows[rowindex]["star6"] = star6;
                dt.Rows[rowindex]["star7"] = star7;
                dt.Rows[rowindex]["star8"] = star8;
                ...
                dt.Rows[rowindex]["sval6"] = sval6;
                dt.Rows[rowindex]["sval7"] = sval7;
                dt.Rows[rowindex]["sval8"] = sval8;
        ...
        protected void lnkappupdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string comcod = this.Getcomcod();
                Hashtable hst = (Hashtable)Session["tblLogin"];
                string sdeptcode = "9402%";

                this.Save_Value();
                DataTable tbl1 = (DataTable)ViewState["tbEmpData"];
                DataTable dt = (DataTable)ViewState["tblkpigrp"];
                bool result = false;
                result = KpiData.UpdateTransInfo(comcod, "dbo_kpi.SP_ENTRY_EMP_KPI_SETUP", "DELMONTHLYTARGET", YmonID, sdeptcode, "", "", "", "", "", "", "");
                if (!result)
                {
                ...
                {
                    string deptcode = dr2["deptcode"].ToString();
                ...
                dv.RowFilter = ("kpigrp like '810100601901%'");
                dt = dv.ToTable();
                foreach (DataRow dr2 in tbl1.Rows)
                {
                    string deptcode = dr2["deptcode"].ToString();
        ...
        protected void gvStdKpi_DataBound(object sender, EventArgs e)
        {
            ...
            gvStdKpi.HeaderRow.Parent.Controls.AddAt(0, row);
        }



        protected void gvStdKpi_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            if (gvRow.RowType == DataControlRowType.Header)
            {
                ...
                cell5.ColumnSpan = 6;
                cell5.BackColor = Color.FromName("#7AA5D6");

                TableCell cell6 = new TableCell();
                cell6.Text = "Index";
                cell6.HorizontalAlign = HorizontalAlign.Center;
                cell6.ColumnSpan = 9;
                cell6.BackColor = Color.FromName("#59BAF5");
                ...
                gvStdKpi.Controls[0].Controls.AddAt(0, gvrow);
            }
        }
    }
}
