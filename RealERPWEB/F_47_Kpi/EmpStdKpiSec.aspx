<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EmpStdKpiSec.aspx.cs" Inherits="RealERPWEB.F_47_Kpi.EmpStdKpiSec" %>
                    ...
                    <asp:GridView ID="gvStdKpi" runat="server" AllowPaging="True" Width="200px" OnRowDeleting="gvStdKpi_RowDeleting"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Target<br/>Sales">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvsalTarget" runat="server"
                                ...
                                <FooterTemplate>
                                    <asp:Label ID="lblFsTarget" runat="server" Style="text-align: right; color: black;" Width="70px"></asp:Label>
                                </FooterTemplate>
                            ...
                            <asp:TemplateField HeaderText="Target<br/>Collection">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtgvcollTarget" runat="server"
                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem,"star2")).ToString("#,##0;(#,##0); ") %>'
                                        Width="70px"
                                        Style="text-align: right" BackColor="Transparent" BorderStyle="None" AutoCompleteType="Disabled"></asp:TextBox>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Label ID="lblFCollTarget" runat="server" Style="text-align: right; color: black;" Width="70px"></asp:Label>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            </asp:TemplateField>

                             <asp:TemplateField HeaderText="Target<br/>Offer">
                                <ItemTemplate>
                                ...
                                <FooterTemplate>
                                    <asp:Label ID="lblFtaroffer" runat="server" Style="text-align: right; color: black;" Width="50px"></asp:Label>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Target<br/>Visit">
                                <ItemTemplate>
                                ...
                                <FooterTemplate>
                                    <asp:Label ID="lblFtarvisit" runat="server" Style="text-align: right; color: black;" Width="50px"></asp:Label>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Target<br/>Call">
                                <ItemTemplate>
                                ...
                                <FooterTemplate>
                                    <asp:Label ID="lblFtarcall" runat="server" Style="text-align: right; color: black;" Width="50px"></asp:Label>
                                </FooterTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Index<br/>Sales">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Index<br/>Collection">
                                <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Index<br/>Offer">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Index<br/>Visit">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Index<br/>Call">
                                <ItemTemplate>
