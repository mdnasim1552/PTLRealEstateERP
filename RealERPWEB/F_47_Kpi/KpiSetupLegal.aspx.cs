...
{
    public partial class KpiSetupLegal : System.Web.UI.Page
    {
        ...
        private void ShowEmpData()
        {
            ...
            DataSet ds = KpiData.GetTransInfo(comcod, "dbo_kpi.SP_ENTRY_EMP_KPI_SETUP", "SHOWLEGAL", "", YmonID, upload, deptcode);
            ViewState["tbEmpData"] = ds.Tables[0];
        ...
        private void FooterCal()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFcpTarget")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star1)", "")) ?
                                   0 : dt.Compute("sum(star1)", ""))).ToString("#,##0;(#,##0); ");
                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFcdTarget")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star2)", "")) ?
                                  0 : dt.Compute("sum(star2)", ""))).ToString("#,##0;(#,##0); ");

                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFtarcrc")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star3)", "")) ?
                                  0 : dt.Compute("sum(star3)", ""))).ToString("#,##0;(#,##0); ");

                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFtarcra")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star4)", "")) ?
                                  0 : dt.Compute("sum(star4)", ""))).ToString("#,##0;(#,##0); ");
                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFtarpc")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star5)", "")) ?
                                  0 : dt.Compute("sum(star5)", ""))).ToString("#,##0;(#,##0); ");
                ((Label)this.gvStdKpi.FooterRow.FindControl("lblFtarpa")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star6)", "")) ?
                                  0 : dt.Compute("sum(star6)", ""))).ToString("#,##0;(#,##0); ");


                //((Label)this.gvStdKpi.FooterRow.FindControl("lblFtarothers")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(star7)", "")) ?
        ...
        private void Save_Value()
        {
            ...
            for (int i = 0; i < gvStdKpi.Rows.Count; i++)
            {
                double star1 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvcpTarget")).Text.Trim());
                double star2 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvcdTarget")).Text.Trim());
                double star3 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvtarcrc")).Text.Trim());
                double star4 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvtarcra")).Text.Trim());
                double star5 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvtarpc")).Text.Trim());
                double star6 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvtarpa")).Text.Trim());
                double star7 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvtarothers")).Text.Trim());


                double sval1 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindcp")).Text.Trim());
                double sval2 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindcd")).Text.Trim());
                double sval3 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindcrc")).Text.Trim());
                double sval4 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindcra")).Text.Trim());
                double sval5 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindpc")).Text.Trim());
                double sval6 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindpa")).Text.Trim());
                double sval7 = Convert.ToDouble("0" + ((TextBox)this.gvStdKpi.Rows[i].FindControl("txtgvindothers")).Text.Trim());
        ...
        protected void lnkappupdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
             ...
             //dv.RowFilter = ("kpigrp like '810100603901%'");
             //dt = dv.ToTable();
             //foreach (DataRow dr2 in tbl1.Rows)
             //{
             //    string empid = dr2["empid"].ToString();
        ...
        protected void gvStdKpi_SelectedIndexChanged(object sender, EventArgs e)
        {
