<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="GenPage.aspx.cs" Inherits="RealERPWEB.F_26_Alert.GenPage" %>
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:Panel ID="pnlbgd" runat="server" Visible="False">
                                <ul class="colMid">
                                    ...
                                    <li><a href="../F_04_Bgd/RptBgdPrjoject.aspx?Type=MasterBgdAcWk">01. Budgeted Income Statement -(Work)</a></li>
                                    <li><a href="../F_04_Bgd/RptBgdPrjoject.aspx?Type=MasterBgd">02. Budgeted Income Statement -(Resource)</a></li>
                                    <li><a href="../F_04_Bgd/RptBgdPrjoject.aspx?Type=WrkVsResource">03. Budgeted Work Vs. Resource</a></li>
                                    <li><a href="../F_04_Bgd/BgdPrjAna.aspx?InputType=BgdMainRpt&AnaType=1">04. Budgeted Cost-Work Basis</a></li>
                                    <li><a href="../F_04_Bgd/BgdPrjAna.aspx?InputType=BgdMainRpt&AnaType=0">05. Budgeted Cost-Resource Basis</a></li>
                                    <li><a href="../F_04_Bgd/BgdPrjAna.aspx?InputType=BgdMainRpt&AnaType=4">06. Cost-Analysis Sheet</a></li>
                                    <li><a href="../F_14_Pro/RptPurchaseStatus.aspx?Type=Purchase&Rpt=PurBilltk">07. Bill Tracking</a></li>
                            ...
                            <asp:Panel ID="pnlProCure" runat="server" Visible="False">
                                <ul class="colMid">
                                    ...
                                    <li><a href="../F_14_Pro/RptPurchaseStatus.aspx?Type=Purchase&Rpt=Purchasetrk">01. Purchase Tracking</a></li>
                                    <li><a href="../F_14_Pro/RptDateWiseReq.aspx?Type=PendingStatus">02. Pending Status</a></li>
                                    <li><a href="../F_14_Pro/RptPurchaseStatus.aspx?Type=Purchase&Rpt=DaywPur">03. Day Wise Purchase</a></li>
                                    <li><a href="../F_14_Pro/RptPurchaseStatus.aspx?Type=Purchase&Rpt=PurSum">04. Purchase Summary</a></li>

                                    <li><a href="../F_14_Pro/RptMatPurHistory.aspx">05. Purchase History-Materials Wise</a></li>
                                    <li><a href="../F_14_Pro/RptPurchaseStatus02.aspx?Type=Purchase">06. Purchase Summary with Opening</a></li>
                                    <li><a href="../F_17_Acc/RptAccSpLedger.aspx?Type=ASPayment">07. Supplier Overall Position</a></li>
                            ...
                            <asp:Panel ID="pnlMgtAcc" runat="server" Visible="False">
                                <ul class="colMid">
                                    <li>
                                        <h5>12. Management Accounts</h5>
                                    </li>
                                    <li><a href="../F_17_Acc/RptAccDTransaction.aspx?Type=Accounts&TrMod=IssuedVsCollect">01. Receipts & Payment(Actual)</a></li>
                                    <li><a href="../F_17_Acc/RptAccDTransaction.aspx?Type=Accounts&TrMod=RecPay">02. Receipts & Payment(Honoured)</a></li>
                                    <li><a href="../F_17_Acc/AccTrialBalance.aspx?Type=Mains">03. Trial Balance</a></li>
                                    <li><a href="../F_17_Acc/AccTrialBalance.aspx?Type=HOTB">04. Head Office Trial Balance</a></li>

                                    <li><a href="../F_17_Acc/AccTrialBalance.aspx?Type=Details">05. Details Of Balance Sheet</a></li>
                                    <li><a href="../F_17_Acc/AccFinalReports.aspx?RepType=PS">06. Project Report</a></li>
                                    <li><a href="../F_17_Acc/AccFinalReports.aspx?RepType=BE">07. Budget Vs Expenses</a></li>
                                    <li><a href="../F_32_Mis/ProjTrialBalanc.aspx?Type=PrjTrailBal">08. Project Trial Balance</a></li>
                            ...
                            <asp:Panel ID="pnlSales" runat="server" Visible="False">
                                <ul class="colMid">
                                    ...
                                    <li><a href="../F_22_Sal/RptSaleSoldunsoldUnit.aspx?Type=soldunsold">01. Sold & Unslod Informations</a></li>
                                    <li><a href="../F_22_Sal/RptSaleSoldunsoldUnit.aspx?Type=RptDayWSale">02. Day Wise Sales</a></li>
                                    <li><a href="../F_22_Sal/RptSalesInventory.aspx">03. Sales Inventory(Summary)</a></li>
                                    <li><a href="../F_22_Sal/RptRateChart.aspx">04. Sales Inventory(Details)</a></li>
                                    <li><a href="../GenPage.aspx?Type=All">05. Availability Chart 1</a></li>
                                    <li><a href="../F_23_CR/RptCustPayStatus.aspx?Type=Payment">06. Payment Status</a></li>
                                    <li><a href="../F_22_Sal/RptSalSummery.aspx?Type=dSaleVsColl">07. Sales & Collection Target Vs Achievement </a></li>
                            ...
                            <asp:Panel ID="pnlMis" runat="server" Visible="False">
                                <ul class="colMid">
                                    ...
                                    <li><a href="../F_17_Acc/RptAccSales.aspx">01. Sales, Received, Receivable & Cost</a></li>
                                    <li><a href="../F_34_Mgt/PurReqAdjst.aspx?Type=ProMargin">02. System Generated Sales (Upto Date)</a></li>
                                    <li><a href="F_32_Mis/RptSalesDuPeriod.aspx">03. System Generated Sales (Period)</a></li>
                            ...
                            <asp:Panel ID="pnlDoc" runat="server" Visible="False">
                                <ul class="colMid">
                                    ...
                                    <li><a href="../F_32_Mis/RptMisMasterBgd.aspx?Type=ComProCost">10. Any Cost-All Project (5 Years)</a></li>
                                    <li><a href="../F_32_Mis/RptProjectStatus.aspx?Type=PrjStatus">11. Project Status Report</a></li>
                                    <li><a href="../F_32_Mis/RptMisMasterBgd.aspx?Type=ColVsExpenses">12. Investment Plan - All Project</a></li>
