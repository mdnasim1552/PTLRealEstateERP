<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="GrpAccDashBoard.aspx.cs" Inherits="RealERPWEB.F_46_GrMgtInter.GrpAccDashBoard" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-1 col-md-1 col-lg-1">
                                    <a class="btn btn-primary primaryBtn" href='<%=this.ResolveUrl("~/GenPage.aspx?Type=22")%>' target="_blank" style="margin: 10px 0 0 5px; line-height: 18px;">NEXT-2</a>
