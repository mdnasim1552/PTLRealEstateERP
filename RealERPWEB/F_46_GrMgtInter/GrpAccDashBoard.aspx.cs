...
{
    public partial class GrpAccDashBoard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "ACCOUNTS DASHBOARD " + this.Request.QueryString["Desc"].ToString();
