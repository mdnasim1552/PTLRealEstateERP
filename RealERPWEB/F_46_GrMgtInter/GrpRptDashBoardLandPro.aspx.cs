...
{
    public partial class GrpRptDashBoardLandPro : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "DASHBOARD-LAND PROCUREMENT " + this.Request.QueryString["Desc"].ToString(); ;
