...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkAccMultiReport.aspx.cs" Inherits="RealERPWEB.F_45_GrAcc.LinkAccMultiReport" %>
        ...
        <div class="contentPart">
            <asp:MultiView ID="MultiView1" runat="server">
                <asp:View ID="ScheduleView" runat="server">
                    ...
                    <asp:GridView ID="gvSchedule" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea grvCenter"
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            <div class="form-horizontal">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <asp:Label ID="Label2" runat="server" Text="ACCOUNTS DETAILS SCHEDULE" CssClass="rptheadTitel1"></asp:Label>
                                        <asp:Label ID="lblRptPeriod" runat="server" Text="Reporting Period" CssClass="rptheadTitel2"></asp:Label>
                ...
                <asp:View ID="ViewFxtAsset" runat="server">
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-6 text-center">
                                        <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="14px" Height="16px"
                                            Style="text-align: right; color: #000;" Text="From" Width="120px"></asp:Label>
                                        <asp:Label ID="lblFdate" runat="server" BackColor="White" BorderStyle="None" Font-Bold="True"
                                            ForeColor="Black" Width="100px"></asp:Label>
                                        <asp:Label ID="Label3124" runat="server" Font-Bold="True" Font-Size="14px" Height="16px"
                                            Style="text-align: right; color: #000;" Text="To:" Width="20px"></asp:Label>

                                        <asp:Label ID="lblTDate" runat="server" BackColor="White" BorderStyle="None" Font-Bold="True"
                                            ForeColor="Black" Width="100px"></asp:Label>
                        ...
                        <asp:GridView ID="gvFxtAsset" runat="server" AutoGenerateColumns="False"
                            ShowFooter="True" CssClass="table-striped table-hover table-bordered grvContentarea grvCenter">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Acc. Description">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvAccDesc" runat="server" Text='<%# "<B>"+ Convert.ToString(DataBinder.Eval(Container.DataItem, "actdesc")) + "</B>"+
                                ...
                                <asp:TemplateField HeaderText="Res. Description" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvSupname" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "resdesc")) %>'
                                            Width="180px"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Opening Dr.">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvOpDramt" runat="server" Style="text-align: right" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "opndram")).ToString("#,##0;(#,##0); ") %>'
                                            Width="70px"></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lgvFOpDramt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                ...
                                <asp:TemplateField HeaderText="Opening Cr.">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvOpCramt" runat="server" Style="text-align: right" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "opncram")).ToString("#,##0;(#,##0); ") %>'
                                            Width="70px"></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lgvFOpCramt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                            Style="text-align: right" Width="70px"></asp:Label>
                                    </FooterTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Right" />
                                ...
                                <asp:TemplateField HeaderText="Dr.">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvDramt" runat="server" Style="text-align: right" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "dram")).ToString("#,##0;(#,##0); ") %>'
                                            Width="70px"></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lgvFDramt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                            Style="text-align: right" Width="70px"></asp:Label>
                                    </FooterTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Right" />
                                ...
                                <asp:TemplateField HeaderText="Cr.">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvCramt" runat="server" Style="text-align: right" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "cram")).ToString("#,##0;(#,##0); ") %>'
                                            Width="70px"></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lgvFCramt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                            Style="text-align: right" Width="70px"></asp:Label>
                                    </FooterTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Right" />
                                ...
                                <asp:TemplateField HeaderText="Closing Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvClsamt" runat="server" Style="text-align: right" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "closam")).ToString("#,##0;(#,##0); ") %>'
                                            Width="70px"></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lgvFClsamt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                            Style="text-align: right" Width="70px"></asp:Label>
                                    </FooterTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Right" />
