...
{
    public partial class LinkGrpRevsiFeasibility : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ((Label)this.Master.FindControl("lblTitle")).Text = (Request.QueryString["Type"].ToString().Trim() == "PrjInfo") ? "Project Feasibility Project Information"
                    : ((Request.QueryString["Type"].ToString().Trim() == "Cost") ? "Project Feasibility Cost Information" : "Project Feasibility Revenue Information");
        ...
        protected void lnkPrint_Click(object sender, EventArgs e)
        {
            ...
            string prjname = this.lblProjectName.Text;
