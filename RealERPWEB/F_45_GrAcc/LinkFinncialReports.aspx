...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkFinncialReports.aspx.cs" Inherits="RealERPWEB.F_45_GrAcc.LinkFinncialReports" %>
                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        <asp:View ID="ISView" runat="server">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-4 pading5px asitCol4">
                                        <asp:Label ID="Label10" runat="server" CssClass="lblTxt lblName" Text="Income Statement" Visible="False"></asp:Label>
                        ...
                        <asp:View ID="BSView" runat="server">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-4 pading5px asitCol4">
                                        <asp:Label ID="Label11" runat="server" CssClass="lblTxt lblName" Text="Balance Sheet" Visible="False"></asp:Label>
                        ...
                        <asp:View ID="PSView" runat="server">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-md-3 pading5px asitCol3">
                                                ...
                                                <asp:TextBox ID="txtSearch" runat="server" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>
                                                <asp:LinkButton ID="ImgbtnFindProj" runat="server" CssClass="btn btn-primary srearchBtn colMdbtn" OnClick="ImgbtnFindProj_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>

                                            </div>

                                            <div class="col-md-4 pading5px ">
                                                <asp:DropDownList ID="ddlAccProject" runat="server" CssClass="form-control inputTxt"
                                                    OnSelectedIndexChanged="ddlAccProject_SelectedIndexChanged">
                                                </asp:DropDownList>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3 pading5px asitCol3">
                                                <asp:Label ID="Label14" runat="server" CssClass="lblTxt lblName">Resource Name:</asp:Label>
                                                <asp:TextBox ID="txtSrcRes" runat="server" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 pading5px asitCol3">
                                                <asp:Label ID="Label3" runat="server" CssClass="smLbl_to" Text="Report Level"></asp:Label>
                            ...
                            <asp:GridView ID="dgvPS" runat="server" AutoGenerateColumns="False" BackColor="#DDFFEE"
                                ShowFooter="True" Width="1010px" CssClass="table-striped table-hover table-bordered grvContentarea">
                                <Columns>
                        ...
                        <asp:View ID="BEView" runat="server">
                            <div class="row">
                                <fieldset class="scheduler-border fieldset_A">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-md-3 pading5px asitCol3">
                                                <asp:Label ID="Label15" runat="server" CssClass="lblTxt lblName">Project Name:</asp:Label>
                                                <asp:TextBox ID="txtSearchp" runat="server" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>
                                                <asp:LinkButton ID="ImgbtnFindProjI" runat="server" CssClass="btn btn-primary srearchBtn colMdbtn" OnClick="ImgbtnFindProjI_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>

                                            </div>

                                            <div class="col-md-4 pading5px ">
                                                <asp:DropDownList ID="ddlHAccProject" runat="server" CssClass="form-control inputTxt" OnSelectedIndexChanged="ddlAccProject_SelectedIndexChanged">
                                                </asp:DropDownList>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 pading5px asitCol3">
                                                <asp:Label ID="Label5" runat="server" CssClass="smLbl_to" Text="Report Level"></asp:Label>
                                                <asp:DropDownList ID="ddlRptGroupbve" runat="server" CssClass="smDropDown inputTxt"
                                                    TabIndex="6">
                                                    <asp:ListItem>Main</asp:ListItem>
                                                    <asp:ListItem>Sub-1</asp:ListItem>
                                                    <asp:ListItem>Sub-2</asp:ListItem>
                            ...
                            <asp:GridView ID="dgvBE" runat="server" AutoGenerateColumns="False"
                                ShowFooter="True" Width="850px" CssClass="table-striped table-hover table-bordered grvContentarea">
                                <Columns>
                                    <asp:TemplateField HeaderStyle-Font-Size="12px" HeaderText="Code" Visible="False">
                                        <ItemTemplate>
                        ...
                        <asp:View ID="SpcCode" runat="server">
                            <div class="row">
                                <fieldset class="scheduler-border fieldset_A">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-md-3 pading5px asitCol3">
                                                <asp:Label ID="Label20" runat="server" CssClass="lblTxt lblName">Project Name:</asp:Label>
                                                <asp:TextBox ID="txtSearchpSpc" runat="server" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>
                                                <asp:LinkButton ID="ImgbtnFindProjSpc" runat="server" CssClass="btn btn-primary srearchBtn colMdbtn" OnClick="ImgbtnFindProjSpc_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>

                                            </div>

                                            <div class="col-md-4 pading5px ">
                                                <asp:DropDownList ID="ddlProject" runat="server" CssClass="form-control inputTxt">
                                                </asp:DropDownList>
                            ...
                            <asp:GridView ID="dgvSPC" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea"
                                 ShowFooter="True"
                                Width="753px">
                                <Columns>
                                    <asp:TemplateField HeaderText="Code">
                        ...
                        <asp:View ID="InComeInd" runat="server">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-md-3 pading5px asitCol3">
                                                ...
                                                <asp:TextBox ID="txtSearchpIndp" runat="server" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>
                                                <asp:LinkButton ID="ImgbtnFindProjind" runat="server" CssClass="btn btn-primary srearchBtn colMdbtn" OnClick="ImgbtnFindProjind_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>

                                            </div>

                                            <div class="col-md-4 pading5px ">
                                                <asp:DropDownList ID="ddlProjectInd" runat="server" CssClass="form-control inputTxt">
                                                </asp:DropDownList>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 pading5px asitCol3">
                                                ...
                                                <asp:RadioButtonList ID="rbtnList1" runat="server" CssClass="smDropDown inputTxt"
                            ...
                            <asp:GridView ID="gvIncome" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvIncome_RowDataBound"
                                ShowFooter="True" Width="758px" CssClass="table-striped table-hover table-bordered grvContentarea">
                                <RowStyle />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lgvFTAmt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                            ...
                            <asp:GridView ID="gvInfast" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                Width="758px" CssClass="table-striped table-hover table-bordered grvContentarea">
                                <RowStyle />
                                <Columns>
                                    <asp:TemplateField HeaderText="Sl.No.">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lgvFTfAmt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="White"
                                                Style="text-align: right" Width="75px"></asp:Label>
                                        </FooterTemplate>
                                        <ItemStyle HorizontalAlign="Right" />
                                        <FooterStyle Font-Bold="True" HorizontalAlign="right" />
                        ...
                        <asp:View ID="SPBalSheet" runat="server">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-4 pading5px asitCol4">
                                        <asp:Label ID="Label22" runat="server" CssClass="lblTxt lblName" Text="Special Balance Sheet" Visible="False"></asp:Label>

                                    </div>
                                </div>
                            </div>
                            <asp:GridView ID="dgvSpBS" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea"
                                 OnRowDataBound="dgvSpBS_RowDataBound"
                                Width="640px">
                                <Columns>
                                    <asp:TemplateField HeaderText="Description Of accounts">
                                        <ItemTemplate>
