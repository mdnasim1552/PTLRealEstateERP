...
namespace RealERPWEB.F_45_GrAcc
{
    public partial class RptGrpMisDailyActiviteis : System.Web.UI.Page
    {
        ...
        protected void lbtnPrint_Click(object sender, EventArgs e)
        {
            ...
            ReportDocument rrs1 = new RealERPRPT.R_45_GrAcc.RptGrpMisMgtActivities();
        ...
        protected void gvrcoll_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else
                {
                    ...
                    graph.NavigateUrl = "~/F_45_GrAcc/LinkGrpMisGraph.aspx?comcod=" + code + "&capacity=" + Capacity + "&masbgd=" + Masbgd + "&bep=" + Bep + "&ttargetamt=" + ttargetamt1 + "&targetamt=" + targetamt1 + "&acsalamt=" + accollamt1;
        ...
        protected void gvarecandpayis_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label Company = (Label)e.Row.FindControl("lblgvCompanyrecapayis");
        ...
        protected void gvpdc_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                HyperLink HLgvDescpaysum = (HyperLink)e.Row.FindControl("HLgvCompanypaysum");
        ...
        protected void gvFeasibility_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label amargin = (Label)e.Row.FindControl("lblgvfeamargin");
                HyperLink revcost = (HyperLink)e.Row.FindControl("hlnkgvfeacost");
                ...
                if (code == "51001")
                {
                    double oramt = Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "oramt"));
                    double revamt = Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "revamt"));
                    if (oramt > revamt)
                    {
                        amargin.Style.Add("color", "red");
                ...
                else if (code == "51004")
                {
                    ...
                    revcost.Font.Bold = true;
                    revcost.Style.Add("color", "blue");
                    revcost.NavigateUrl = "~/F_45_GrAcc/LinkGrpMisDailyActivities.aspx?Type=GPNPALLPRO&comcod=" + comcod + "&date=" + this.txttodate.Text.Trim();
        ...
        protected void gvcomwclients_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                HyperLink SalDem = (HyperLink)e.Row.FindControl("hlnkgvSalDem");
                HyperLink SalDec = (HyperLink)e.Row.FindControl("hlnkgvSalDec");
                HyperLink CliCap = (HyperLink)e.Row.FindControl("hlnkgvCliCap");
                HyperLink CliHis = (HyperLink)e.Row.FindControl("hlnkgvCliHis");
                HyperLink SalPHis = (HyperLink)e.Row.FindControl("hlnkgvSalPHis");
                ...
                SalDem.Style.Add("color", "blue");
                SalDem.NavigateUrl = "~/F_45_GrAcc/LinkGrpProWiseClOffered.aspx?Type=SalesDeamnd&comcod=" + code + "&Date2=" + Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy");

                SalDec.Style.Add("color", "blue");
                SalDec.NavigateUrl = "~/F_45_GrAcc/LinkGrpProWiseClOffered.aspx?Type=SalesDeci&comcod=" + code + "&Date2=" + Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy");

                CliCap.Style.Add("color", "blue");
                CliCap.NavigateUrl = "~/F_45_GrAcc/LinkGrpProWiseClOffered.aspx?Type=Capacity&comcod=" + code + "&Date2=" + Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy");

                CliHis.Style.Add("color", "blue");
                CliHis.NavigateUrl = "~/F_45_GrAcc/LinkGrpMktAppointment.aspx?Type=DiscussHis&UType=Mgt&comcod=" + code + "&Date1=" + Convert.ToDateTime(this.txtDate.Text).ToString("dd-MMM-yyyy") + "&Date2=" + Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy");

                SalPHis.Style.Add("color", "blue");
                SalPHis.NavigateUrl = "~/F_45_GrAcc/LinkGrpMktAppointment.aspx?Type=OffPerformance&UType=Mgt&comcod=" + code + "&Date1=" + Convert.ToDateTime(this.txtDate.Text).ToString("dd-MMM-yyyy") + "&Date2=" + Convert.ToDateTime(this.txttodate.Text).ToString("dd-MMM-yyyy");
