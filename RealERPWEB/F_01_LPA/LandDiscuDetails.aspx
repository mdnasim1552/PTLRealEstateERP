<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LandDiscuDetails.aspx.cs" Inherits="RealERPWEB.F_01_LPA.LandDiscuDetails" %>
                    ...
                    <div class="row">
                        ...
                        <asp:Repeater ID="repteClientDetail" OnItemDataBound="repteClientDetail_ItemDataBound" runat="server">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Label runat="server" CssClass="hidden" Text='<% #Eval("teamcode")%>' ID="lblteam"></asp:Label>
                                        ...
                                        <div class="col-sm-12 panel">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                ...
                                                <p>
                                                    ...
                                                    <%# Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.createdate")).ToString("dd-MMM-yyyy") %>
                                                </p>
                                            ...
                                            <div class="col-xs-12 col-sm-9 pading5px panel">
                                                <h5><span class="pull-right">Land Followup ? - <span class=" badge bg-danger stcolor"><%# DataBinder.Eval(Container, "DataItem.fstatus")%></span></span>
                                                    <span style="margin-right: 120px; float: right">Status- <span class="badge bg-primary stcolor "><%# DataBinder.Eval(Container, "DataItem.clstatus")%>  </span>
                                                    <span style="margin-right: 240px; float: left">Dealing- <span class="badge bg-primary stcolor "><%# DataBinder.Eval(Container, "DataItem.teamdesc")%>  </span></h5>
                                                        ...
                                                        <table class="table no-border custom_table dataTable no-footer dtr-inline">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="width: 80px;" class="text-center">Meeting </br>Date</th>
                                                                    <th class="text-center">Meeting </br>Type</th>
                                                                    <th style="width: 80px;" class="text-center">Offered </br>Price </th>
                                                                    <th style="width: 150px;" class="text-center">Discussion</th>
                                                                    <th style="width: 120px; " class="text-center">Participants</th>
                                                                    <th class="text-center">Next </br>Followup</th>
                                                                    <th style="width: 80px;" class="text-center">Next </br> Appointment</th>
                                                                    <th style="width: 120px;" class="text-center">Subject</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 80px;">
                                                                 ...
                                                                 <td>
                                                                    <asp:Label runat="server" Text='<% #Eval("kpigrpdesc")%>' ID="Label7"></asp:Label></td>
                                                                <td style="width: 80px; text-align: right">
                                                                    <asp:Label runat="server" Text='<% #Convert.ToDouble(Eval("ofpamt")).ToString("#,##0;(#,##0);")%>' ID="Label5"></asp:Label>
                                                                </td>
                                                                <td style="width: 150px; font-size:9px;">
                                                                    <asp:Label runat="server" Text='<% #Eval("discus")%>' ID="Label2"></asp:Label></td>

                                                                 <td style="width: 120px; font-size:8px;">
                                                                    <asp:Label runat="server" Text='<% #Eval("partcilist")%>' ID="Label8"></asp:Label></td>
                                                               
                                                                  <td>
                                                                    <asp:Label runat="server" Text='<% #Eval("nfollowup")%>' ID="Label9"></asp:Label></td>
                                                                <td style="width: 80px;">

                                                                    <asp:Label runat="server" Text='<% #Eval("napnt1")%>' ID="Label4"></asp:Label>
                                                                </td>
                                                                 <td style="width: 120px; font-size:9px;">
                                                                    <asp:Label runat="server" Text='<% #Eval("ndissub")%>' ID="Label10"></asp:Label></td>
                                                            </tr>
                                                        </tbody>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
