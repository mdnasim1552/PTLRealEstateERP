...
{
    public partial class LpProjectCodeBook : System.Web.UI.Page
    {
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                string code = (this.Request.QueryString["Type"] == "Land") ? "02%" : "03%";
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_LP_CODEBOOK", "GETLPGENCODE", code,
                                "", "", "", "", "", "", "", "");
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_LP_CODEBOOK", "INSERTUPLPPRGINF", tgcod,
                           gdesc, Gtype, "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_LP_CODEBOOK", "GETLPGENCODEDETAIL", tempddl1,
                            tempddl2, "", "", "", "", "", "", "");
