...
{
    public partial class LandProGenCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //((Label)this.Master.FindControl("lblTitle")).Text = "General Code Book";
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "GETGENCODE", "",
                                "", "", "", "", "", "", "", "");
                this.ddlOthersBook.DataTextField = "gdesc";
                this.ddlOthersBook.DataValueField = "gcode";
        ...
        protected void grvacc_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            {
                string eventtype = "General Code";
                string eventdesc = "Edit General Code Book";
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string gdesc2 = ((TextBox)this.grvacc.Rows[e.RowIndex].FindControl("txtgrGdesc2")).Text.Trim();
            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "INSERTUPLREGINF", tgcod,
                           gdesc, gdesc2, "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "SHOWGENCODEDETAILS", tempddl1,
                            tempddl2, "", "", "", "", "", "", "");
