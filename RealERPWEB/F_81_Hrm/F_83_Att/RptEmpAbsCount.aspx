                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Emp ID" Visible="false">
                                       ...
                                       <asp:TemplateField HeaderText="Department">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDepart" runat="server" Width="150px" Height="16px" Text='<%#  Convert.ToString(DataBinder.Eval(Container.DataItem, "deptname"))  %>'
                                                ></asp:Label>
                                        </ItemTemplate>
...
<%--                                    <asp:TemplateField HeaderText="Card #">
                                    ...
                                    <asp:TemplateField HeaderText="Total Absent</br>Day">
                                        <ItemTemplate>
                                          <asp:Label ID="lbltotalabs" runat="server" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "abscount")).ToString("#,##0;(#,##0); ") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
