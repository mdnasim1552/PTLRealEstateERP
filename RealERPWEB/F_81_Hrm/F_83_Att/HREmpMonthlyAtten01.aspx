<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="HREmpMonthlyAtten01.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_83_Att.HREmpMonthlyAtten01" %>
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                             ...
                             <div class="form-group">
                                    <div class="col-md-3 pading5px asitCol3">
                                        ...
                                        <asp:LinkButton ID="imgbtnCompany" runat="server" CssClass="btn btn-primary srearchBtn"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
                                    </div>
                                    <div class="col-md-4 pading5px asitCol4">
                                        ...
                                        <div class="pull-left">
                                            <asp:LinkButton ID="lnkbtnShow" runat="server" CssClass="btn btn-primary okBtn pull-left">ok</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                            </div>
