<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="EmpEarlyLeaveApproval.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_83_Att.EmpEarlyLeaveApproval" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlEmpName" AutoPostBack="True" runat="server" CssClass="chzn-select form-control form-control-sm" TabIndex="3">
                                </asp:DropDownList>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:Label ID="lblCompany" runat="server" CssClass=" inputlblVal"></asp:Label>
                            </div>
                        </div>
                ...
                <asp:GridView ID="gvMonthlyAttn" runat="server" AutoGenerateColumns="False" ShowFooter="True" CssClass=" table-striped table-hover table-bordered grvContentarea"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Approved">
                            <ItemTemplate>
                                <asp:CheckBox ID="txtgvapproved" runat="server" BackColor="Transparent" BorderStyle="None"
                                    Checked='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "earleaveapp"))==true?true:false %>'
                                    Width="40px" Font-Size="11px"></asp:CheckBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Remarks">
                            <ItemTemplate>
                                <asp:TextBox ID="txtgvrmrks" runat="server" BackColor="Transparent" BorderStyle="None"
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px ">
                                        <asp:DropDownList ID="ddlEmpName" AutoPostBack="True" runat="server" CssClass="chzn-select form-control inputTxt" TabIndex="3">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 pading5px">
                                        ...
                                        <asp:DropDownList ID="ddlMonth" runat="server" AutoPostBack="True"
                                            CssClass=" ddlPage chzn-select" TabIndex="3"
                                            OnSelectedIndexChanged="ddlMonth_SelectedIndexChanged" >
                                        </asp:DropDownList>
