                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="tfDisabled">Company</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="tfDisabled">Department</label>
                                    <asp:DropDownList ID="ddlProjectName" runat="server" CssClass="form-control chzn-select" OnSelectedIndexChanged="ddlProjectName_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <asp:Label class="control-label" runat="server" ID="lblfrmdate" for="tfDisabled">From</asp:Label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <asp:Label class="control-label" runat="server" ID="lbltodate" for="tfDisabled">To</asp:Label>
                            ...
                            <div class="col-md-2">
                                <asp:LinkButton ID="lnkbtnShow" runat="server" CssClass="btn btn-primary btn-sm mt-3" OnClick="lnkbtnShow_Click">Ok</asp:LinkButton>
                            </div>
                        </div>
                        <div class="row">
