                    ...
                    <div class="row">
                        <div class="col-sm-1 col-md-1 col-lg-1">
                            <div class="form-group">
                                ...
                                <cc1:CalendarExtender ID="txtCurTransDate_CalendarExtender" runat="server" Format="dd.MM.yyyy"
                                        ...
                                        <asp:TemplateField HeaderText="Company Name">
                                            <HeaderTemplate>
                                                ...
                                                <asp:HyperLink ID="hlbtntbCdataExcelemplist" runat="server"
                                                    CssClass="btn  btn-success btn-xs " ForeColor="White" ToolTip="Export Excel"><i class="fas fa-file-excel"></i></asp:HyperLink>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lnkbtnApproved" runat="server"
                                                    OnClick="lnkbtnApproved_Click" ToolTip="Click for Transfer"> <span class=" fa fa-check "></span> </asp:LinkButton>
                                            </HeaderTemplate>
                            ...
                            <asp:Panel ID="pnlToCompany" runat="server" CssClass="well padingLeft5px" Visible="false">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlToCompany" runat="server" CssClass="form-control  chzn-select" OnSelectedIndexChanged="ddlToCompany_SelectedIndexChanged" AutoPostBack="true" TabIndex="2">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlToProject" runat="server" CssClass="form-control  chzn-select" OnSelectedIndexChanged="ddlToProject_SelectedIndexChanged" AutoPostBack="true" TabIndex="2">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:Label ID="Label9" runat="server">Section</asp:Label>
                                        <asp:DropDownList ID="ddlToSection" runat="server" CssClass="form-control  chzn-select" OnSelectedIndexChanged="ddlToSection_SelectedIndexChanged" AutoPostBack="true" TabIndex="2">
                                        </asp:DropDownList>
                                    </div>
                                </div>
