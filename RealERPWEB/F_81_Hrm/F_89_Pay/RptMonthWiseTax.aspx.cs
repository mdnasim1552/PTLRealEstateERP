...
namespace RealERPWEB.F_81_Hrm.F_89_Pay
{
    ...
    public partial class RptMonthWiseTax : System.Web.UI.Page
    {
        ...
        protected void lbtnOk_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_REPORT_PAYROLL01", "SHOWEMPMONTHWISETAX", CompanyName, projectcode, section, frmdate, todate, empid, "", "", "");
            if (ds1 == null)
            {
