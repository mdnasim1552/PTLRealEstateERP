                    ...
                    <div class="row">
                        <asp:MultiView ID="MultiView1" runat="server">
                                    ...
                                    <asp:GridView ID="gvpayroll" runat="server" AllowPaging="false" CssClass="table-striped table-hover table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Joining Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lgDateJoin" runat="server"
                                            ...
                                            <asp:TemplateField HeaderText="Office Duty">
                                                <ItemTemplate>
                                                    <asp:Label ID="lgvoffdu" runat="server" Style="text-align: right"
                                            ...
                                            <asp:TemplateField HeaderText="Absday(Oth.)">
                                                <ItemTemplate>
                                                    <asp:Label ID="lFgvoffdu" runat="server" Style="text-align: right"
                                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "tabday")).ToString("#,##0;(#,##0); ") %>'
                                                        Width="50px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            ...
                                            <asp:TemplateField HeaderText="Advance/Others">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Total Deduction">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="gvlnkbtnTotalDed" runat="server" Style="text-align: right"  OnClick="gvlnkbtnTotalDed_Click"
                                            ...
                                            <asp:TemplateField HeaderText="Payble">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpayable" runat="server" Style="text-align: right"
                                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "payables")).ToString("#,##0;(#,##0); ") %>'
                                                        Width="55px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Foods & Others">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Arrea & Others">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Net Payable Salary">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Bank2 Amount">
                                                <ItemTemplate>
                            ...
                            <asp:View ID="viewspecialbonus" runat="server">
                                <fieldset class="scheduler-border fieldset_A">
                                    <div class="form-horizontal">
                                        <asp:Panel ID="Panelspbonus" runat="server">
                                            <div class="form-group">

                                                <div class="col-md-3 pading5px asitCol3">
                                                    <asp:Label ID="Label5" runat="server" CssClass="lblTxt lblName">Bonus(%):</asp:Label>
                                                    <asp:TextBox ID="txtspecialbonus" runat="server" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>
                                                    <asp:LinkButton ID="lnkbtnGenspBonus" runat="server" CssClass="btn btn-primary srearchBtn" OnClick="lnkbtnGenspBonus_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
                                                </div>


                                                <div class="col-md-2">
                                                    <asp:Label ID="lblfrmd" runat="server" CssClass="lblTxt lblName">Form</asp:Label>
                                                    <asp:DropDownList ID="ddlfrmDesig" runat="server" AutoPostBack="true" CssClass="ddlPage chzn-select" Width="174px" TabIndex="6">
                                                    </asp:DropDownList>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <asp:DropDownList ID="ddlToDesig" runat="server" Width="174px" CssClass="form-control inputTxt chzn-select" TabIndex="6">
                                                    </asp:DropDownList>
                                                </div>
                                        </asp:Panel>
                                    </div>
                                        ...
                                        <asp:TemplateField HeaderText="Section">
                                            ...
                                            <FooterTemplate>
                                                <asp:LinkButton ID="lbtnTotalsbonus" runat="server" Font-Bold="True"
                                                    Font-Size="12px" CssClass="btn btn-primary primarygrdBtn" OnClick="lbtnTotalsbonus_Click">Total</asp:LinkButton>
                                            </FooterTemplate>
                                            ...
                                            <HeaderTemplate>
                                                <table style="width: 200px;">
                                                    <tr>
                                                        ...
                                                        <td class="style60">&nbsp;</td>
                                                        <td>
                                                            <asp:HyperLink ID="hlbtntbCdataExelSP" runat="server" CssClass="btn btn-primary primarygrdBtn" Style="text-align: center" Width="110px">Export Excel</asp:HyperLink>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </HeaderTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Designation">
                                            ...
                                            <FooterTemplate>
                                                <asp:LinkButton ID="lnkUpSPBonus" runat="server" Font-Bold="True"
                                                    Font-Size="12px" CssClass="btn  btn-danger primarygrdBtn" OnClick="lnkUpSPBonus_Click">Update</asp:LinkButton>
                                            </FooterTemplate>
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Basic">
                    ...
                    <div class="modal-content  ">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">
                                <span class="fa fa-table"></span>Deduction Details</h4>
                        </div>
                        <div class="modal-body form-horizontal">
                            <div class="row-fluid">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" AllowPaging="false" CssClass="table-striped table-hover table-bordered grvContentarea"
                                        AutoGenerateColumns="False" OnPageIndexChanging="gvpayroll_PageIndexChanging"
                                        ShowFooter="True" Width="1500px">
                                        <PagerSettings Position="Top" Mode="NumericFirstLast" />
                                        <RowStyle />
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Absent">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lblmFabsent" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            ...
                                            <asp:TemplateField HeaderText="Income Tax">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lblmFitax" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            ...
                                            <asp:TemplateField HeaderText="Pro. Fund">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lblFpfund" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            ...
                                            <asp:TemplateField HeaderText="Gratuity Loan">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lblmFgratloan" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            ...
                                            <asp:TemplateField HeaderText="Car Loan">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lblmFCarlon" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            ...
                                            <asp:TemplateField HeaderText="Advance/Others">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lblmFadv" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            ...
                                            <asp:TemplateField HeaderText="Transport">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lblmFTrans" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            ...
                                            <asp:TemplateField HeaderText="Other ded.">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lblmFothded" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                            ...
                                            <asp:TemplateField HeaderText="Total Deduction">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblmtotded" runat="server" Style="text-align: right" OnClick="gvlnkbtnTotalDed_Click"
                                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "tdeduc")).ToString("#,##0;(#,##0); ") %>'
                                                        Width="45px"></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblmFtotded" runat="server" Font-Bold="True" Font-Size="12px"
                                                        ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
