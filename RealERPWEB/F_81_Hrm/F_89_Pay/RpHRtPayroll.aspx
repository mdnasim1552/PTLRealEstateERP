            ...
            <div class="card mt-5">
                <div class="card-header">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-6" id="divToDate" runat="server">
                        ...
                        <div class="col-lg-2" style="margin-top: 20px;" id="divChkDiff" runat="server" visible="false">
                            <asp:CheckBox ID="chckdiff" runat="server" Text="Print with bonus diffrence " />
                        </div>
