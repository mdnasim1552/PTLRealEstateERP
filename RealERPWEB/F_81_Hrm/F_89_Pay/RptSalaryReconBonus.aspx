<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="RptSalaryReconBonus.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_89_Pay.RptSalaryReconBonus" %>
                        ...
                        <asp:GridView ID="gvSalaryRecon" runat="server" PageSize="50"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="" >
                                  ...
                                  <asp:TemplateField HeaderText="" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblgvIdCard" runat="server" Font-Size="12px" Text='<%#  Convert.ToString(DataBinder.Eval(Container.DataItem, "idcard")) %>'
                                         ></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:Label ID="lblgvDesig" runat="server" Font-Size="12px" Text='<%#  Convert.ToString(DataBinder.Eval(Container.DataItem, "desig")) %>'
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:Label ID="lblgvbsal" runat="server" Font-Size="12px" Text='<%#  Convert.ToString(DataBinder.Eval(Container.DataItem, "bsal")) %>'
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:Label ID="lblgvbonamt" runat="server" Font-Size="12px" Text='<%#  Convert.ToString(DataBinder.Eval(Container.DataItem, "bonamt")) %>'
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                     <asp:Label ID="lblgvduration" runat="server" Font-Size="12px" Text='<%#  Convert.ToString(DataBinder.Eval(Container.DataItem, "duration")) %>'
                                            Width="80px"></asp:Label>
                                    </ItemTemplate>
