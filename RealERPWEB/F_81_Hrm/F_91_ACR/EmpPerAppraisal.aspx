                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-3 pading5px asitCol3">
                                        ...
                                        <asp:TextBox ID="textSrcCompanyApr" runat="server" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>
                                        <asp:LinkButton ID="ibtnFindCompanyApr" runat="server" CssClass="btn btn-primary srearchBtn colMdbtn" OnClick="ibtnEmpList_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
                                    </div>
                                    <div class="col-md-4 pading5px">
                                        <asp:DropDownList ID="ddlCompanyApr" runat="server" CssClass=" chzn-select form-control inputTxt">
                                        </asp:DropDownList>
                                        <asp:Label ID="lblCompanyNameAgg" runat="server" CssClass="form-control dataLblview" Height="22" Style="line-height: 1.5" Visible="false"></asp:Label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="lbldeptnameapr" runat="server" CssClass="lblTxt lblName">Department</asp:Label>
                                        <asp:TextBox ID="txtsrchdeptapr" runat="server" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>
                                        <asp:LinkButton ID="lbtndeptapr" runat="server" CssClass="btn btn-primary srearchBtn colMdbtn" OnClick="lbtndeptapr_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
                                    </div>
                                    <div class="col-md-4 pading5px">
                                        ...
                                        <asp:Label ID="lblvaldeptapr" runat="server" CssClass="form-control dataLblview" Height="22" Style="line-height: 1.5" Visible="false"></asp:Label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4 pading5px">
                                        <asp:DropDownList ID="ddlProjectName" runat="server" CssClass=" chzn-select form-control inputTxt" OnSelectedIndexChanged="ddlProjectName_SelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                                        <asp:Label ID="lblProjectdesc" runat="server" CssClass="form-control dataLblview" Height="22" Style="line-height: 1.5" Visible="false"></asp:Label>
                                    </div>
                                    <div class="col-md-2 pading5px asitCol3">
                                    ...
                                    <div class="col-md-3 pading5px">
                                        <asp:DropDownList ID="ddlPreList" runat="server" CssClass=" chzn-select form-control inputTxt" AutoPostBack="true">
                                        </asp:DropDownList>
                                  ...
                                  <asp:CheckBox ID="list3"  runat="server"   Visible="false" value="3"  Text=" 3 Mark"/>--%>
                                        ...
                                        <FooterTemplate>
                                            <asp:LinkButton ID="btndeleteApprisal" runat="server" Font-Bold="True"
                                                CssClass="btn btn-danger primaryBtn" OnClick="btndeleteApprisal_Click" Visible="false">Delete ALL </asp:LinkButton>
                                        </FooterTemplate>
                                        <FooterStyle Font-Bold="True" HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                    </asp:TemplateField>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 pading5px">
                                            <div class="input-group">
                                                ...
                                                <asp:TextBox ID="txtNarr" runat="server" class="form-control" TextMode="MultiLine" Height="60px"></asp:TextBox>
                                            </div>
                                        </div>
