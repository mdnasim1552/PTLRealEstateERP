<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="AllEmpList.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_92_Mgt.AllEmpList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card card-fluid container-data mt-5" style="min-height: 1000px;">
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-md-4" id="cmplist" runat="server" visible="False">
                    <div class="form-group">
                        <label for="ddlLvType">
                            List Of Companies
                        </label>
                        <asp:DropDownList ID="ddlComName" OnSelectedIndexChanged="ddlComName_OnSelectedIndexChanged" AutoPostBack="True" class="form-control" runat="server" TabIndex="2">
                        </asp:DropDownList>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlsection" runat="server" CssClass="chzn-select form-control" TabIndex="2">
                        </asp:DropDownList>
                    </div>
                </div>
