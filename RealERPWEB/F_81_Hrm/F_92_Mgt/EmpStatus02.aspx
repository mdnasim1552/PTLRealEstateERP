            ...
            <div class="card">
                <div class="card-header">
                     <div class="form-inline">
                                ...
                                <div class="form-group">
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="lblDept" runat="server" CssClass="lblTxt lblName">Section</asp:Label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:CheckBox ID="chkbdate" runat="server" AutoPostBack="True" Font-Bold="True" Font-Size="12px" ForeColor="Black"
                                ...
                                <asp:GridView ID="gvJoinEmp" runat="server" CssClass="table-striped table-hover table-bordered grvContentarea"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Salary">
                                            ...
                                            <FooterTemplate>
                                                <asp:Label ID="lblgvFsalary" runat="server" BackColor="Transparent" BorderStyle="None" BorderWidth="1px" Font-Bold="True" Font-Size="11px"
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-md-3 pading5px asitCol3">
                                                ...
                                                <asp:TextBox ID="txtSPType" runat="server" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>
                                                <asp:LinkButton ID="imgBtnSpType" runat="server" CssClass="btn btn-primary srearchBtn" OnClick="imgBtnSpType_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
                                            </div>
                                            <div class="col-md-4 pading5px asitCol4">
                                                <asp:DropDownList ID="ddlSepType" runat="server" Width="233" CssClass="form-control inputTxt pull-left" AutoPostBack="true" TabIndex="2">
                                                </asp:DropDownList>
                                            </div>
