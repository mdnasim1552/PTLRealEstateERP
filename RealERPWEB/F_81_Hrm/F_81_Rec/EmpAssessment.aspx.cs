...
{
    public partial class EmpAssessment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //((Label)this.Master.FindControl("lblTitle")).Text = "Empmloyee Assessment Form";
                this.txtCurDate.Text = System.DateTime.Today.ToString("dd-MMM-yyyy");
        ...
        private void GetEmployeeName()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_ENTRY_APPOINTMENT_LETTER", "GETEMPNAME", txtSProject, "", "", "", "", "", "", "", "");
        ...
        protected void ibtnEmpList_OnClick(object sender, EventArgs e)
        {
        ...
        private void GetAssGenInfo()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_ENTRY_APPOINTMENT_LETTER", "GETASSGENINFO", "", "",
                         "", "", "", "", "", "", "");
        ...
        protected void GetAssNO()
        {
            ...
            if (mAssNO == "NEWASS")
            {
                DataSet ds3 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_ENTRY_APPOINTMENT_LETTER", "LASTASSINFO", date, "", "", "", "", "", "", "", "");
        ...
        private void ShowAssInfo()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_ENTRY_APPOINTMENT_LETTER", "GETASSINFO", mAssNo, "",
                         "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
            ///////Here was
            ...
            if (mAssNo == "NEWASS")
            {
                DataSet ds3 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_ENTRY_APPOINTMENT_LETTER", "LASTASSINFO", CurDate1, "", "", "", "", "", "", "", "");
                if (ds3 == null)
                    return;
                this.lblCurNo1.Text = ds3.Tables[0].Rows[0]["maxassno1"].ToString().Substring(0, 6);
                this.lblCurNo2.Text = ds3.Tables[0].Rows[0]["maxassno1"].ToString().Substring(6);
        ...
        private void GetPreAssNo()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_ENTRY_APPOINTMENT_LETTER", "GETPREVASSNO", curdate, "", "", "", "", "", "", "", "");
        ...
        private void SaveValue()
        {
            ...
            for (int i = 0; i < this.gvAssessment.Rows.Count; i++)
            {
                ...
                dt.Rows[TblRowIndex]["good"] = good;
                dt.Rows[TblRowIndex]["avrg"] = avg;
                dt.Rows[TblRowIndex]["poor"] = poor;
                dt.Rows[TblRowIndex]["nill"] = nill;
        ...
        protected void lbtnUpPerAppraisal_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool result = false;
                result = HRData.UpdateTransInfo(comcod, "dbo_hrm.SP_ENTRY_APPOINTMENT_LETTER", "INSERTORUPDATEASS", "ASSINFB", assno, empid, curdate, txtref, "", "", "", "", "", "", "", "", "", "");
                ...
                foreach (DataRow dr1 in dt.Rows)
                {
                    ...
                    result = HRData.UpdateTransInfo(comcod, "dbo_hrm.SP_ENTRY_APPOINTMENT_LETTER", "INSERTORUPDATEASS", "ASSINFA", assno, gcod, desc, exc, good,
                        avg, poor, nill, "", "", "", "", "", "");
                    if (!result)
                    {
        ...
        protected void lnkPrint_Click(object sender, EventArgs e)
        {
            ...
            string title = "Employee Assessment Form";
            DataTable dt1 = (DataTable)ViewState["tblAss"];
            DataTable dt2 = (DataTable)ViewState["tblEmp"];
            string empId = this.ddlEmpName.SelectedValue;
            string empname = dt2.Select("empid='" + empId + "'")[0]["empname1"].ToString();
            string desig = dt2.Select(("empid='" + empId + "'"))[0]["desig"].ToString();
            string section = dt2.Select(("empid='" + empId + "'"))[0]["section"].ToString();
            ...
            Rpt1 = RDLCAccountSetup.GetLocalReport("R_81_Hrm.R_81_Rec.RptEmpAss", list, null, null);
            ...
            Rpt1.SetParameters(new ReportParameter("txtSec", section));
