<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="EmpFoodingRate.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_86_All.EmpFoodingRate" %>
                ...
                <div class="card-header">
                    <div class="row">
                     ...
                     <div class="form-group">
                         ...
                         <input name="txtTerm" onkeyup="filter2(this, '<%=gvEmpfood.ClientID %>')" type="text" class="form-control form-control-sm" placeholder="Search here">
                 </div>
                           </div>
                        <div class="col-lg-1">
