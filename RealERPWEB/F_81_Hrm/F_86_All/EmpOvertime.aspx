<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EmpOvertime.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_86_All.EmpOvertime" %>
                    ...
                    <div class="form-group">
                            ...
                            <asp:GridView ID="gvEmpMbill" runat="server" AllowPaging="True" CssClass="table-striped table-hover table-bordered grvContentarea"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Card #">
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbtnTotalmBill" runat="server"  CssClass="btn btn-primary primaryBtn"  OnClick="lbtnTotalmBill_Click"
                                    ...
                                    <asp:TemplateField HeaderText="Employee Name & Designation">
                                        ...
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbntUpdateMbill" runat="server"  CssClass="btn btn-danger primaryBtn"  OnClick="lbntUpdateMbill_Click"
                        ...
                        <asp:View ID="VieweNCAHSLEAVE" runat="server">
                            <asp:GridView ID="gvEmpELeave" runat="server" AllowPaging="True" CssClass="table-striped table-hover table-bordered grvContentarea"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Card #">
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbtnTotalEnLeave" runat="server" CssClass="btn btn-primary primaryBtn"  OnClick="lbtnTotalEnLeave_Click"
                                                >Total</asp:LinkButton>
                                        </FooterTemplate>
                                        <ItemTemplate>
                    ...
                    <div class="form-group">
                            ...
                            <asp:GridView ID="gvEmpOtherded" runat="server" AllowPaging="True" CssClass="table-striped table-hover table-bordered grvContentarea"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Card #">
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbtnTotalOtherDed" runat="server" CssClass="btn btn-primary primaryBtn" OnClick="lbtnTotalOtherDed_Click"
                                                >Total</asp:LinkButton>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblgvCardno" runat="server"
...
<%--                                     <asp:TemplateField>
                        ...
                        <asp:View ID="loandeduction" runat="server">
                            <asp:GridView ID="gvEmploan" runat="server" AllowPaging="True" CssClass="table-striped table-hover table-bordered grvContentarea"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Card #">
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbtnTotalLoan" runat="server" CssClass="btn btn-primary primaryBtn" OnClick="lbtnTotalLoan_Click"
                                                >Total</asp:LinkButton>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Employee Name & Designation">
                                        ...
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbntUpdateLoan" runat="server" CssClass="btn btn-danger primaryBtn" OnClick="lbntUpdateLoan_Click"
                                                >Update</asp:LinkButton>
                                        </FooterTemplate>
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                    </asp:TemplateField>
                        ...
                        <asp:View ID="Viewarersalary" runat="server">
                         ...
                         <asp:Panel ID="Pnlarrer" runat="server" Visible="false" Style=" border:1px solid blue;">
                        
                         <div class="form-group">
                            <div class="col-md-5 pading5px ">
                                <asp:Label ID="Label8" runat="server" CssClass=" smLbl_to" Text="Month:"></asp:Label>

                                <asp:DropDownList ID="ddlprearrear" runat="server" AutoPostBack="True"
                                    TabIndex="11" CssClass=" ddlPage">
                                </asp:DropDownList>
                    ...
                    <div class="form-group">
                            ...
                            <asp:GridView ID="gvarrear" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Card #">
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbtnTotalArrear" runat="server" CssClass="btn btn-primary primaryBtn"  OnClick="lbtnTotalArrear_Click"
                                                >Total</asp:LinkButton>
                                        </FooterTemplate>
                                        <ItemTemplate>
                    ...
                    <div class="form-group">
                            ...
                            <asp:GridView ID="gvothearn" runat="server" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Card #">
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbtnTotalOthEarn" runat="server" CssClass="btn btn-primary primaryBtn" OnClick="lbtnTotalOthEarn_Click"
                                                >Total</asp:LinkButton>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Employee Name &amp; Designation">
                                        ...
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbntUpdateOthEarn" runat="server"  OnClick="lbntUpdateOthEarn_Click" CssClass="btn btn-danger primaryBtn"
                                               >Update</asp:LinkButton>
                                        </FooterTemplate>
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="HardShip Allowance" Visible="false" >
                                        <ItemTemplate>
                                   ...
                                   <asp:TemplateField HeaderText="Trip days" Visible="false">
                                        <ItemTemplate>
                                   ...
                                   <asp:TemplateField HeaderText="Trip Amt" Visible="false">
                                        <ItemTemplate>
                            ...
                            <asp:GridView ID="grvAdjDay" runat="server" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Approved Days">
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbtnCalCulationSadj" runat="server"  OnClick="lbtnCalCulationSadj_Click"
