                        ...
                        <asp:View ID="ViewOvertime" runat="server">
                            ...
                            <asp:GridView ID="gvEmpOverTime" runat="server" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <%--8--%>
                                       <asp:TemplateField HeaderText="Fix Hour">
                                        <ItemTemplate>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Employee Name">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label  runat="server" ID="lblempid" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "empid")) %>'  Visible="false">   </asp:Label>
                                        </ItemTemplate>


                               
                                       <FooterTemplate>
                                            <asp:LinkButton ID="lnkencashUpdate" runat="server" CssClass="btn btn-danger primaryBtn" OnClick="lnkencashUpdate_Click">Update</asp:LinkButton>
                                        </FooterTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="From Date">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblfrmdat"
                                    ...
                                    <asp:TemplateField HeaderText="To Date">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lbltodat"
                                    ...
                                    <asp:TemplateField HeaderText="DUE E/L">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblduelv"
                                    ...
                                    <asp:TemplateField HeaderText="Availed">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblenjoyed"
                                    ...
                                    <asp:TemplateField HeaderText="E/L FOR ENCASHMENT ">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtballve" runat="server" BackColor="Transparent"
                                                BorderStyle="None"
                                                Style="text-align: right"
                                                Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "elencashday")).ToString("#,##0.00;(#,##0.00); ") %>'
                                                Width="80px"></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    ...
                                    <asp:TemplateField HeaderText="Present Sal.">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblsal"
                                    ...
                                    <asp:TemplateField HeaderText="Encashment Amt ">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblencashamt"
                                      
                                                 Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "encashamt")).ToString("#,##0;(#,##0); ") %>'
                                                Width="80px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
