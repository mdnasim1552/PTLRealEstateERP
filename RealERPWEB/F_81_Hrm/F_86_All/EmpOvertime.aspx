                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-lg-1 col-md-3 col-sm-4">
                                ...
                                <asp:TextBox ID="txtSrcCompany" runat="server" CssClass="form-control inpPixedWidth"></asp:TextBox>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4">
                                ...
                                <asp:TextBox ID="txtSrcDepartment" runat="server" CssClass="form-control inpPixedWidth"></asp:TextBox>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                <asp:Label ID="Label7" runat="server" CssClass="lblTxt lblName">Section
                                     <asp:LinkButton ID="imgbtnSecSrch" runat="server" OnClick="imgbtnSecSrch_Click"><span class="fas fa-search"> </span></asp:LinkButton>
                                </asp:Label>
                                <asp:TextBox ID="txtSrcSec" runat="server" CssClass="form-control inpPixedWidth"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <asp:Panel ID="pnlDedEarnExcel" runat="server" Visible="false">
