                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:CommandField ShowDeleteButton="True" />--%>
                                    ...
                                    <asp:TemplateField HeaderText="Employee Name">
                                        <ItemTemplate>
                                             <asp:Label ID="lblempid" runat="server" Font-Bold="true" Font-Size="11px" Visible="False"
                                                Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "empid")) %>'
                                                Width="160px"></asp:Label>
                                            <asp:Label ID="lblgvempname" runat="server" Font-Bold="true" Font-Size="11px"
                                    ...
                                    <asp:TemplateField HeaderText="Designation">
                                        ...
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lbntUpdateOtherDed" runat="server" CssClass="btn btn-danger primaryBtn" OnClick="lbntUpdateOtherDed_OnClick" 
