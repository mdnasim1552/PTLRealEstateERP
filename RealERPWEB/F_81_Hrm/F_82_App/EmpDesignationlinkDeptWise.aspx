<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EmpDesignationlinkDeptWise.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_82_App.EmpDesignationlinkDeptWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function pageLoaded() {
            ...
            var gvEmpListTrans = $('#<%=this.gvEmpListslno.ClientID %>');
                                    ...
                                    <asp:TemplateField HeaderText="Company Name">
                                        ...
                                        <asp:TemplateField HeaderText="Department Name">
                                         ...
                                         <asp:TemplateField HeaderText="Employee Name">
                                            ...
                                            <FooterTemplate>
                                            <asp:LinkButton ID="lbntUpdateSl" runat="server" OnClick="lbntUpdateSl_Click" CssClass="btn btn-danger primaryBtn"  >Update</asp:LinkButton>
                                        </FooterTemplate>
