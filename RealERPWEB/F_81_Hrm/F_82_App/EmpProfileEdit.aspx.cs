...
{
    public partial class EmpProfileEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Edit Profile";
                CommonButton();
            }
        }
        ...
        private void GetEmployeeName()
        {
            ...
            string txtSProject = "%" + this.GetEmpId() + "%";
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            if (FileUploadControl.HasFile)
            {
                try
                {
                    ...
                    string empid = this.GetEmpId();
                    bool result = HRData.UpdateTransInfo(comcod, "dbo_hrm.SP_ENTRY_EMPLOYEE", "INSERTUPDATCV", empid, "", "", "", "", "", "", "", "");
                    if (!result)
                    {
