<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EmpEntry01.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_82_App.EmpEntry01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function pageLoaded() {
            ...
            $('#<%=this.gvDegree.ClientID%>').tblScrollable();
        }
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 pading5px">
                                ...
                                <%--<asp:Label ID="lblInformation" runat="server" CssClass="form-control dataLblview" Height="22" Style="line-height: 1.5" Visible="false"></asp:Label>--%>
                            </div>
                            <div class="col-md-3 pading5px">
                            ...
                            <div class="col-md-1 pading5px ">
                                <asp:Button runat="server" ID="btnUpload" Text="Upload" OnClick="btnUpload_Click" Visible="false" />
                            </div>
                        ...
                        <asp:GridView ID="gvDegree" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Institution">
                                    <FooterTemplate>
                                        <asp:LinkButton ID="lUpdateDegree" runat="server" CssClass="btn btn-danger primaryBtn" OnClick="lUpdateDegree_Click">Update</asp:LinkButton>
                                    </FooterTemplate>
