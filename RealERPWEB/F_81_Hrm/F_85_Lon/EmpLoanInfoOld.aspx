<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EmpLoanInfoOld.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_85_Lon.EmpLoanInfo" %>
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-md-2">
                                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="">Paid Amount:</asp:LinkButton>
                                                <asp:TextBox ID="txtPaidAmt" runat="server" CssClass="form-control"></asp:TextBox>
