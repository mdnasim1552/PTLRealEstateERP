<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptYearlyLeaveRecord.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_84_Lea.RptYearlyLeaveRecord" %>
                                    ...
                                    <asp:TemplateField HeaderText="Company Name">
                                        ...
                                        <asp:TemplateField HeaderText="Department Name">
                                         ...
                                         <asp:TemplateField HeaderText="Employee Name">
                                            ...
                                            <FooterTemplate>
                                            <asp:LinkButton ID="lbnLvRecordUpdate" runat="server" OnClick="lbnLvRecordUpdate_Click" CssClass="btn btn-danger primaryBtn"  >Update</asp:LinkButton>
                                        </FooterTemplate>
