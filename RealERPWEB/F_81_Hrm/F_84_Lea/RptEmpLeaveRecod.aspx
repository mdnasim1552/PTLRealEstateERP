                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvLeavRecod" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Opening <br/> Leave">
                                <ItemTemplate>
                                    <asp:label ID="txtgvoplv" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="#000" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "oplv")).ToString("#,##0;(#,##0); ") %>'
                            ...
                            <asp:TemplateField HeaderText="Earned <br/> Leave">
                                <ItemTemplate>
                                    <asp:label ID="txtgvel" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="#000" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "ernleave")).ToString("#,##0;(#,##0); ") %>'
                                        Width="40px"></asp:label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="right" />
                            ...
                            <asp:TemplateField HeaderText="Casual <br/> Leave">
                                <ItemTemplate>
                                    <asp:label ID="txtgvcl" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="#000" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "csleave")).ToString("#,##0;(#,##0); ") %>'
                                        Width="40px"></asp:label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Medical <br/> Leave">
                                <ItemTemplate>
                                    <asp:label ID="txtgvsl" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="Black" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "skleave")).ToString("#,##0;(#,##0); ") %>'
                                        Width="40px"></asp:label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Enjoyee <br/> Eleave">
                                <ItemTemplate>
                                    <asp:label ID="sickleavenj" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="Black" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "ernenjoy")).ToString("#,##0;(#,##0); ") %>'
                                        Width="40px"></asp:label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField HeaderText="Enjoyee <br/> CLeave">
                                <ItemTemplate>
                                    <asp:label ID="txtenjcaslv" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="Black" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "cleavenj")).ToString("#,##0;(#,##0); ") %>'
                                        Width="40px"></asp:label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField HeaderText="Enjoyee <br/> MLeave">
                                <ItemTemplate>
                                    <asp:label ID="sickleavenj" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="Black" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "sckenjoy")).ToString("#,##0;(#,##0); ") %>'
                                        Width="40px"></asp:label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField HeaderText="Bal. <br/> ELeave">
                                <ItemTemplate>
                                    <asp:label ID="sickleavenj" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="Black" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "balernlv")).ToString("#,##0;(#,##0); ") %>'
                                        Width="40px"></asp:label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" />
                              ...
                              <asp:TemplateField HeaderText="Bal. <br/> Cleave">
                                <ItemTemplate>
                                    <asp:label ID="sickleavenj" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="Black" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "balclv")).ToString("#,##0;(#,##0); ") %>'
                                        Width="40px"></asp:label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="Bal. <br/> Mleave">
                                <ItemTemplate>
                                    <asp:label ID="sickleavenj" runat="server" BackColor="Transparent" BorderStyle="None"
                                        ForeColor="Black" Style="font-size: 11px; text-align: center;" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "balsklv")).ToString("#,##0;(#,##0); ") %>'
                                        Width="40px"></asp:label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="right" />
                                <HeaderStyle HorizontalAlign="Center" />
