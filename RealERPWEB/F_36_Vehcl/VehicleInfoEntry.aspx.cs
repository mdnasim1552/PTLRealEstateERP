    ...
    public partial class VehicleInfoEntry : System.Web.UI.Page
    {
        ...
        protected void lnkSave_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < this.gvVehicleEntry.Rows.Count; i++)
            {
                ...
                dr["gcod"] = Gcode;
                dr["gval"] = gval;
                dr["gvalue"] = (((DropDownList)this.gvVehicleEntry.Rows[i].FindControl("ddlval")).Items.Count == 0) ? 
                    (((TextBox)this.gvVehicleEntry.Rows[i].FindControl("txtgvdVal")).Text.Trim().Length==0)?
                    ((TextBox)this.gvVehicleEntry.Rows[i].FindControl("txtgvVal")).Text.Trim(): ((TextBox)this.gvVehicleEntry.Rows[i].FindControl("txtgvdVal")).Text.Trim() : 
                    ((DropDownList)this.gvVehicleEntry.Rows[i].FindControl("ddlval")).SelectedValue.ToString();
                dt1.Rows.Add(dr);
            }
