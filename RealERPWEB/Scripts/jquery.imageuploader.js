    ...
    $.fn.uploader = function (options, testMode) {
        ...
        return this.each(function (index) {
            ...
            var dom = {
                ...
                selectButton: $('<input style="height: 0; width: 0;" id="fileinput' + index + '" type="file" multiple="multiple" class="js-uploader__file-input uploader__file-input">' +
            ...
            function uploadSubmitHandler() {
                ...
                if (state.fileBatch.length !== 0) {
                    ...
                    var refNodata = $("#refNodata").val();
                  
                    
                    data.append('refNodata', refNodata)
                   // data.append('refComcod', refComcod)
                   // alert(data);
                    $.ajax({
                        type: 'POST',
                        url: options.ajaxUrl,
