...
{
    public partial class PostDatedChq : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.Master.Page.Title = "Post Dated Cheque All";
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                DataSet ds1 = accData.GetTransInfo(comcod, "SP_ENTRY_ACCOUNTS_VOUCHER", "REPORTCHEQUEUPDATEALL", voutype, startRow.ToString(), endRow.ToString(), SrchChequeno, BankName, "", "");
                if (ds1 == null)
                {
            ...
            try
            {
                ...
                for (int i = 0; i < dt1.Rows.Count; i++)
                {
                    ...
                    bool resulta = accData.UpdateTransHREMPInfo3(comcod, "SP_ENTRY_ACCOUNTS_VOUCHER", "ACVUPDATE02", acvounum, actcode, rescode, cactcode,
                                                           voudat, "0", Remarks, vtcode, trnamt, spclcode, recndt, rpcode, billno, userid, userdate, Terminal, "", "", "", "", "", "", "", "", "", "");
        ...
        //    ReportDocument rptsale = new RealERPRPT.R_17_Acc.rptPostDatCheque ();
