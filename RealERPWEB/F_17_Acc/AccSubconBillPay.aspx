<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="AccSubconBillPay.aspx.cs" Inherits="RealERPWEB.F_17_Acc.AccSubconBillPay" %>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2 pading5px asitCol2">
                                        ...
                                        <cc1:CalendarExtender ID="txtEntryDate_CalendarExtender" runat="server" BehaviorID="txtEntryDate_CalendarExtender" TargetControlID="txtEntryDate" Format="dd-MMM-yyyy" />
                                    ...
                                    <div class="col-md-3 pading5px  asitCol3">
                                        <div class="col-md-4 pading5px ">
                                            <asp:DropDownList ID="ddlPrivousVou" runat="server" CssClass="form-control inputTxt chzn-select ">
                                            </asp:DropDownList>
                        ...
                        <asp:Panel ID="Panel2" runat="server" Visible="False">
                            <fieldset class="scheduler-border fieldset_B">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3 pading5px asitCol3">
                                            <asp:Label ID="Label11" runat="server" CssClass="lblTxt lblName">SubConductor</asp:Label>
                                        ...
                                        <div class="col-md-4 pading5px">
                                            <asp:DropDownList ID="ddlresuorcecode" runat="server" CssClass="form-control inputTxt chzn-select " TabIndex="17" AutoPostBack="true" OnSelectedIndexChanged="ddlresuorcecode_SelectedIndexChanged">
                                            </asp:DropDownList>
                       ...
                       <fieldset class="scheduler-border fieldset_Nar">
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-md-12 pading5px ">
                                        ...
                                        <asp:TextBox ID="txtPayto" runat="server" CssClass="inputtextbox" Style="width:131px;"></asp:TextBox>
