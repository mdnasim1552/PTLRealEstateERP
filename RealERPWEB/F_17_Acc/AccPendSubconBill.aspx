<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="AccPendSubconBill.aspx.cs" Inherits="RealERPWEB.F_17_Acc.AccPendSubconBill" %>
        ...
        <ContentTemplate>
            ...
            <div class="container moduleItemWrpper">
                <div class="contentPart">
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 pading5px ">
                                        <asp:DropDownList ID="ddlSubCon" runat="server" CssClass="form-control inputTxt">
                                        </asp:DropDownList>
                    ...
                    <asp:GridView ID="dgvConbill" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                        ShowFooter="True"
                        Width="580px">
                        <RowStyle />
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Date" ItemStyle-Font-Size="9px">
                                <ItemTemplate>
                                    <asp:Label ID="lblDate" runat="server" CssClass="GridLebelL" Font-Names="Verdana"
                            ...
                            <asp:TemplateField HeaderText="Billno">
                                <ItemTemplate>
                                    <asp:Label ID="lblBillno" runat="server" CssClass="GridLebelL" ForeColor="Black"
                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "textbillno")) %>'
                                        Width="90px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
