...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="AccSubconBillPayPost.aspx.cs" Inherits="RealERPWEB.F_17_Acc.AccSubconBillPayPost" %>
            ...
            <div class="container moduleItemWrpper">
                <div class="contentPart">
                    <div class="row">
                     ...
                     <%--                      <asp:Label ID="Label1" CssClass="btn-danger btn disabled" runat="server" Visible="false"></asp:Label>

                                        <asp:CheckBox ID="CheckBox1" runat="server" TabIndex="10" Text="Cheque Print" CssClass="btn btn-primary checkBox" />--%>
                                ...
                                <asp:TemplateField HeaderText="Head of Accounts">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblAccdesc1" runat="server"
                                            ...
                                            Width="220px" TabIndex="75"></asp:Label>
