<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="SuplierPayment02.aspx.cs" Inherits="RealERPWEB.F_17_Acc.SuplierPayment02" %>
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-md-7 pading5px">
                                        ...
                                        <asp:TextBox ID="txtSrinfo" runat="server" CssClass="inputtextbox" ></asp:TextBox>
                                           ...
                                           <asp:Label ID="lbltaxamt" runat="server" CssClass="smLbl_to" >Tax</asp:Label>
