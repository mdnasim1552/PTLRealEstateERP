...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EntryLandOwPaymentCode.aspx.cs" Inherits="RealERPWEB.F_17_Acc.EntryLandOwPaymentCode" %>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-md-2 pading5px">
                                        ...
                                        <asp:Label ID="LblBookName1" runat="server" CssClass=" lblTxt lblName" Text="Select Code Book:" Style="text-align:right; width:195px;"></asp:Label>
                                    </div>
                                    

                                    <div class="col-md-4 pading5px">
                                        
                                        <asp:DropDownList ID="ddlSalPayment" runat="server" CssClass="  form-control">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="lblPage" runat="server" CssClass="col-md-2 control-label lblTxt" Text="Page Size"></asp:Label>
                                    <div class="col-md-1 pading5px">
