...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="AccPaymntProp01.aspx.cs" Inherits="RealERPWEB.F_17_Acc.AccPaymntProp01" %>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px">
                                        <asp:Label ID="lblcurVounum" runat="server" CssClass=" smLbl_to">Bill No</asp:Label>
                                        <asp:TextBox ID="txtBillno" runat="server" AutoCompleteType="Disabled" CssClass="smltxtBox"></asp:TextBox>


                                        <asp:Label ID="Label1" runat="server" CssClass="smLbl_to">Bill Amount</asp:Label>
                                        <asp:TextBox ID="txtBillAmount" AutoCompleteType="Disabled" runat="server" CssClass="inputtextbox"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="Label4" runat="server" CssClass="lblTxt lblName" Text="Appx Pay Date"></asp:Label>

                                        <asp:TextBox ID="txtpaymentdate" runat="server" AutoCompleteType="Disabled" CssClass="inputTxt inpPixedWidth"
                                            TabIndex="12" AutoPostBack="True"
                                            OnTextChanged="txtpaymentdate_TextChanged"></asp:TextBox>
                                        <cc1:CalendarExtender ID="txtpaymentdate_CalendarExtender" runat="server"
                                            Enabled="True" Format="dd.MM.yyyy" TargetControlID="txtpaymentdate"
                    ...
                    <asp:GridView ID="gvPayment" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Project Name">
                              <%--  <FooterTemplate>
                                    <asp:LinkButton ID="lbtnTotal" runat="server"  CssClass="btn btn-primary btn-xs" OnClick="lbtnTotal_Click">Total</asp:LinkButton>
                                </FooterTemplate>--%>
                                <ItemTemplate>
