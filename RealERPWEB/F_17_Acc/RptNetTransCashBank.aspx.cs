...
{
    public partial class RptNetTransCashBank : System.Web.UI.Page
    {
        ...
        private void ShowCashBook()
        {
            ...
            string CallType = ((this.rbtnGroup.SelectedItem.Text.Trim() == "Deposit") ? "RPTNETTRANSCASHBANK02" : "RPTNETTRANSCASHBANK");
            ...
            switch (RptGroup1)
            {
                case "Deposit":
                    ...
                    this.gvcashbook.Columns[1].HeaderText = "Received Date";
                    this.gvcashbook.Columns[4].HeaderText = "MR No";
                    this.gvcashbook.Columns[9].HeaderText = "Received From";
                    this.gvcashbook.Columns[10].HeaderText = "Received From(Clients)";
                ...
                case "Withdraw":
                    ...
                    this.gvcashbook.Columns[1].HeaderText = "Issue Date";
                    this.gvcashbook.Columns[4].HeaderText = "Issue #";
                    this.gvcashbook.Columns[9].HeaderText = "Party/Suppliers/Receivers Name";
                    this.gvcashbook.Columns[10].HeaderText = "Pay To";
                    // this.gvcashbook.Columns[10].HeaderText = "Deposit";
                    break;
            }
        ...
        private void PrintCashBook02()
        {
            ...
            ReportDocument rptcb1 = new RealERPRPT.R_17_Acc.RptAccNetTransCashBanK02();
            ...
            IsueDate.Text = (this.rbtnGroup.SelectedIndex == 0) ? "Received Date" : "Issue Date";
