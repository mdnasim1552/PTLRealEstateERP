...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseOrderRecived.aspx.cs" Inherits="RealERPWEB.F_17_Acc.PurchaseOrderRecived" %>
            ...
            <div class="container moduleItemWrpper">
                <div class="contentPart">
                    ...
                    <div class="table-responsive table">
                                <asp:GridView ID="grvMWiseSupBill" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Order No">
                                           ...
                                           <asp:TemplateField HeaderText="Order No(Manual)">
                                            <ItemTemplate>
                                                <asp:Label ID="lblordernoMan" runat="server"
                                        ...
                                        <asp:TemplateField HeaderText="Advanced</br>Amount">
                                         ...
                                         <asp:TemplateField HeaderText="Partial </br>Payment">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtppayment" runat="server" Style="text-align: right" 
                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "ppayment")).ToString("#,##0.00;(#,##0.00); ") %>'
                                                    Width="70px"></asp:TextBox>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:Label ID="lblFPpayent" runat="server" Font-Bold="True" Font-Size="12px"
                                                    Style="text-align: right" Width="70px"></asp:Label>
                                            </FooterTemplate>
                                              <FooterStyle Font-Bold="True" HorizontalAlign="Right" />
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                         ...
                                         <asp:TemplateField HeaderText="Tax</br>Amount">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txttax" runat="server" Style="text-align: right" 
