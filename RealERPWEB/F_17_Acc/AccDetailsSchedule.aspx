...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="AccDetailsSchedule.aspx.cs" Inherits="RealERPWEB.F_17_Acc.AccDetailsSchedule" %>
                ...
                <div class="contentPart">
                    <div class="row">
                        <fieldset class="scheduler-border fieldset_A">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 pading5px ">
                                    <asp:DropDownList ID="ddlAccHeads" runat="server" CssClass="chzn-select form-control inputTxt" AutoPostBack="True" OnSelectedIndexChanged="ddlAccHeads_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 pading5px ">
                                    <asp:DropDownList ID="ddlResHead" runat="server" CssClass="chzn-select  form-control inputTxt">
                                    </asp:DropDownList>
                    ...
                    <div class="row">
                        <asp:GridView ID="dgv2" runat="server" AutoGenerateColumns="False"
                            ShowFooter="True" Width="911px" CssClass="table-striped table-hover table-bordered grvContentarea">
                            <Columns>
