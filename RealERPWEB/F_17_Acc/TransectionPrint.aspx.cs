    ...
    public partial class TransectionPrint : System.Web.UI.Page
    {
        ...
        private void SetView()
        {
            ...
            switch (Type)
            {
                ...
                case "AccCheque":
                    ...
                    this.txtfromdatec.Text = (comcod == "3336" || comcod == "3337") ? System.DateTime.Today.ToString("dd-MMM-yyyy") : System.DateTime.Today.ToString("dd-MMM-yyyy");
                ...
                case "AccPostDatChq":
                    this.rbtCprintList.SelectedIndex = 0;
                    //this.CompanyCheckPrint();
                    this.txtfromdatec1.Text = (comcod == "3336" || comcod == "3337") ? System.DateTime.Today.ToString("dd-MMM-yyyy") : System.DateTime.Today.AddDays(-30).ToString("dd-MMM-yyyy");
            ...
            switch (Type)
            {
                ...
                case "AccCheque":
                    ...
                    try
                    {
                        ...
                        vounum = this.ddlChkVouNo.SelectedValue.ToString();
                        string curvoudat = Convert.ToDateTime(((DataTable)ViewState["tblvoucherno"]).Select("vounum='" + vounum + "'")[0]["chequedat"]).ToString("dd-MMM-yyyy");



                        paytype = this.ChboxPayee.Checked ? "0" : "1";
                        string cquepbl = "0";
                        type = "Type=AccCheque&vounum=" + vounum + "&paytype=" + paytype + "&pbl=" + cquepbl; ;
        ...
        private void PrintPaySlip()
        {
            try
            {
                ...
                {
                    Rpt1 = RealERPRDLC.RptSetupClass1.GetLocalReport("R_17_Acc.RptPaySlipSupplierLeisure", list, null, null);
                }
        ...
        private void GetVouNum()
        {
            ...
            ViewState["tblvoucherno"] = ds4.Tables[0];
        ...
        private void RptPostDatChqSU()
        {
            try
            {
                ...
                string[] amtdivide = amtWrd1[1].Split(' ');
                string value = this.chkpayee.Checked ? "A/C Payee" : "";
        ...
        private void PostVouPrint()
        {
            try
            {
                ...
                //{
                //    rptinfo = new RealERPRPT.R_17_Acc.rptBankVoucherCredence();
