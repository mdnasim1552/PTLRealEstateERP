...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="AccTrialBalanceAll.aspx.cs" Inherits="RealERPWEB.F_17_Acc.AccTrialBalanceAll" %>
                                ...
                                <div class="form-group">
                                    <div class="tbMenuWrp nav nav-tabs">
                                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="Mains"><div class='circle-tile'><div class='circle-tile-content common_color'><div class='circle-tile-description text-faded'>Trial Balance</div></div></div></asp:ListItem>
                                            <asp:ListItem Value="TBConsolidated"><div class='circle-tile'><div class='circle-tile-content common_color'><div class='circle-tile-description text-faded'>Trial Balance (Consolidated)</div></div></div></asp:ListItem>
                                            <asp:ListItem Value="Trial02"><div class='circle-tile'><div class='circle-tile-content common_color'><div class='circle-tile-description text-faded'>Trial Balance (Category Wise)</div></div></div></asp:ListItem>
                                            <asp:ListItem Value="HOTB"><div class='circle-tile'><div class='circle-tile-content common_color'><div class='circle-tile-description text-faded'>HO Trial Balance</div></div></div></asp:ListItem>

                                            <asp:ListItem Value="PrjTrailBal"><div class='circle-tile '><div class='circle-tile-content common_color'><div class='circle-tile-description text-faded'>Project Trial Balance</div></div></div></asp:ListItem>                                           
                                             <asp:ListItem Value="TrailBal2"><div class='circle-tile '><div class='circle-tile-content common_color'><div class='circle-tile-description text-faded'>Trial Balance 2</div></div></div></asp:ListItem>
                                            <asp:ListItem Value="LandPrj"><div class='circle-tile '><div class='circle-tile-content common_color'><div class='circle-tile-description text-faded'>Trial Balance(WIP)</div></div></div></asp:ListItem>
                                            <asp:ListItem Value="PrjTrailBal3"  style="display:none;"><div class='circle-tile  pull-right'><div class='circle-tile-content common_color'><div class='circle-tile-description text-faded'>Project Trial Balance -3</div></div></div></asp:ListItem>
