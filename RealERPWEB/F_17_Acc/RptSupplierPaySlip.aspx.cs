...
{
    public partial class RptSupplierPaySlip : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //((Label)this.Master.FindControl("lblTitle")).Text = "Supplier Payment Slip";
                //this.Master.Page.Title = "Supplier Payment Slip";
        ...
        private void ShowCheque()
        {
            ...
            DataSet ds1 = MktData.GetTransInfo(comcod, "SP_REPORT_ACCOUNTS_VOUCHER", "RPTSUPPLIERPAYSLIP", fromdate, todate, Chequeno, "", "", "", "", "", "");
            if (ds1 == null)
                return;

            Session["cashbank"] = ds1.Tables[0];

            this.gvcashbook.DataSource = ds1.Tables[0];
        ...
        protected void gvcashbook_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlink1.NavigateUrl = "~/F_17_Acc/SupplierPaySlipPrint.aspx?Type=SupPay&Vouno=" + vounum + "&frmdat=" + frmdate + "&todat=" + todate;// +"&recvno=" + recvno + "&imesimeno=" + imesimeno;
