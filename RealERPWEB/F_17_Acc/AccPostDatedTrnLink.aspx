...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="AccPostDatedTrnLink.aspx.cs" Inherits="RealERPWEB.F_17_Acc.AccPostDatedTrnLink" %>
        ...
        <ContentTemplate>
            ...
            <div class="container moduleItemWrpper">
                <div class="contentPart">
                    ...
                    <asp:GridView ID="gv1" runat="server" CssClass=" table-striped table-hover table-bordered grvContentarea"
                            ...
                            <asp:TemplateField HeaderText="Voucher #">
                                ...
                                <FooterTemplate>
                                    <asp:Label ID="lgvFTotal" runat="server" Font-Bold="True" Font-Size="12px"
                                        ForeColor="White" Style="text-align: right">Grand Total:</asp:Label>
                                </FooterTemplate>
