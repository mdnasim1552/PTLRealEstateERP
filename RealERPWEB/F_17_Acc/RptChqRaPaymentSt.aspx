...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptChqRaPaymentSt.aspx.cs" Inherits="RealERPWEB.F_17_Acc.RptChqRaPaymentSt" %>
                ...
                <div class="contentPart">
                                ...
                                <asp:Panel ID="pnlmain" runat="server">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 ">
                                            ...
                                            <asp:Label ID="lblAppPaydate" runat="server" CssClass="lblTxt lblName" Width="130px">Appx. Payment Date</asp:Label>
                                            <asp:DropDownList ID="ddlapppaydate" runat="server" AutoPostBack="True"
                                                OnSelectedIndexChanged="ddlapppaydate_SelectedIndexChanged" CssClass="ddlPage"
                                                TabIndex="2">
                                                <asp:ListItem Value="=">Equal</asp:ListItem>

                                                <asp:ListItem Value="between">Between</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:TextBox ID="txtapppaydate" runat="server" CssClass="inputtextbox" OnTextChanged="txtapppaydate_TextChanged"></asp:TextBox>

                                            <asp:Label ID="lblapppdateto" runat="server" CssClass=" smLbl_to" Visible="false">To</asp:Label>

                                            <asp:TextBox ID="txtapppaydateto" runat="server" AutoPostBack="True" CssClass="inputtextbox"
                                                OnTextChanged="txtapppaydateto_TextChanged" TabIndex="4"
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="col-md-3 pading5px asitCol4">
                                        <asp:RadioButtonList ID="rbtnChqType" RepeatDirection="Horizontal" CssClass="rbtnList1"   runat="server" >
                                            <asp:ListItem >Without Chq. Ready</asp:ListItem> 
                                            <asp:ListItem >Bill will Cheque Ready</asp:ListItem>                                                                        
                                            <asp:ListItem Selected="True" >All</asp:ListItem>

                                        </asp:RadioButtonList>
                                    </div>

                                          <%--  <asp:CheckBox ID="chkwchqready" runat="server" BorderWidth="1px" BackColor="#ffffff" CssClass="checkBox" TabIndex="27" Text="Without Chq. Ready"
                                                Width="180px" />--%>
                    ...
                    <div class="table table-responsive">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Cheque Ready Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvgvchqrdate" runat="server" BorderColor="#99CCFF"
                                            BorderStyle="Solid" BorderWidth="0px" Font-Size="11px"
                                            Style="text-align: Left; background-color: Transparent"
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "chqrdate")) %>'
                                            Width="70px"></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                    <HeaderStyle Font-Bold="True" Font-Size="12px" />
                                ...
                                <asp:TemplateField HeaderText="Cheque Pay to Party">
                                    <ItemTemplate>
                                        <asp:Label ID="lgvchqptparty" runat="server" BorderColor="#99CCFF"
                                            BorderStyle="Solid" BorderWidth="0px" Font-Size="11px"
                                            Style="text-align: Left; background-color: Transparent"
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "chqptpdate")) %>'
                                            Width="70px"></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Right" />
                                    <HeaderStyle Font-Bold="True" Font-Size="12px" />
