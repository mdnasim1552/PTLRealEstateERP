...
namespace RealERPWEB.F_17_Acc
{
    ...
    public partial class AccTrialBalance : System.Web.UI.Page
    {
        ...
        private void ViewSection()
        {
            ...
            switch (Type)
            {
                ...
                case "Mains":
                    ...
                    if (comcod == "1103")
                    {
                        ...
                        this.txtDatefrom.Text = Convert.ToDateTime("01-Jan-" + cdate.Substring(7)).ToString("dd-MMM-yyyy");
                    }
            ...
            {
                string eventtype = ((Label)this.Master.FindControl("lblTitle")).ToString();
                string eventdesc = "Show Report: " + ((Label)this.Master.FindControl("lblTitle")).Text;
                string eventdesc2 = "";
                bool IsVoucherSaved = CALogRecord.AddLogRecord(comcod, ((Hashtable)Session["tblLogin"]), eventtype, eventdesc, eventdesc2);
            }
        }
            ...
            switch (Type)
            {
                case "Mains":
                    ...
                    if (Convert.ToBoolean(events) == true)
                    {
                        ...
                        string eventdesc = "Show Report: " + eventtype;
        ...
        protected void lnkPrint_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    string eventtype = ((Label)this.Master.FindControl("lblTitle")).ToString();
            //    string eventdesc = "Print Report: " + eventtype;
            //    string eventdesc2 = "";
            //    bool IsVoucherSaved = CALogRecord.AddLogRecord(comcod, ((Hashtable)Session["tblLogin"]), eventtype, eventdesc, eventdesc2);
        ...
        private void PrintMainTrialBal()
        {
            ...
            if (Convert.ToBoolean(events) == true)
            {
                string eventtype = ((Label)this.Master.FindControl("lblTitle")).Text;
                string eventdesc = "Print Report: " + eventtype;
                 string eventdesc2 = "Trail Balance Data print From: " + Convert.ToDateTime(this.txtDatefrom.Text.Trim()).ToString("dd-MMM-yyyy") + " To: " + Convert.ToDateTime(this.txtDateto.Text.Trim()).ToString("dd-MMM-yyyy"); ;
                bool IsVoucherSaved = CALogRecord.AddLogRecord(comcod, ((Hashtable)Session["tblLogin"]), eventtype, eventdesc, eventdesc2);
        ...
        protected void gvtrialbalance01_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if ((code.Substring(0, 2) != "16" && code.Substring(0, 2) != "18" && code.Substring(0, 2) != "26" && code.Substring(0, 2) != "25") && (ASTUtility.Right(rescode, 4) == "0000"))
            {
            ...
            else if (code.Substring(0, 2) == "16")
            {

                string sircode = rescode.Substring(0, 2);                
        ...
        private void ExportGridToExcel()
        {
            ...
            Response.Charset = "";
            string FileName = "TrialBal" + DateTime.Now + ".xlsx";
            StringWriter strwritter = new StringWriter();
            HtmlTextWriter htmltextwrtter = new HtmlTextWriter(strwritter);
            //Response.Cache.SetCacheability(HttpCacheability.NoCache);
            Response.ContentType = "application/vnd.ms-excel";
            Response.AddHeader("Content-Disposition", "attachment;filename=" + FileName);
            dgv1.GridLines = GridLines.Both;
            dgv1.HeaderStyle.Font.Bold = true;
            dgv1.RenderControl(htmltextwrtter);
