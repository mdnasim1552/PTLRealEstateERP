    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <asp:Panel ID="pnlvouCount" runat="server" Visible="false"></asp:Panel>
              <table class="table table-striped table-condensed" style="width:80%" >
                  ...
                  <tr>
                      <th> PDC Voucher:</th>
                      <th>  <asp:Label ID="lbltoPdcVoucher" runat="server" CssClass="lblTxt lblName"></asp:Label></th>
                      <th>Cash Voucher:</th>
                      <th> <asp:Label ID="lbltoCashVoucher" runat="server" CssClass="lblTxt lblName" ></asp:Label></th>
                      <th>Bank Voucher:</th>
                      <th> <asp:Label ID="lbltoBankVoucher" runat="server" CssClass="lblTxt lblName" ></asp:Label></th>
                      <th>Contra Voucher:</th>
                        <th> <asp:Label ID="lbltoContraVoucher" runat="server" CssClass="lblTxt lblName" ></asp:Label></th>

                      <th>Journal Voucher:</th>
                      <th><asp:Label ID="lbltoJournalVoucher" runat="server" ></asp:Label></th>                                          
                                                                
                      <th>Total Voucher :</th> 
                      <th> <asp:Label ID="lbltotalvoucher" runat="server" ></asp:Label></th>                                          
