<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptSubConPaySlip.aspx.cs" Inherits="RealERPWEB.F_17_Acc.RptSubConPaySlip" %>
...
<%--                                   <div class="col-md-3 pading5px asitCol3">
                        ...
                        <asp:GridView ID="gvSubCon" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                            OnRowDataBound="gvSubCon_RowDataBound" CssClass="table table-striped table-hover table-bordered grvContentarea" Width="571px" >
                            <RowStyle />
                            <Columns>
