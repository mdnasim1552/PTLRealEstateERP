<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="AccMatConversion.aspx.cs" Inherits="RealERPWEB.F_17_Acc.AccMatConversion" %>
        ...
        <ContentTemplate>
            ...
            <div class="container moduleItemWrpper">
                <div class="contentPart">
                    <div class="row">
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            ...
                            <div class="form-horizontal">
                                 ...
                                 <div class="form-group">
                                        <div class="col-md-3 pading5px asitCol3">
                                            <asp:Label ID="lblconversionList" runat="server" CssClass="lblTxt lblName" Text="Conversion List"></asp:Label>
                                            <asp:TextBox ID="txtSrcConvrNo" runat="server" CssClass="inputtextbox"></asp:TextBox>
                                            <div class="colMdbtn">
                                                <asp:LinkButton ID="imgbtnConvrNo" runat="server" CssClass="btn btn-primary srearchBtn" OnClick="imgbtnConvrNo_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
                                        ...
                                        <div class="col-md-4 pading5px ">
                                            <asp:DropDownList ID="ddlConversionList" runat="server" CssClass="form-control inputTxt">
                                            </asp:DropDownList>
                                        ...
                                        <div class="col-md-3 pading5px asitCol3">
                                            ...
                                            <div class="colMdbtn pading5px">
                                                <asp:LinkButton ID="lbtnSelectConversion" runat="server" CssClass="btn btn-primary primaryBtn" OnClick="lbtnSelectConversion_Click">Select</asp:LinkButton>
                    ...
                    <div class="row">
                     <asp:GridView ID="grvAccMatConversion" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                              ...
                              <%--  <asp:TemplateField HeaderText="A/C Description" ItemStyle-Font-Size="9px">
                                ...
                                <asp:TemplateField HeaderText="Dr.Amount" ItemStyle-Font-Size="11px">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtgvDrAmt" runat="server"  BackColor="Transparent"  ReadOnly="true"  BorderStyle="None" Font-Size="11px" Style="text-align: right"
                                ...
                                <asp:TemplateField HeaderText="Cr.Amount" ItemStyle-Font-Size="11px">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtgvCrAmt" runat="server" BackColor="Transparent"  ReadOnly="true"  BorderStyle="None" Font-Size="11px" Style="text-align: right"
