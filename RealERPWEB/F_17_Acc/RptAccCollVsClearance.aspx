<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="RptAccCollVsClearance.aspx.cs" Inherits="RealERPWEB.F_17_Acc.RptAccCollVsClearance" %>
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                <asp:Label ID="Label2" runat="server">Sales Team</asp:Label>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText=" Description">
                                                <HeaderTemplate>
                                                    ...
                                                    <asp:HyperLink ID="hlbtntbCdataExcel" runat="server" CssClass="btn  btn-success btn-xs" ToolTip="Export Excel"><i class="fas fa-file-excel" aria-hidden="true"></i>
                                                    </asp:HyperLink>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                    ...
                                    <div class="panel with-nav-tabs panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade" id="tab1primary1">
