...
{
    public partial class EntryLandOwPaymentCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //this.Master.Page.Title = "Payment Schedule Code";
            }
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "LWPAYMENTCODE",
                                "", "", "", "", "", "", "", "", "");
