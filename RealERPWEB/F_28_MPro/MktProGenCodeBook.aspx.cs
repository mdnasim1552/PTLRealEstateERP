...
{
    public partial class MktProGenCodeBook : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //((Label)this.Master.FindControl("lblTitle")).Text = "General Code(M. Procurement)";
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "MKTPROGENCODE", qtype,
                                    "", "", "", "", "", "", "", "");
        ...
        protected void grvacc_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            string Type = ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "63" & gcode2 != "000") ? "62%" : "";
            ...
            if (gcode != "00000")
            {
                ...
                DataSet ds1 = da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "GETAREALIST", Type, "", "", "", "", "", "", "", "");
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
           ...
           // string codedsc = "";
            ...
            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK", "INSERTUPMKTGENINF", tgcod,
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "MKTCODEINFO", tempddl1,
                            tempddl2, catgrory, "", "", "", "", "", "");
