    ...
    <asp:Label ID="lblSssion" runat="server" Visible="false">
        <div class="col-sm-6 col-md-6 col-md-offset-3">
            <div class="alert-message alert-message-success">
                <h4>For Your Attention!!</h4>
                <p>
                    Your Login Session May be Timeout. Please
                    <asp:HyperLink ID="LognHypl" runat="server" NavigateUrl="~/LogIn.aspx">Login</asp:HyperLink>
                    Again <strong>
                        <br />
                        For Contact Administration
                        <br />
                    </strong><a href="https://pintechltd.com/">Pinovation Tech Ltd </a>

                    <br />
                    Center Point (8th floor), Unit-F,   
                    <br />
                    14/A, Tejkunipara, Tejgaon, FarmGate,    
                    <br />
                    Dhaka - 1215. Bangladesh    
                    <br />
                    P: 09611677682, 09611677683,   
                    <br />
                    Shovon +880-1796-999992   
                    <br />

                    Mostak +880-1717-545613   
                    <br />
