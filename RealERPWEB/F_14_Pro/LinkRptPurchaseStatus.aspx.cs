...
{
    public partial class LinkRptPurchaseStatus : System.Web.UI.Page
    {
        ...
        private void GetBillNo()
        {
            ...
            string comcod = this.GetComeCode();
            string billno = "";
            string type = this.Request.QueryString["genno"];
            if (type.Length > 0)
            {
            ...
            {
                billno = this.txtBillSearch.Text.Trim();
            }
        ...
        private void RptPurchaseTrack()
        {
            ...
            rpt.SetParameters(new ReportParameter("mrfNo", "MRF No: " + (((DataTable)Session["tblreq"]).Select("reqno='" + reqno + "'"))[0]["mrfno"].ToString()));
        ...
        private void ShowPurchaseBill()
        {
            ...
            Session["tblpurchase"] = dv.ToTable();
            this.LoadGrid();
