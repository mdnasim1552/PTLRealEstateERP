<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptSuppierBgd.aspx.cs" Inherits="RealERPWEB.F_14_Pro.RptSuppierBgd" %>
                                        ...
                                        <asp:TemplateField HeaderText="Supplier Name">
                                               ...
                                               <HeaderTemplate>
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblheader" runat="server" Text="Supplier Name"></asp:Label>
                                                            </td>
                                                            <td>
                                       ...
                                       <%-- <asp:TemplateField HeaderText="Order No">
                                        ...
                                        <asp:TemplateField HeaderText="Project Balance">
                                           ...
                                           <asp:TemplateField HeaderText="Net Balance">
                                            ...
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFNetBal" runat="server" Font-Bold="True"
                                                    Font-Size="12px" ForeColor="Black" Style="text-align: right"></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle Font-Bold="True" HorizontalAlign="Right" />
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
