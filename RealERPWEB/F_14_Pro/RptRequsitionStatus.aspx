<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptRequsitionStatus.aspx.cs" Inherits="RealERPWEB.F_14_Pro.RptRequsitionStatus" %>
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <asp:CheckBox ID="ChkBalance" runat="server" CssClass="chkBoxControl margin5px" Text="Without Zero Balance" />
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="lblReq" runat="server" CssClass="lblTxt lblName">Req</asp:Label>
                                        <asp:TextBox ID="txtSrcRequisition" runat="server" CssClass=" inputTxt inputName inpPixedWidth"></asp:TextBox>

                                        <asp:LinkButton ID="imgbtnFindRequiSition" runat="server" CssClass="btn btn-primary srearchBtn" OnClick="imgbtnFindRequiSition_Click"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
