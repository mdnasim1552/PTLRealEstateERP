<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptPurchasetracking.aspx.cs" Inherits="RealERPWEB.F_14_Pro.RptPurchasetracking" %>
                    ...
                    <div class="row">
                        ...
                        <asp:MultiView ID="MultiView1" runat="server">
                            ...
                            <asp:View ID="Purchasetrk" runat="server">
                                ...
                                <asp:Label ID="lblproject" runat="server" Style="text-align: center !important" Font-Bold="true" Font-Size="12px" ForeColor="blue">
                                </asp:Label>
