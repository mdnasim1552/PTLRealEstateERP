<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkRptPurchaseStatus.aspx.cs" Inherits="RealERPWEB.F_14_Pro.LinkRptPurchaseStatus" %>
                                ...
                                <asp:GridView ID="gvPurBilltk" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Supplier Name">
                                            ...
                                            <FooterTemplate>
                                                            <asp:LinkButton ID="lbtnDelete" Visible="false" runat="server"  CssClass="btn btn-primary primaryBtn" onclick="lbtnDelete_Click">Delete</asp:LinkButton>
                                                        </FooterTemplate>
