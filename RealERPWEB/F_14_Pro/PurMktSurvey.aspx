<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="PurMktSurvey.aspx.cs" Inherits="RealERPWEB.F_14_Pro.PurMktSurvey" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="lblInformation" runat="server" CssClass="lblTxt lblName" Text="Information for"></asp:Label>
                                        <asp:TextBox ID="txtInfo" runat="server" CssClass="inputTxt inpPixedWidth" TabIndex="4"></asp:TextBox>
                                    ...
                                    <div class="col-md-3 pull-right">
                                        <div class="msgHandSt">
                                            <asp:Label ID="lblmsg1" runat="server" CssClass="btn btn-danger  disabled" Visible="false"></asp:Label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 pading5px asitCol3">
                                                ...
                                                <asp:TextBox ID="txtCurMSRDate" runat="server" CssClass="inputTxt inputDateBox" ToolTip="(dd.mm.yyyy)"></asp:TextBox>
                                            ...
                                            <div class="col-md-5 pading5px asitCol5 pull-right">
                                                <asp:LinkButton ID="ImgbtnFindPreMR" runat="server" CssClass="lblTxt lblName" OnClick="ImgbtnFindPreMR_Click"
                                                    TabIndex="3">Pre. MSR. List</asp:LinkButton>

                                                <asp:DropDownList ID="ddlPrevMSRList" runat="server" Width="180px" CssClass="inputTxt inpPixedWidth" TabIndex="6">
                                                </asp:DropDownList>
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 pading5px asitCol4">
                                                        <asp:DropDownList ID="ddlMSRRes" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlMSRRes_SelectedIndexChanged" CssClass="chzn-select form-control inputTxt" TabIndex="6">
                                                        </asp:DropDownList>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-1 col-md-1 col-lg-1">
                                                        <a class="btn btn-primary primaryBtn" href='<%=this.ResolveUrl("~/F_14_Pro/PurMktSurvey.aspx?Type=SurveyLink")%>' target="_blank" style="margin: 10px 0 0 5px; line-height: 18px;">Survey Link</a>
                                    ...
                                    <asp:GridView ID="gvMSRInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Supplier Name">
                                                ...
                                                <FooterTemplate>
                                                    <asp:LinkButton ID="lbtnMSRTotal" runat="server" CssClass="btn  btn-primary  primarygrdBtn" OnClick="lbtnMSRTotal_Click">Total</asp:LinkButton>
                                                ...
                                                <div class="col-md-6 pading5px">
                                                    <div class="input-group">
                                                        <span class="input-group-addon glypingraddon">
                                                            <asp:Label ID="lblReqNarr" runat="server" CssClass="lblTxt lblName" Text="Vendor Justification:"></asp:Label>
                                                        </span>
                                ...
                                <fieldset class="scheduler-border fieldset_A">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 pading5px asitCol3">
                                                <asp:DropDownList ID="ddlSupl2" runat="server" CssClass="chzn-select form-control inputTxt" TabIndex="6" style="width:336px;">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-1 pading5px">
                                                <asp:LinkButton ID="lbtnSelectSupl2" runat="server" CssClass="btn btn-primary okBtn" OnClick="lbtnSelectSupl2_Click" TabIndex="2" Style="margin-left:140px;">Ok</asp:LinkButton>
                                    ...
                                    <fieldset class="scheduler-border fieldset_A">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4 pading5px  asitCol4">
                                                    <asp:DropDownList ID="ddlResList2" runat="server" CssClass="chzn-select form-control inputTxt" TabIndex="6" AutoPostBack="True" OnSelectedIndexChanged="ddlResList2_SelectedIndexChanged" >
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-md-3 pading5px">
                                                    <asp:LinkButton ID="lbtnSelectRes2" runat="server" CssClass="btn btn-primary   primarygrdBtn" OnClick="lbtnSelectRes2_Click" TabIndex="2">Select</asp:LinkButton>
                                                    <asp:LinkButton ID="lbtnSelectResAll" runat="server" CssClass="btn btn-primary   primarygrdBtn" OnClick="lbtnSelectResAll_Click" TabIndex="2">Select all(Spec)</asp:LinkButton>
                                                     <asp:LinkButton ID="lbtnSelectReaSpesAll" runat="server" CssClass="btn btn-primary   primarygrdBtn" OnClick="lbtnSelectReaSpesAll_Click" TabIndex="2">Select all(Mat)</asp:LinkButton>
