<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptWorkOrderHistorySup.aspx.cs" Inherits="RealERPWEB.F_14_Pro.RptWorkOrderHistorySup" %>
                    ...
                    <div class="row">
                        <fieldset class="scheduler-border fieldset_A">
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <asp:LinkButton ID="lnkbtnOk" runat="server" OnClick="lnkbtnOk_Click" Style="margin-left: -64px" CssClass="btn btn-primary okBtn">Ok</asp:LinkButton>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="form-group">
