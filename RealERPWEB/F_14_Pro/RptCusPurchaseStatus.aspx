<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptCusPurchaseStatus.aspx.cs" Inherits="RealERPWEB.F_14_Pro.RptCusPurchaseStatus" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 pading5px asitCol6" id="main" runat="server">
                                        ...
                                        <asp:DropDownList ID="ddlProjectName" OnSelectedIndexChanged="ddlProjectName_OnSelectedIndexChanged" AutoPostBack="True" runat="server" style="width:350px" CssClass="chzn-select  ddlPage">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                        <div class="col-md-4 pading5px">
                                            <asp:Label ID="Label8" runat="server" CssClass="lblTxt lblName" Text="Information Field"></asp:Label>
                                            <asp:ListBox ID="ddlInformation" runat="server" CssClass=" form-control" Width="280px"  SelectionMode="Multiple"></asp:ListBox>
