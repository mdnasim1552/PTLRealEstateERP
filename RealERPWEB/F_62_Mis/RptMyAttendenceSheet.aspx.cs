...
namespace RealERPWEB.F_62_Mis
{
    public partial class RptMyAttendenceSheet : System.Web.UI.Page
    {
        ...
        private void getMyAttData()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "SP_REPORT_EMP_DASEBOARD", "EMPATTNIDWISE", frmdate, todate, empid, "", "", "", "", "", "");
        ...
        private void PrintEmpAttnIdWise()
        {
            ...
            DataSet ds4 = HRData.GetTransInfo(comcod, "SP_REPORT_EMP_DASEBOARD", "EMPATTNIDWISE", frmdate, todate, empid, "", "", "", "", "", "");
            ...
            ReportDocument rptTest = new RealERPRPT.R_62_Mis.rptDailyAttnEmp();
