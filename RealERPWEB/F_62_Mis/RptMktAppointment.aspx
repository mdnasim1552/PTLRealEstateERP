<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptMktAppointment.aspx.cs" Inherits="RealERPWEB.F_62_Mis.RptMktAppointment" %>
    ...
    <script type="text/javascript">
        ...
        function pageLoaded() {
           <%-- var gv = $('#<%=this.dgvAccRec.ClientID %>');
            ...
            var dgvAccRec02 = $('#<%=this.gvalloffper.ClientID %>');
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 pading5px ">
                                        ...
                                        <asp:Label ID="lbltodate" runat="server" Text="To" TabIndex="1" CssClass=" lblTxt lblName"></asp:Label>
                                     ...
                                     <asp:CheckBox ID="chkChangeAppoint" runat="server" CssClass="smLbl_to " Text="Change Appointment Date" OnCheckedChanged="chkChangeAppoint_CheckedChanged" Visible="False" />
                                     <asp:CheckBox ID="chkAppoint" runat="server" CssClass="smLbl_to " Text=" Appointment Print" Visible="False" />

                                         <asp:RadioButtonList ID="rbtnlist" runat="server" Visible="false" RepeatDirection="Horizontal"  
                                CssClass=" ">
                                ...
                                <div class="form-group">
                                    <div class="col-md-3 pading5px asitCol3">
                                        ...
                                        <asp:TextBox ID="txtSrcteam" runat="server" TabIndex="3" CssClass=" inputtextbox"></asp:TextBox>
                                        <div class="colMdbtn">
                                    ...
                                    <div class="col-md-6 pading5px">
                                        <asp:DropDownList ID="ddlSalesTeam" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSalesTeam_SelectedIndexChanged" CssClass="form-control inputTxt chzn-select"
                                            TabIndex="5">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group">
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="lblproject" runat="server" CssClass="lblTxt lblName" Text="Project" Visible="false"></asp:Label>


                                        <asp:TextBox ID="txtsrchproject" runat="server" TabIndex="3" CssClass=" inputtextbox" Visible="false"></asp:TextBox>
                                        <div class="colMdbtn">
                                            <asp:LinkButton ID="lbtnproject" runat="server" OnClick="lbtnproject_Click" TabIndex="4" CssClass="btn btn-primary srearchBtn" Visible="false"><span class="glyphicon glyphicon-search asitGlyp" ></span></asp:LinkButton>
                                        </div>
                                    </div>


                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:DropDownList ID="ddlProject" runat="server" AutoPostBack="True" CssClass="form-control inputTxt"
                            ...
                            <asp:View ID="todaysApp" runat="server">
                                <div class="table-responsive">
                                    <asp:GridView ID="gvtodayapp" runat="server" AllowPaging="True" OnPageIndexChanging="gvtodayapp_PageIndexChanging"
                                        ...
                                        CssClass="table-striped table-hover table-bordered grvContentarea" OnRowDataBound="gvtodayapp_RowDataBound"
                                         OnRowCancelingEdit="gvtodayapp_RowCancelingEdit" OnRowEditing="gvtodayapp_RowEditing" OnRowUpdating="gvtodayapp_RowUpdating">
                    ...
                    <asp:View ID="ViewProsClient" runat="server">
                        <div class="table-responsive">
                            <asp:GridView ID="gvProsClient" runat="server" AllowPaging="True" OnPageIndexChanging="gvProsClient_PageIndexChanging"
                                AutoGenerateColumns="False" PageSize="15" ShowFooter="true"
                                CssClass="table table-striped table-hover table-bordered grvContentarea" Width="950px">
                                <PagerSettings NextPageText="Next" PreviousPageText="Previous" Position="Top"
                                    Mode="NumericFirstLast" />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Client Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lgvClientName" runat="server" Font-Bold="True" Style="text-align: left"
                                                Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "name")) %>' Width="150px"
