<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptProWiseClOffered.aspx.cs" Inherits="RealERPWEB.F_62_Mis.RptProWiseClOffered" %>
                ...
                <div class="contentPart">
                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 pading5px ">
                                            ...
                                            <asp:DropDownList ID="ddlSrchCash" runat="server" AutoPostBack="True"
                                                CssClass="ddlPage "
                                                OnSelectedIndexChanged="ddlSrchCash_SelectedIndexChanged" Style="width: 125px;">
                        ...
                        <asp:GridView ID="gvClientOff" runat="server" AllowPaging="True" OnRowDataBound="gvClientOff_RowDataBound"
                                ...
                                CssClass=" table-striped table-hover table-bordered grvContentarea" OnPageIndexChanging="gvClientOff_PageIndexChanging">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Unit Name">
                                        <FooterTemplate>
                                            <asp:Label ID="lgvFunitname" runat="server" Font-Bold="True" Font-Size="11px">Total</asp:Label>
                                        </FooterTemplate>
                                        <ItemTemplate>
