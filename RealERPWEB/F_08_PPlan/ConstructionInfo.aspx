<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="ConstructionInfo.aspx.cs" Inherits="RealERPWEB.F_08_PPlan.ConstructionInfo" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="nav nav-tabs card-header-tabs" style="margin-top: 20px;">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link show" data-toggle="tab" href="#dayorder">Day Wise Target</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link show" data-toggle="tab" href="#dayship">Day Wise Execution</a>
                                    </li>
