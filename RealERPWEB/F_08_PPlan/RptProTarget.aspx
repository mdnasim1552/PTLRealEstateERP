<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptProTarget.aspx.cs" Inherits="RealERPWEB.F_08_PPlan.RptProTarget" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function pageLoaded() {
            ...
            var gvProDetials = $('#<%=this.gvProDetials.ClientID %>');
            ...
            <div class="row">
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-5 pading5px ">
                                <asp:DropDownList ID="ddlProjectName" runat="server" OnSelectedIndexChanged="ddlProjectName_SelectedIndexChanged" CssClass="chzn-select form-control inputTxt" Style="width: 336px;" TabIndex="3">
                                </asp:DropDownList>

                            </div>

                            <div class="col-md-1 pading5px">
                                <asp:LinkButton ID="lbtnOk" runat="server" CssClass="btn btn-primary okBtn" OnClick="lbtnOk_Click" TabIndex="4" Style="margin-left: -146px;">ok</asp:LinkButton>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 pading5px asitCol4">
                                ...
                                <asp:TextBox ID="txttodate" runat="server" CssClass="inputTxt inpPixedWidth" TabIndex="2"></asp:TextBox>
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="ViewCashflowRaWork" runat="server">
                        ...
                        <asp:GridView ID="gvProTarget" runat="server" AllowPaging="True" CssClass=" table-striped table-hover table-bordered grvContentarea"
                            AutoGenerateColumns="False" OnPageIndexChanging="gvProTarget_PageIndexChanging"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkgvResDescd" runat="server" ForeColor="black" 
                                            Text='<%# "<B><span class=headerstyle>" + Convert.ToString(DataBinder.Eval(Container.DataItem, "grpdesc")) + "</span></B>"+
                                                                    ...
                                                                    %>'
                                            Width="200px" OnClick="lnkgvResDescd_Click">
                ...
                <div class="modal fade AsitModal" id="ProModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <%-- <div class="modal-dialog row">--%>
                    <%--  <div class="modal-content">--%>

                    <div class="modal-body">
                       
                                    <asp:GridView ID="gvresdet" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvresdet_RowDataBound" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        ShowFooter="True">
                                        <RowStyle />
                                        <Columns>
