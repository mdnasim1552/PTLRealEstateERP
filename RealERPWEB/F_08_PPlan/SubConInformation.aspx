<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="SubConInformation.aspx.cs" Inherits="RealERPWEB.F_08_PPlan.SubConInformation" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul class="nav nav-tabs card-header-tabs" style="margin-top: 20px;">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link show" data-toggle="tab" href="#dayorder">Day Wise Bill</a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 col-md-3 col-lg-3">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <asp:Label ID="lblYear" runat="server" class="GrpHeader" Visible="false" Width="267px">A. YEARLY BILL & PAYMENT</asp:Label>
                                                        ...
                                                        <asp:TemplateField HeaderText="Bill">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblyAmt" runat="server" Width="80px"
                                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "tbamt")).ToString("#,##0;-#,##0; ") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle Font-Size="10px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                        ...
                                        <div class="col-sm-9 col-md-9 col-lg-9">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-3 col-md-3 col-lg-3">
                                                    <asp:Label ID="lblWeek" runat="server" class="GrpHeader btn-block" Visible="false" Width="798px">C. WEEKLY BILL & PAYMENT</asp:Label>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="mon">
                                    <div class="row">
                                        <div class="col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <asp:Label ID="lblMon" runat="server" class="GrpHeader" Visible="false" Width="267px">B. MONTHLY BILL & PAYMENT</asp:Label>
                                            ...
                                            <asp:GridView ID="grvMonthlyPur" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Bill">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblyAmt" runat="server" Width="80px"
                                                                Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "tcbamt")).ToString("#,##0;-#,##0; ") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Payment">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblytpayamt" runat="server" Width="80px"
                                                                Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "tcbpayamt")).ToString("#,##0;-#,##0; ") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                            ...
                            <Legends>
                                ...
                                <div class="tab-pane fade" id="dayorder">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                            <asp:Label ID="lblDetails" runat="server" class="GrpHeader" Visible="false" Width="823px">D. DAY WISE BILL DETAILS</asp:Label>
                                            <asp:GridView ID="GvDayWise" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Labour Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblrsirdesc" runat="server" Width="250px"
