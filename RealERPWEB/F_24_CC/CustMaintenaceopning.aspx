<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="CustMaintenaceopning.aspx.cs" Inherits="RealERPWEB.F_24_CC.CustMaintenaceopning" %>
                ...
                <div class="contentPart">
                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        ...
                        <asp:View ID="ViewPersonal" runat="server">
                            ...
                            <div class="form-group">
                                <asp:Label ID="lperInfo0" runat="server" CssClass="btn btn-success primaryBtn" Text="Modification & Optional Information"></asp:Label>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <asp:GridView ID="gvCost" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Amount">
                                                <FooterTemplate>
                                                    <asp:Label ID="lgvFmodamt" runat="server" Font-Bold="True" Font-Size="12px"
                                                               ForeColor="#000" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtgvmodamt" runat="server" BackColor="Transparent"
                                                                 BorderStyle="None" Font-Size="11px" Height="18px" Style="text-align: right"
                                                                 Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "modaopamt")).ToString("#,##0;-#,##0; ") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Adjusted">
                                                ...
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtgvpaidamt" runat="server" BackColor="Transparent"
                                                        BorderStyle="None" Font-Size="11px" Height="18px" Style="text-align: right"
