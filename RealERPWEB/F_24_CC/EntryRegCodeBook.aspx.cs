...
{
    public partial class EntryRegCodeBook : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.ddlOthersBook.Items.Count == 0)
                this.Load_CodeBookList();
            //((Label)this.Master.FindControl("lblmsg")).Visible = true;

        }
        protected void Load_CodeBookList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "REGCOSTINF", "",
                                "", "", "", "", "", "", "", "");
                this.ddlOthersBook.DataTextField = "regdesc";
                this.ddlOthersBook.DataValueField = "regcod";
        ...
        protected void grvacc_OnRowEditing(object sender, GridViewEditEventArgs e)
        {
        ...
        protected void grvacc_OnRowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
        {
            this.grvacc.EditIndex = -1;
            this.grvacc_DataBind();
        }

        protected void grvacc_OnRowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            DataRow[] dr1 = ASTUtility.PagePermission1(HttpContext.Current.Request.Url.AbsoluteUri.ToString(), (DataSet)Session["tblusrlog"]);
            ...
            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK", "INSERTREGCOSTINF", gcode2,
                           Desc, Gtype, "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            try
            {
                ...
                DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "REGCOSTINFDETAILS", tempddl1,
                                "", "", "", "", "", "", "", "");
