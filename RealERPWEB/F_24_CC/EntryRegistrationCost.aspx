<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EntryRegistrationCost.aspx.cs" Inherits="RealERPWEB.F_24_CC.EntryRegistrationCost" %>
            ...
            <div class="container moduleItemWrpper">
                <div class="contentPart">
                    <div class="row">
                        ...
                        <asp:GridView ID="grvCostRegistration" runat="server" AutoGenerateColumns="False" Style="margin-left: 30px;"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Particulars">
                                    ...
                                    <FooterTemplate>
                                        <asp:LinkButton ID="btnUpdate" runat="server" CssClass="btn btn-success primaryBtn" OnClick="btnUpdate_OnClick"  style="margin-left: 7px;">Update</asp:LinkButton>
                                        <asp:LinkButton ID="btnCalculate" runat="server" CssClass="btn btn-primary primaryBtn" OnClick="btnCalculate_OnClick" style="margin-left: 7px;">Calculate</asp:LinkButton>
                                    </FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="Total Value">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtTotlValu" runat="server" BorderColor="#99CCFF"
                                            BorderStyle="Solid" BorderWidth="0px" Font-Size="12px"
                                            Style="background-color: Transparent; text-align:right"
                                            Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "TOTALVALUE")).ToString("#,##0;#,##0; ") %>'
                                            Width="60px"></asp:TextBox>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="grndTotal" runat="server" Font-Bold="True" Font-Size="12px"
                                ...
                                <asp:TemplateField HeaderText="Actual Amount">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtActAmnt" runat="server" BorderColor="#99CCFF"
                                            BorderStyle="Solid" BorderWidth="0px" Font-Size="12px"
                                            Style="background-color: Transparent; text-align: right"
                                ...
                                <asp:TemplateField HeaderText="Received Amount">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtRcvAmnt" runat="server" BorderColor="#99CCFF"
                                            BorderStyle="Solid" BorderWidth="0px" Font-Size="12px"
                                            Style="background-color: Transparent; text-align: right"
                                ...
                                <asp:TemplateField HeaderText="Received Amount(%)">
                                    <ItemTemplate>
                                        <asp:Label ID="lblRcAmtp" runat="server" Style="text-align: right" Width="50px" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem,"rcvamtp")).ToString("#,##0;#,##0; ") %>'></asp:Label>
                                 ...
                                 <asp:TemplateField HeaderText="Actual Cost(%)">
                                    <ItemTemplate>
                                        <asp:Label ID="lblacamtp" runat="server" Style="text-align: right" Width="50px" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem,"acamtp")).ToString("#,##0;#,##0; ") %>'></asp:Label>
