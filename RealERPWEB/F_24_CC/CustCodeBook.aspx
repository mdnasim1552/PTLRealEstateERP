<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="CustCodeBook.aspx.cs" Inherits="RealERPWEB.F_24_CC.CustCodeBook" %>
                                         ...
                                         <asp:Panel ID="Panel4" runat="server">
                                            ...
                                            <div class="col-md-10 pading5px asitCol10">
                                                <asp:Label ID="LblBookName1" runat="server" CssClass="lblTxt lblName"  Text="SC BOOK :" ></asp:Label>
                                                 ...
                                                 <asp:DropDownList ID="ddlSalPayment" runat="server" Width="350px" CssClass="ddlPage"> </asp:DropDownList>

                                               <asp:Label ID="lbalterofddl" runat="server" Visible="False" Width="400px" CssClass="inputtextbox"></asp:Label>
                                                ...
                                                <asp:ListItem Selected="True" Value="5">Details Code</asp:ListItem>
                                                 ...
                                                 <asp:Label ID="lbalterofddl0" runat="server"  Visible="False" CssClass="inputtextbox" Width="130px"></asp:Label>
                           ...
                           <asp:GridView ID="gvPaySch" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Type">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtgvttpe" runat="server" BackColor="#000" BorderStyle="None" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "gval")) %>'
                                            Width="50px"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
