...
namespace RealERPWEB.F_24_CC
{
    ...
    public partial class CompanyStandardChoice : System.Web.UI.Page
    {
        ...
        private void ShowData()
        {
            ...
            DataSet ds1 = CustData.GetTransInfo(comcod, "SP_ENTRY_SALSE_CLCHOICE", "GETCOMPANYSTANCHOICE", PactCode, "", "", "", "", "", "", "", "");
        ...
        private DataTable HiddenSameData(DataTable dt1)
        {
            ...
            {
                if (dt1.Rows[j]["mgcod"].ToString() == mgcod && dt1.Rows[j]["hcode"].ToString() == hcode)
                {
                ...
                hcode = dt1.Rows[0]["hcode"].ToString();
        ...
        protected void lbtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr2 in dt.Rows)
                {
                    ...
                    string chk = dr2["chk"].ToString();

                    if (chk == "True")
                    {
                        bool result = CustData.UpdateTransInfo(comcod, "SP_ENTRY_SALSE_CLCHOICE", "GETCOMPANYSTANINSERTANDUPDATE", Pactcode, wcode, chk, "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        private void ShowAll()
        {
            ...
            DataSet ds1 = CustData.GetTransInfo(comcod, "SP_ENTRY_SALSE_CLCHOICE", "GETCOMPANYSTANCHOICECHK", PactCode, "", "", "", "", "", "", "", "");
            //DataSet ds1 = CustData.GetTransInfo(comcod, "SP_ENTRY_SALSE_CLCHOICE", "GETCLINETCHOICE",PactCode, "", "", "", "", "", "", "","","","","","","");
            if (ds1 == null)
            {
                this.gvclientchoice.DataSource = null;
