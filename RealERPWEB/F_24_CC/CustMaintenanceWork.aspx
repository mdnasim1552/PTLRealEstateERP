                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2 pading5px asitCol3">
                                        ...
                                        <cc1:CalendarExtender ID="CalendarExtender1" runat="server"
                                            Enabled="True" Format="dd-MMM-yyyy" TargetControlID="txtCurTransDate"></cc1:CalendarExtender>
                    ...
                    <asp:Panel ID="PanelItem" runat="server" Visible="False">
                        <fieldset class="scheduler-border fieldset_B">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-md-3 pading5px asitCol3">
                                        <asp:Label ID="lblInsmnt" runat="server" CssClass="lblTxt lblName" Text="Installment" Visible="false"></asp:Label>
                                        <asp:TextBox ID="txtsrchInsmnt" runat="server" CssClass="inputTxt inputDateBox" Visible="false"></asp:TextBox>
                                        <asp:LinkButton ID="ibtnFindInsmnt" CssClass="btn btn-primary srearchBtn" runat="server" TabIndex="2" Visible="false"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>

                                    </div>
                                    <div class="col-md-4 pading5px asitCol4">
                                        <asp:DropDownList ID="ddlInstallment" runat="server" CssClass="form-control inputTxt chzn-select" Visible="false"></asp:DropDownList>
                                    </div>
                                    <div class="clearfix"></div>
