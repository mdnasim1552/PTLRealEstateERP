<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptProjectStatus.aspx.cs" Inherits="RealERPWEB.F_32_Mis.RptProjectStatus" %>
                ...
                <div class="contentPart">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class=" col-md-4  pading5px asitCol4">
                                        ...
                                        <asp:Label ID="lbltoDate" CssClass=" smLbl_to" runat="server" Text="To" Visible="false"></asp:Label>
                                        <asp:TextBox ID="txttodate" runat="server" CssClass=" inputtextbox" Visible="false"></asp:TextBox>
                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        <asp:View ID="PrjReport" runat="server">
                            <div class="table table-responsive">
                                <asp:GridView ID="grvPrjStatus" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                    CssClass=" table-striped table-hover table-bordered grvContentarea" OnPageIndexChanging="grvPrjStatus_PageIndexChanging"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="This Month">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFTmonSVal" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                        ...
                                        <asp:TemplateField HeaderText="Received  </br>against Sales">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFTReSVal" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Non-Operating </br> Income">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFNOI" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Receivable">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFBRecSalamt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Construction </br>  Admin </br>  Selling Exp.">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFExpAmt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Advance">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFPAdvAmt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Land Cost </br>(Non-Refundable)">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFLCNFAmt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Overhead">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFOvmt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Bank Interest">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFIAmt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Total Actual </br> Expenses">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFtExp" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Liabilities">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFLibAmt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Loan from</br> Head Office">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFLframt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Loan to</br> Head Office">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFLtoamt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Refundable </br>Loan">
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFRLamt" runat="server" Font-Bold="True" Font-Size="12px" ForeColor="#000"
                                                    Style="text-align: right" Width="80px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemTemplate>
                        ...
                        <asp:View ID="ViewTurnover" runat="server">
                            <div class="table table-responsive">
                                <asp:GridView ID="grvPrjturnover" runat="server" AutoGenerateColumns="False" OnRowDataBound="grvPrjturnover_RowDataBound" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ShowFooter="True">
                                    <RowStyle />
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sl.No.">
                        ...
                        <asp:View ID="ViewGPNPCalculation" runat="server">
                            <div class="table table-responsive">
                                <asp:GridView ID="gvGPNPCal" runat="server" AutoGenerateColumns="False" ShowFooter="True" CssClass=" table-striped table-hover table-bordered grvContentarea"
                        ...
                        <asp:View ID="ViewGPNPSummary" runat="server">
                            <div class="table table-responsive">
                                <asp:GridView ID="gvGpNpSum" runat="server" AutoGenerateColumns="False" ShowFooter="True" CssClass=" table-striped table-hover table-bordered grvContentarea"
