<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptMisMasterBgd03.aspx.cs" Inherits="RealERPWEB.F_32_Mis.RptMisMasterBgd03" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function pageLoaded() {
          ...
          var gvComCost = $('#<%=this.gvComCost.ClientID %>');
           // gvComCost.Scrollable();
            
            gvComCost.gridviewScroll({
                width: 1160,
                height: 420,
                arrowsize: 30,
                railsize: 16,
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 pading5px">
                                ...
                                <asp:LinkButton ID="lbtnShow" runat="server" CssClass="btn btn-primary primaryBtn"
                                    OnClick="lbtnShow_Click">Ok</asp:LinkButton>
                            </div>
                            ...
                            <asp:GridView ID="gvComCost" runat="server" AutoGenerateColumns="False" ShowFooter="True" CssClass=" table-striped table-hover table-bordered grvContentarea" OnRowDataBound="gvComCost_RowDataBound">
                                ...
                                <Columns>
                                     ...
                                     <asp:TemplateField  HeaderText="Group">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lggroup" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "grpdesc")) %>'
                                    ...
                                    <asp:TemplateField  HeaderText=" Main Head">
                                       
                                        <ItemTemplate>
                                            <asp:Label ID="lgvmainhead" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "mresdesc")) %>'
                                    ...
                                    <asp:TemplateField FooterText="Grand Total" HeaderText=" Description">
                                        <HeaderTemplate>
                                            <table style="width: 47%;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:HyperLink ID="hlbtnCdataExel" runat="server" CssClass="btn btn-warning primaryBtn">Export Excel</asp:HyperLink>
                                                    </td>
                                                </tr>
                                            </table>
                                        </HeaderTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="P22">
                                        <ItemTemplate>
                                            <asp:Label ID="lgvpc22" runat="server" Style="text-align: right" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "p22")).ToString("#,##0;(#,##0); ") %>'
                                                Width="55px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="P72">
                                        <ItemTemplate>
                                            <asp:Label ID="lgvpc72" runat="server" Style="text-align: right" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "p72")).ToString("#,##0;(#,##0); ") %>'
                                                Width="55px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
