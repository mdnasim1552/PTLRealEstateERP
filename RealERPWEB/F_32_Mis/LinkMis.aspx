<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkMis.aspx.cs" Inherits="RealERPWEB.F_32_Mis.LinkMis" %>
                ...
                <div class="contentPart">
                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        <asp:View ID="View1" runat="server">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 pading5px ">
                                                <asp:Label ID="Label1" CssClass="lblTxt lblName" runat="server" Text="Bill No:"></asp:Label>
                                                ...
                                                <asp:Label ID="lblProjectName" CssClass="smLbl_to" runat="server" Text=""></asp:Label>
                            ...
                            <div class="row">
                                <asp:GridView ID="gvPurBilltk" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                        ...
                        <asp:View ID="ViewResCostDetails" runat="server">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10 pading5px ">
                                                <asp:Label ID="Label3" CssClass="lblTxt lblName" runat="server" Text="Description"></asp:Label>
                                                <asp:Label ID="lblResName" CssClass=" smLbl_to" runat="server"></asp:Label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10 pading5px ">
                                                <asp:Label ID="Label4" CssClass="lblTxt lblName" runat="server" Text="From"></asp:Label>
                                                <asp:Label ID="lblfrmdate" CssClass=" smLbl_to" runat="server"></asp:Label>
                                                <asp:Label ID="Label5" CssClass="lblTxt lblName" runat="server" Text="To"></asp:Label>
                                                <asp:Label ID="lbltodate" CssClass=" smLbl_to" runat="server"></asp:Label>
                            ...
                            <div class="row">
                                <asp:GridView ID="gvComCost" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                        ...
                        <asp:View ID="ViewTvImp" runat="server">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 pading5px ">
                                                <asp:Label ID="Label6" CssClass="lblTxt lblName" runat="server" Text="Project :"></asp:Label>
                                                <asp:Label ID="lblProNametvp" CssClass=" smLbl_to" runat="server"></asp:Label>

                                            </div>
                                            <div class="col-md-8 pading5px ">
                                                <asp:Label ID="Label8" CssClass="lblTxt lblName" runat="server" Text="From: "></asp:Label>
                                                <asp:Label ID="lblfrmdatetvp" CssClass=" smLbl_to" runat="server"></asp:Label>
                                                <asp:Label ID="Label14" CssClass="smLbl_to" runat="server" Text="To :"></asp:Label>
                                                <asp:Label ID="lbltodatetvp" CssClass=" smLbl_to" runat="server"></asp:Label>
                                                <asp:Label ID="lblPactcode" runat="server" Visible="False" CssClass=" smLbl_to"></asp:Label>
                                                <asp:Label ID="lblPage" runat="server" Text="Page Size:" CssClass="lblName lblTxt">
                                                </asp:Label>
                            ...
                            <div class="row">
                                <asp:GridView ID="gvTvsImp" runat="server" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    AutoGenerateColumns="False" 
                                   ShowFooter="True" Width="104px">
                                    <RowStyle />
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sl">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Less Execution Qty">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Less Execution Amt">
                                            <ItemTemplate>
                                            ...
                                            <FooterTemplate>
                                                <asp:HyperLink ID="lgvFtramttvp" runat="server" Font-Bold="True" Font-Size="12px" Target="_blank"
                                                    ForeColor="Blue" Style="text-align: right" Width="75px"></asp:HyperLink>
                                            </FooterTemplate>
                                            <FooterStyle Font-Bold="True" HorizontalAlign="right" />
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                        </asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="Start Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lgvprjstdate" runat="server" 
                                                    Text='<%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "prjstdate")).ToString("dd-MMM-yyyy") %>'
                                                    Width="70px"></asp:Label>
                                            </ItemTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="End Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lgvprjenddate" runat="server"
                                                    Text='<%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "prjenddate")).ToString("dd-MMM-yyyy") %>'
                                                    Width="70px"></asp:Label>
                                            </ItemTemplate>
