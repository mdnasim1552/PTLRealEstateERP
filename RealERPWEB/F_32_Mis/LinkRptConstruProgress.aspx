<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkRptConstruProgress.aspx.cs" Inherits="RealERPWEB.F_32_Mis.LinkRptConstruProgress" %>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 pading5px">
                                        <asp:DropDownList ID="ddlProjectName" runat="server" style="width:336px;" AutoPostBack="True" CssClass="chzn-select form-control inputTxt"
                                            TabIndex="5">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-1 pading5px">
                                        <asp:LinkButton ID="lbtnOk" runat="server" Text="Ok" OnClick="lbtnOk_Click" CssClass="btn btn-primary okBtn" style="margin-left:-50px;" TabIndex="9"></asp:LinkButton>
