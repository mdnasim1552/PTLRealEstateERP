<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EntryFinResult.aspx.cs" Inherits="RealERPWEB.F_34_Mgt.EntryFinResult" %>
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            <div class="col-md-5 pading5px asitCol5">
                                ...
                                <asp:LinkButton ID="lbtnYearbgd" runat="server" CssClass="btn btn-primary primaryBtn"
