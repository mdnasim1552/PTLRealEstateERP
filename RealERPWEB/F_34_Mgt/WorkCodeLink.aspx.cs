...
namespace RealERPWEB.F_34_Mgt
{
    ...
    public partial class WorkCodeLink : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Work Code Permission";
        ...
        protected void Load_Project_Combo()
        {
            ...
            DataSet ds1 = purData.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "GETWORKLIST", "", "", "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        private void Get_Receive_Info()
        {
            ...
            DataSet ds1 = purData.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "GETWORKLINK", UserCode, "", "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        protected void lbtnSuplUpdate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tbl1.Rows.Count; i++)
            {
                ...
                bool result = purData.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "INSERTUPDATEWORKLINK",
                              userid, cacode, mRMRKS, "", "", "", "", "", "", "", "", "", "", "", "");
                if (!result)
                {
        ...
        protected void gvCALinkInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            //string cType = this.tbnRadio.SelectedValue.ToString();
            bool result = purData.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "DELETEWORKCODE", UserName, BankCode, "", "", "", "", "", "", "", "", "", "", "", "", "");
