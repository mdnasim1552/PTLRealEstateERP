...
{
    public partial class CodeLinkWs : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Link(WS)";
        ...
        private void GetACGCode()
        {
            ...
            string srchoption = "%%";
            DataSet dsone = this.accData.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "GETAGCCODE", srchoption, "WS", "", "", "", "", "", "", "");
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            this.grvacc.EditIndex = -1;
            bool result = this.accData.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK", "UPDATEACCGENCODEWS", actcode, acgcode, "", "", "", "", "", "", "", "",
                "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            ...
            string comcod = hst["comcod"].ToString();
            string srchoption = "%";
            DataSet ds1 = this.accData.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "GETWSCODEINFO", srchoption, "", "", "", "", "", "", "", "");
