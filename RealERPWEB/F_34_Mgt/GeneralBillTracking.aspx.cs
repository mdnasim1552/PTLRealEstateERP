...
{
    public partial class GeneralBillTracking : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "General Bill Edit ";
        ...
        private void GetReqno01()
        {
           ...
           // string date = this.txtCurReqDate.Text;
            ...
            DataSet ds1 = MktData.GetTransInfo(comcod, "SP_REPORT_REQ_STATUS", "GETGENERALBILLTRACKING", Mrfno, "", "", "", "", "", "");
