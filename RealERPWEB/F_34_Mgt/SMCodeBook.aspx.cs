...
{
    public partial class SMCodeBook : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((Label)this.Master.FindControl("lblTitle")).Text = "SMS/Mail Template Code";
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = _SMRecord.GetTransInfo(comcod, "SP_ENTRY_SMS_MAIL_INFO", "GETMODTEMP", "",
                                "", "", "", "", "", "", "", "");
        ...
        protected void ddlOthersBook_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            EnumerableRowCollection<DataRow> item = (from r in dt.AsEnumerable()
                                                     where (r.Field<string>("gcod").Substring(0, 2) == mrescode || r.Field<string>("gcod").Substring(0, 2) == "00")
                                                     select r);

            dt = item.AsDataView().ToTable();
            dt.Rows.Add("0000", "All Template");

            this.ddlCatcode.DataTextField = "gdesc";
            this.ddlCatcode.DataValueField = "gcod";
        ...
        protected void grvacc_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            string gcode2 = ASTUtility.Right(((TextBox)grvacc.Rows[e.NewEditIndex].FindControl("txtgrcode")).Text.Trim().Replace("-", ""), 2);
            ...
            if (gcode2 != "00")
            {
                ...
                dataTablesummary.Rows.Add("True", "Active");
                dataTablesummary.Rows.Add("False", "In-Active");

                DropDownList ddlgval = (DropDownList)this.grvacc.Rows[e.NewEditIndex].FindControl("ddlactStat");
                ddlgval.DataTextField = "typedesc";
                ddlgval.DataValueField = "type";
                ddlgval.DataSource = dataTablesummary;
                ddlgval.DataBind();
                ddlgval.SelectedValue = tbl1.Rows[rowindex]["actstatus"].ToString().Trim();
                ...
                var dataTablesummary2 = new DataTable();
                dataTablesummary2.Columns.Add("type", typeof(string));
                dataTablesummary2.Columns.Add("typedesc", typeof(string));
                dataTablesummary2.Rows.Add("True", "Active");
                dataTablesummary2.Rows.Add("False", "In-Active");

                DropDownList ddlgval2 = (DropDownList)this.grvacc.Rows[e.NewEditIndex].FindControl("ddlactMStat");
                ddlgval2.DataTextField = "typedesc";
                ddlgval2.DataValueField = "type";
                ddlgval2.DataSource = dataTablesummary2;
                ddlgval2.DataBind();
                ddlgval2.SelectedValue = tbl1.Rows[rowindex]["actmstatus"].ToString().Trim();
            }
            else
            {
                //ddlgval.Items.Clear();
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string smscont = ((TextBox)this.grvacc.Rows[e.RowIndex].FindControl("txtgvsmscont")).Text.Trim();
            string mailcont = ((TextBox)this.grvacc.Rows[e.RowIndex].FindControl("txtgvmailcont")).Text.Trim();
            string cActive = ((DropDownList)this.grvacc.Rows[e.RowIndex].FindControl("ddlactStat")).SelectedValue;
            string mActive = ((DropDownList)this.grvacc.Rows[e.RowIndex].FindControl("ddlactMStat")).SelectedValue;




            bool result = _SMRecord.UpdateTransInfo(comcod, "SP_ENTRY_SMS_MAIL_INFO", "INSERTUPSMINF", tgcod,
                           gdesc, smscont, mailcont, cActive, mActive, "", "", "", "", "", "", "", "", "");
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = _SMRecord.GetTransInfo(comcod, "SP_ENTRY_SMS_MAIL_INFO", "GETMODTEMPDETAILS", tempddl1,
                            tempddl2, catgrory, "", "", "", "", "", "");
        ...
        protected void grvacc_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (ASTUtility.Right(Code, 2) == "00" && ASTUtility.Right(Code, 4) != "0000")
                {

                    e.Row.Attributes["style"] = " font-weight:bold; color:#3399FF";
                }
