...
namespace RealERPWEB.F_02_Fea
{
    ...
    public partial class RptProjectFeasibility02 : System.Web.UI.Page
    {
        ...
        protected void lnkPrint_Click(object sender, EventArgs e)
        {
            ...
            if (qtype == "Cost")
            {
                ...
                dsrpt = feaData.GetTransInfo(comcod, "SP_REPORT_FEA_PROFEASIBILITY", "RPT_GETPROSALES", pactcode, Code, CostOrSale, mRptGroup, "", "", "", "", "");
                if (dsrpt == null)
                {
                    return;
                }
                ...
                TextObject txtBep3 = rpcp.ReportDefinition.ReportObjects["txtBep3"] as TextObject;
            ...
            if (qtype == "Revenue")
            {
                ...
                if (ASTUtility.Left(comcod, 1) == "2")
                {
                    ...
                    dsrevpt = feaData.GetTransInfo(comcod, "SP_REPORT_FEA_PROFEASIBILITY", "RPT_GETPROREVENUELAND", pactcode, Code, mRptGroup, "", "", "", "", "", "");
                    ...
                    {
                        rpcp = new RealERPRPT.R_02_Fea.RptPrjFeasRevnue1Det();
                    }
                }
                else
                {
                    ...
                    dsrevpt = feaData.GetTransInfo(comcod, "SP_REPORT_FEA_PROFEASIBILITY", "RPT_GETPROREVENUE", pactcode, Code, CostOrSale, mRptGroup, "", "", "", "", "");
        ...
        private void ShowCost()
        {
            ...
            DataSet ds2 = feaData.GetTransInfo(comcod, "SP_ENTRY_FEA_PROFEASIBILITY", "GETPROSALES02", pactcode, Code, CostOrSale, mRptGroup, "", "", "", "", "");
            if (ds2 == null)
            {
        ...
        private void ShowRevenueLand()
        {
            ...
            string mRptGroup = Convert.ToString(this.ddlGroup.SelectedIndex);
            mRptGroup = (mRptGroup == "0" ? "4" : (mRptGroup == "1" ? "4" : (mRptGroup == "2" ? "7" : (mRptGroup == "3" ? "9" : "12"))));
            DataSet ds2 = feaData.GetTransInfo(comcod, "SP_ENTRY_FEA_PROFEASIBILITY", "GETPROSALESREVNUELAND", pactcode, Code, mRptGroup, "", "", "", "", "", "");
            if (ds2 == null)
            {
        ...
        //        double tsizes = Convert.ToDouble("0" + ((TextBox)this.gvFeaPrjFCS.Rows[i].FindControl("txtgvlsizess")).Text.Trim());
        ...
        //        ((Label)this.gvFeaPrjFCS.Rows[i].FindControl("lgvstonums")).Text = (tsizes == 0) ? 0.00.ToString("#, ##0;(#,##0); ") : Convert.ToDouble((tssizesft / tsizes)).ToString("#, ##0;(#,##0); ");
        ...
        //    for (int i = 0; i < this.gvFeaPrjFCS.Rows.Count; i++)
        //    {
        //        string Code = Convert.ToDouble("0" + ((Label)this.gvFeaPrjFCS.Rows[i].FindControl("lblgvItmCodfcs")).Text.Trim()).ToString();
        ...
        //            bool result = feaData.UpdateTransInfo(comcod, "SP_ENTRY_FEA_PROFEASIBILITY", "INORUPDATEFEAPRJCTFC", PactCode, Code, lsizek, sftperf, tsizes.ToString(), tcsizesft.ToString(), bqty, bdesc, "", "", "", "", "", "", "");
        //        }
        ...
        //    double plownershare = Convert.ToDouble(this.lblLownerval.Text.Trim().Replace("%", ""));
        //    double pcomshare = Convert.ToDouble(this.lblCompanyval.Text.Trim().Replace("%", ""));
        ...
        //        double salamt = Convert.ToDouble("0" + ((TextBox)this.gvFeaPrj.Rows[i].FindControl("txtgvsalamt")).Text.Trim());

        //        double lownershare = tosize * plownershare * 0.01;
        //        double comshare = tosize * pcomshare * 0.01;
        //        double salrate = ((comshare + Purflowner) == 0) ? 0.00 : salamt / (comshare + Purflowner);
        ...
        //        dr1[0]["totalcom"] = comshare+Purflowner;
