...
{
    public partial class RptLinkFeaIncomeSt : System.Web.UI.Page
    {
        ...
        protected void gvFeaIncomeSt_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (InfCode == "000000000000")
            {
                ...
                string pactcode = Request.QueryString["actcode"].ToString().Trim();
                hlink1.NavigateUrl = "RptProjectrevRevenue.aspx?actcode=" + pactcode + "&actdesc=" + ActDesc;
            }
            ...
            if (InfCode == "000000000000")
            {
                ...
                string ActDesc = Request.QueryString["actdesc"].ToString().Trim();
                string pactcode = Request.QueryString["actcode"].ToString().Trim();
                hlink2.NavigateUrl = "RptLinkRevenueACost.aspx?actcode=" + pactcode + "&actdesc=" + ActDesc + "&Type=Revenue";
            }
            ...
            else if (InfCode == "60AAAAAAAAAA")
            {
                ...
                string ActDesc = Request.QueryString["actdesc"].ToString().Trim();
                string pactcode = Request.QueryString["actcode"].ToString().Trim();
                hlink2.NavigateUrl = "RptLinkRevenueACost.aspx?actcode=" + pactcode + "&actdesc=" + ActDesc + "&Type=Cost";
            }
