<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptProjectFeasibility.aspx.cs" Inherits="RealERPWEB.F_02_Fea.RptProjectFeasibility" %>
                                ...
                                <asp:Panel ID="Panel1" runat="server">
                                    <div class="form-group">
                                        <div class="col-md-10  pading5px  asitCol10">
                                            ...
                                            <asp:TextBox ID="txtSrcPro" runat="server" CssClass="inputTxt inpPixedWidth" Width="80px"></asp:TextBox>
                                            <asp:LinkButton ID="ibtnFindProject" CssClass="btn btn-primary srearchBtn" runat="server" OnClick="ibtnFindProject_Click" TabIndex="2"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
                                            <asp:DropDownList ID="ddlProjectName" runat="server" CssClass="ddlPage" Width="400px"></asp:DropDownList>
                                            <asp:LinkButton ID="lbtnOk" runat="server" OnClick="lnkbtnSerOk_Click" CssClass="btn btn-primary okBtn">Ok</asp:LinkButton>
