...
{
    public partial class ProjectFeasibility03 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //((Label)this.Master.FindControl("lblTitle")).Text = "Feasibility City Development";
            }
        }
        ...
        private void ShowCostAll()
        {
            ...
            string comcod = this.GetComCode();
            string pactcode = this.ddlProjectName.SelectedValue.ToString();
            // string Code = (this.rbtnList1.SelectedIndex == 1) ?  "(infcod like '0[3-5]%')":
            ...
            DataSet ds3 = feaData.GetTransInfo(comcod, "SP_ENTRY_FEA_PROFEASIBILITY_02", "FEAPRANDPRJCT02", pactcode, Code, CostOrSale, "12", "", "", "", "", "");
            ViewState["tblfeaprj"] = ds3.Tables[0];
            ViewState["tblfeaprjCal"] = ds3.Tables[2];
            this.gvFeaPrjFC.DataSource = ds3.Tables[1];
            this.gvFeaPrjFC.DataBind();
            //this.gvFeaPrjFC.Columns[12].HeaderText = (ASTUtility.Left(this.ddlProjectName.SelectedValue,4)=="0199")?"Total Khata":"Total SFT";
            //this.gvFeaPrjC.Columns[14].HeaderText = (ASTUtility.Left(this.ddlProjectName.SelectedValue, 4) == "0199") ? "Cost Per Khata" : "Cost Per SFT";
        ...
        protected void lUpdatProInfo_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < this.gvProjectInfo.Rows.Count; i++)
            {
                ...
                result = feaData.UpdateTransInfo(comcod, "SP_ENTRY_PRJ_INFO", "INSERTORUPDATEPRJINF", pactcode, Gcode, gtype, Gvalue, Gunit, fpactcode, "", "", "", "", "", "", "", "", "");
        ...
        private void ShowCost()
        {
            ...
            DataSet ds2 = feaData.GetTransInfo(comcod, "SP_ENTRY_FEA_PROFEASIBILITY_02", "GETPROSALES02", pactcode, Code, CostOrSale, "12", "", "", "", "", "");
            if (ds2 == null)
            {
        ...
        {
            double toamt = 0.00, far = 0.00, tfar = 0.00, bensft = 0.00;
            for (int i = 0; i < this.gvFeaPrjFC.Rows.Count; i++)
            {
                ...
                double stonum = Convert.ToDouble("0" + ((TextBox)this.gvFeaPrjFC.Rows[i].FindControl("txtgvstonum")).Text.Trim());//no of flr
                double tcsizesft = Convert.ToDouble("0" + ((TextBox)this.gvFeaPrjFC.Rows[i].FindControl("txtgvtcsft")).Text.Trim());//total sft

                far = tcsizesft / sftperf;

                ((Label)this.gvFeaPrjFC.Rows[i].FindControl("txtgvFar")).Text = far.ToString("#,##0.00;(#,##0.00); ");
                ...
                //double tcsizesft = (ASTUtility.Left(this.ddlProjectName.SelectedValue, 4) == "0199") ? (tsft + bensft)/720 : (tsft + bensft);//total sft
            ...
            ((Label)this.gvFeaPrjFC.FooterRow.FindControl("lgvFFar")).Text = tfar.ToString("#,##0.00;(#,##0.00); ");
        ...
        protected void lbtnfUpdateCostFC_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < this.gvFeaPrjFC.Rows.Count; i++)
            {
                ...
                string far = Convert.ToDouble("0" + ((Label)this.gvFeaPrjFC.Rows[i].FindControl("txtgvFar")).Text.Trim()).ToString();
