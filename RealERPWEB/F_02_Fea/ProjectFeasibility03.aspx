<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="ProjectFeasibility03.aspx.cs" Inherits="RealERPWEB.F_02_Fea.ProjectFeasibility03" %>
                                ...
                                <asp:GridView ID="gvProjectInfo" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox
                                                    ID="txtgvVal" runat="server" CssClass="form-control"
                                                     Height="20px"
                                ...
                                <asp:GridView ID="gvFeaPrjFC" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="FAR">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="txtgvFar" runat="server" BackColor="Transparent"
                                ...
                                <div class=" table table-responsive">
                                    <asp:GridView ID="gvFeaPrjC" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Building Cost">
                                                <ItemTemplate>
                            ...
                            <asp:View ID="ViewSalesRevenue" runat="server">
                                ...
                                <div class="table table-responsive">
                                    <asp:GridView ID="gvFeaPrjsalrev" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        OnRowDeleting="gvFeaPrjsalrev_RowDeleting" ShowFooter="True"
