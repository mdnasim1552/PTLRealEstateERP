<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptClientInitial.aspx.cs" Inherits="RealERPWEB.F_21_MKT.RptClientInitial" %>
            ...
            <div class="card card-fluid container-data">
                <div class="card-body">
                    ...
                    <asp:GridView ID="gvAdDetails" runat="server" AutoGenerateColumns="False"
                        ShowFooter="True" CssClass="table-striped table-hover table-bordered table-responsive grvContentarea" OnRowDataBound="gvAdDetails_RowDataBound">
                        <RowStyle />
                        <Columns>
