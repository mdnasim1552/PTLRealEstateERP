                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2 mb-0">
                          <label for="validationTooltip01">Lead Id                           
                          </label>
                        ...
                        <!-- form grid -->
                        <div class="col-md-2 mb-0">
                          <label for="validationTooltip02">Customer name
                        ...
                        <!-- form grid -->
                        <div class="col-md-2 mb-0">
                          <label for="validationTooltipUsername">Mobile                            
                          </label>
                          ...
                          <label for="validationTooltipUsername">Email                            
                           ...
                           <div class="col-md-2 mb-0">
                          <label for="validationTooltipUsername">Occupation                            
                          </label>
                          <input type="text" class="form-control form-control-sm"  placeholder="Occupation" aria-describedby="inputGroupPrepend" >
                         
                        </div>
                            <div class="col-md-2 mb-0">
                          <label for="validationTooltipUsername">Organization                            
                          </label>
                           ...
                           <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Category
                          ...
                          <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Area
                          ...
                          <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Project
                          ...
                          <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Flat size
                          ...
                          <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">User Group
                          ...
                          <select class="form-control form-control-sm" >
                           ...
                           <div class="col-md-2 mb-0">
                          <label for="validationTooltipUsername">Entry date range                            
                          </label>
                          <input type="text" class="form-control form-control-sm"  placeholder="Organization" aria-describedby="inputGroupPrepend" >
                         
                        </div>
                           <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Stage
                          ...
                          <select class="form-control form-control-sm" >
                           ...
                           <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Source
                          ...
                          <select class="form-control form-control-sm" >
                           ...
                           <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Sub Source
                          ...
                          <select class="form-control form-control-sm" >
                           ...
                           <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Cluster Head
                          ...
                          <select class="form-control form-control-sm" >
                           ...
                           <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Team Name
                          ...
                          <select class="form-control form-control-sm" >
                            ...
                            <option> United States </option>
                             ...
                             <div class="col-md-2 mb-0">
                          <label for="validationTooltipCountry">Project Visit Source
                          ...
                          <div class="input-group input-group-sm input-group-alt">
                                                            ...
                                                            <div class="input-group-append">
                                                                <a data-toggle="modal" href="#" onclick="OpenGenCode(11,'Category')" class="input-group-text text-success" data-target="#exampleModalSm"><span class="fa fa-search"></span></a>
