...
{
    public partial class MktGenCodeBookLand : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //((Label)this.Master.FindControl("lblTitle")).Text = "Land Basic Information Field";
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "MKTGENCODE", qtype,
                                    "", "", "", "", "", "", "", "");
        ...
        protected void grvacc_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            string Type = ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "54" & gcode2 != "000") ? "53%"
                ...
                : ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "45" & gcode2 != "000") ? "42%"
            ...
            if (gcode != "00000")
            {
                ...
                DataSet ds1 = da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "GETINFOMKTLIST", Type, "", "", "", "", "", "", "", "");
