                            ...
                            <div class=" btn-group" role="group" aria-label="Button group with nested dropdown">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop4" style="">
                                        ...
                                        <asp:HyperLink ID="hyplnkMktMatIssue" runat="server" Target="_blank" NavigateUrl="~/F_28_MPro/MktMatIssue?InputType=Entry&prjcode=&genno=&comcod=" CssClass="dropdown-item" Style="padding: 0 10px">Material Issue</asp:HyperLink>
                                        <asp:HyperLink ID="hlnkmktsurvey" runat="server" Target="_blank" NavigateUrl="~/F_14_Pro/PurMktSurvey?Type=SurveyLink" CssClass="dropdown-item" Style="padding: 0 10px">Market Survey</asp:HyperLink>
                                        <asp:HyperLink ID="hlnkbudget" runat="server" Target="_blank" NavigateUrl="~/F_04_Bgd/BgdMaster?InputType=BgdMain&prjcode=" CssClass="dropdown-item" Style="padding: 0 10px">General Budget</asp:HyperLink>
                                        <asp:HyperLink ID="hyplnkMktMonBudget" runat="server" Target="_blank" NavigateUrl="~/F_28_MPro/AccMktMonthlyBgd?Type=All&actcode=&year=" CssClass="dropdown-item" Style="padding: 0 10px">Monthly Budget</asp:HyperLink>
                                        <asp:HyperLink ID="hyplnkMktReqAdjust" runat="server" Target="_blank" NavigateUrl="~/F_28_MPro/MktReqAdjustment?Type=ReqAdjust" CssClass="dropdown-item" Style="padding: 0 10px">Requisition Adjustment</asp:HyperLink>
                                ...
                                <div class="panel with-nav-tabs panel-primary">
                                    ...
                                    <div>
                                        <asp:Panel ID="pnlReqStatus" runat="server" Visible="false">
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    <asp:GridView ID="gvReqInfo" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="">
                                                                ...
                                                                <HeaderTemplate>
                                                                    <asp:TextBox ID="txtSearchrefnum" SortExpression="mrfno" runat="server" Width="70px" onkeyup="Search_Gridview(this,4,'gvReqInfo')"></asp:TextBox><br />
                                        ...
                                        <asp:Panel ID="pnlReqChq" Visible="false" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    <asp:GridView ID="gvReqChk" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="">
                                                                <HeaderTemplate>
                                                                    <asp:TextBox ID="txtSearchrefnumrchq" SortExpression="mrfno" BorderStyle="None" runat="server" Width="70px" placeholder="MRF No." onkeyup="Search_Gridview(this,4,'gvReqChk')"></asp:TextBox><br />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Catagory">
                                                                <HeaderTemplate>
                                                                    <asp:TextBox ID="txtSearchCataReqChk" SortExpression="catagory" BorderStyle="None" runat="server" Width="120px" placeholder="Catagory" onkeyup="Search_Gridview(this,5,'gvReqChk')"></asp:TextBox>
                                                                </HeaderTemplate>
                                        ...
                                        <asp:Panel ID="pnlFinalApp" Visible="false" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvReqApp" runat="server" AutoGenerateColumns="False" CssClass="table-striped  table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="MRF No.">
                                                                <HeaderTemplate>
                                                                    <asp:TextBox ID="txtSearchrefnuml" SortExpression="mrfno" BorderStyle="None" runat="server" Width="70px" placeholder="MRF No." ToolTip="Search" onkeyup="Search_Gridview(this,4,'gvRateApp')"></asp:TextBox><br />
                                                            ...
                                                            <asp:TemplateField HeaderText="Catagory">
                                                                <HeaderTemplate>
                                                                    <asp:TextBox ID="txtSearchCatagoryRatApp" SortExpression="catagory" BorderStyle="None" runat="server" Width="120px" placeholder="Catagory" onkeyup="Search_Gridview(this,5,'gvRateApp')"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                        ...
                                        <asp:Panel ID="pnlcsprepared" Visible="false" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvcsprepared" runat="server" AutoGenerateColumns="False" CssClass="table-striped  table-bordered grvContentarea"
                                        ...
                                        <asp:Panel ID="pnlcsapproved" Visible="false" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvcsapproved" runat="server" AutoGenerateColumns="False" CssClass="table-striped  table-bordered grvContentarea"
                                        ...
                                        <asp:Panel ID="pnlWorkOrder" Visible="false" runat="server">
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvWrkOrd" runat="server" AutoGenerateColumns="False" CssClass="table-striped  table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="MRF No.">
                                                                ...
                                                                <HeaderTemplate>
                                                                    <asp:TextBox ID="txtSearchrefnumporder" SortExpression="mrfno" BorderStyle="None" runat="server" Width="70px" placeholder="MRF No." onkeyup="Search_Gridview(this,6, 'gvWrkOrd')"></asp:TextBox><br />
                                        ...
                                        <asp:Panel ID="pnlorderfapp" Visible="false" runat="server">
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvordfapp" runat="server" AutoGenerateColumns="False" CssClass="table-striped  table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="MRF No.">
                                                                <HeaderTemplate>
                                                                    <asp:TextBox ID="txtSearchrefnumofap" SortExpression="mrfno" BorderStyle="None" runat="server" Width="70px" placeholder="MRF No." onkeyup="Search_Gridview(this,6,'gvordfapp')"></asp:TextBox><br />
                                        ...
                                        <asp:Panel ID="pnlordersapp" Visible="false" runat="server">
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvordsapp" runat="server" AutoGenerateColumns="False" CssClass="table-striped  table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="MRF No.">
                                                                ...
                                                                <HeaderTemplate>
                                                                    <asp:TextBox ID="txtSearchrefnumosapp" SortExpression="mrfno" BorderStyle="None" runat="server" Width="70px" placeholder="MRF No." onkeyup="Search_Gridview(this,6,'gvordsapp')"></asp:TextBox><br />
                                        ...
                                        <asp:Panel ID="pnlMatRec" Visible="false" runat="server">
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="grvMRec" runat="server" AutoGenerateColumns="False" CssClass="table-striped  table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="MRF No.">
                                                                ...
                                                                <HeaderTemplate>
                                                                    <asp:TextBox ID="txtSearchrefnummrec" SortExpression="mrfno" BorderStyle="None" runat="server" Width="70px" placeholder="MRF No." onkeyup="Search_Gridview(this,6,'grvMRec')"></asp:TextBox><br />
                                        ...
                                        <asp:Panel ID="pnlComplete" Visible="false" runat="server">
                                            <div class="row">
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvPurcom" runat="server" AutoGenerateColumns="False" CssClass="table-striped  table-bordered grvContentarea"
                                                        ShowFooter="True" OnRowDataBound="gvPurcom_RowDataBound">
                                                        <RowStyle />
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Sl">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvDSlNocom" runat="server" Font-Bold="True" Style="text-align: right"
                                                                        Text='<%# Convert.ToString(Container.DataItemIndex+1)+"." %>' Width="30px"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="reqno#" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvreqnocom" runat="server" Font-Bold="True" Style="text-align: right"
                                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "reqno"))%>' Width="15px"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="mrrno#" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvmrrnocom" runat="server" Font-Bold="True" Style="text-align: right"
                                                            ...
                                                            <asp:TemplateField HeaderText="orderno#" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvordernocom" runat="server" Font-Bold="True" Style="text-align: right"
                                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "orderno"))%>' Width="15px"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Recevied <br>  Date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lnkgvmrrdatcom" runat="server"
                                                            ...
                                                            <asp:TemplateField HeaderText="MRR No">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvmrrno1com" runat="server" Font-Bold="True" Style="text-align: left"
                                                            ...
                                                            <asp:TemplateField HeaderText="MRR Ref">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvmrrrefcom" runat="server" Font-Bold="True" Style="text-align: left"
                                                            ...
                                                            <asp:TemplateField HeaderText="Order No">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvorderno1com" runat="server" Font-Bold="True" Style="text-align: left"
                                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "orderno1"))%>' Width="80px"></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText=" Req. No">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvreqno1com" runat="server" Font-Bold="True" Style="text-align: left"
                                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "reqno1"))%>' Width="80px"></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Mrf No.">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvmrfnocom" runat="server" Font-Bold="True" Style="text-align: left"
                                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "mrfno"))%>' Width="90px"></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle Width="90px" />
                                                            ...
                                                            <asp:TemplateField HeaderText="pactcode" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvpactcodecom" runat="server"
                                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "pactcode")) %>'
                                                                        Width="120px"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Resource</br> Count">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblitemcountcom" runat="server" Font-Bold="True"
                                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "itemcount"))%>' Width="40px"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Total Amount">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvmrramtcom" runat="server" Style="text-align: right"
                                                                        Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "mrramt")).ToString("#,##0;(#,##0);") %>'
                                                                        Width="50px"></asp:Label>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
                                                                    <asp:Label ID="lblgvFmrramtcom" runat="server" Style="text-align: right"></asp:Label>
                                                                </FooterTemplate>
                                                                <FooterStyle HorizontalAlign="Right" Font-Bold="true" Width="50px" />
                                                            </asp:TemplateField>
                                                            <%--<asp:TemplateField HeaderText="Curent Status">
                                                            ...
                                                            <asp:TemplateField HeaderText="">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HyperLink ID="hlnkmrrPrint" runat="server" Target="_blank" CssClass="btn btn-default btn-xs"><span class="fa fa-print"></span>
