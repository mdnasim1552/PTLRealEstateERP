...
namespace RealERPWEB.F_99_Allinterface
{
    ...
    public partial class SubContractorBillInterface : System.Web.UI.Page
    {
        ...
        private void SaleRequRpt()
        {
            ...
            this.RadioButtonList1.Items[6].Text = "<div class='circle-tile'><a><div class='circle-tile-heading yellow counter'>" + Convert.ToDouble(ds1.Tables[8].Rows[0]["redyforbill"]).ToString("#,##0;(#,##0); ") + "</i></div></a><div class='circle-tile-content yellow'><div class='circle-tile-description text-faded'>Ready For Bill</div></div></div>";
