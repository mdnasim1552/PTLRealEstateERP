                            ...
                            <table class="table table-dashed">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col" class="text-right w-70px">
                                    ACTION
                                  </th>
                                </tr>
                              </thead>
                              ...
                              <nav class="table-pagination">
                                <ul class="pagination">
                                  <li class="page-item mr-3">
                                    <a class="page-link previews" href="#"
                      ...
                      <div class="card-flash px-4 pt-3 pb-4">
                        ...
                        <div class="card-body pb-0">
                          ...
                          <div class="row">
                            ...
                            <!-- END -->
                            <div class="col-6 col-md-4 col-xl-3 mb-3">
                              <h4 class="card-text-title ml-4">
                                Lead to Q.Lead Ratio
                              </h4>
                              <div class="d-flex">
                                <div class="progress-1 progress-vertical mr-3">
                                  <div class="progress progress-cheyenne">
