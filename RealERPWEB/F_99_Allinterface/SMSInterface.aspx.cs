...
{
    public partial class SMSInterface : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "SMS / Mail Interface";
        ...
        private void GetAddWrkData()
        {
            ...
            this.RadioButtonList1.Items[0].Text = "<div class='circle-tile'><a><div class='circle-tile-heading dark-blue counter'>" + "2" + "</div></a><div class='circle-tile-content dark-blue'><div class='circle-tile-description text-faded'>Purchase Order</div></div></div>";

            this.RadioButtonList1.Items[1].Text = "<div class='circle-tile'><a><div class='circle-tile-heading red counter'>" + "3" + "</div></a><div class='circle-tile-content red'><div class='circle-tile-description text-faded'>Thanks Notification</div></div></div>";

            this.RadioButtonList1.Items[2].Text = "<div class='circle-tile'><a><div class='circle-tile-heading purple counter'>" + "5" + "</div></a><div class='circle-tile-content purple'><div class='circle-tile-description text-faded'>Money Receipt</div></div></div>";

            this.RadioButtonList1.Items[3].Text = "<div class='circle-tile'><a><div class='circle-tile-heading orange counter'>" + "7" + "</div></a><div class='circle-tile-content orange'><div class='circle-tile-description text-faded'>Collection Update</div></div></div>";

            this.RadioButtonList1.Items[4].Text = "<div class='circle-tile'><a><div class='circle-tile-heading dark-gray counter'>" + "3" + "</div></a><div class='circle-tile-content dark-gray'><div class='circle-tile-description text-faded'>Payment Update</div></div></div>";

            this.RadioButtonList1.Items[5].Text = "<div class='circle-tile'><a><div class='circle-tile-heading dark-blue counter'>" + "2" + "</div></a><div class='circle-tile-content dark-blue'><div class='circle-tile-description text-faded'>Cus. Payment dues</div></div></div>";

            this.RadioButtonList1.Items[6].Text = "<div class='circle-tile'><a><div class='circle-tile-heading red counter'>" + "9" + "</div></a><div class='circle-tile-content red'><div class='circle-tile-description text-faded'>Dues Reminder</div></div></div>";

            this.RadioButtonList1.Items[7].Text = "<div class='circle-tile'><a><div class='circle-tile-heading purple counter'>" + "7" + "</div></a><div class='circle-tile-content purple'><div class='circle-tile-description text-faded'>Client Birth Day</div></div></div>";

            this.RadioButtonList1.Items[8].Text = "<div class='circle-tile'><a><div class='circle-tile-heading orange counter'>" + "10" + "</div></a><div class='circle-tile-content orange'><div class='circle-tile-description text-faded'>Client Marr. Day</div></div></div>";

            this.RadioButtonList1.Items[9].Text = "<div class='circle-tile'><a><div class='circle-tile-heading dark-gray counter'>" + "5" + "</div></a><div class='circle-tile-content dark-gray'><div class='circle-tile-description text-faded'>Pro. Client DOB</div></div></div>";

            this.RadioButtonList1.Items[10].Text = "<div class='circle-tile'><a><div class='circle-tile-heading blue counter'>" + "9" + "</div></a><div class='circle-tile-content blue'><div class='circle-tile-description text-faded'>Pre. Client DOM</div></div></div>";
