<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="ProjectDashBoardAllNew.aspx.cs" Inherits="RealERPWEB.F_99_Allinterface.ProjectDashBoardAllNew" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetData() {
            try {
                ...
                $("#btn204").attr("href", "../F_32_Mis/ProjectSummary?Type=Report&comcod=" + comcod + "&projcode=" + $('#<%=this.ddlprojname.ClientID%>').val());
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlprojname" runat="server" CssClass="form-control form-control-sm chzn-select" TabIndex="12">
                                </asp:DropDownList>
                            </div>
                        ...
                        <div class="col-md-2" style="margin-top: 22px;">
                            <div class="form-group">
                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-primary primaryBtn bg-primary mb-2" ClientIDMode="Static">Project Information</asp:LinkButton>
                            </div>
                            ...
                            <div class="metric-row metric-flush">
                                ...
                                <div class="col">
                                    <a id="btn203" class="metric metric-bordered align-items-center" target="_blank" role="button">
                                        <h2 class="metric-label">Inflation Budget</h2>
                                    </a>
                                </div>
                                <div class="col">
                                    <a id="btn204" class="metric metric-bordered align-items-center" target="_blank" role="button">
                                        <h2 class="metric-label">Project Summary</h2>
                                    </a>
                                </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content  ">
                            <div class="modal-header bg-primary">
                                ...
                                <button type="button" style="background-color: red;" class="btn btn-xs" data-dismiss="modal"><span class="fa fa-times"></span></button>
