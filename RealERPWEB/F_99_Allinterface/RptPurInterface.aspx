                                                    ...
                                                    <asp:GridView ID="gvFRec" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Total Amount">
                                                                ...
                                                                <FooterTemplate>
                                                                    <asp:Label ID="lblgvApamtfrec" runat="server" Style="text-align: right"></asp:Label>
                                                                </FooterTemplate>
                                                                <FooterStyle HorizontalAlign="Right" Font-Bold="true" Width="80px" />
                                                            </asp:TemplateField>
                                                            <%-- <asp:TemplateField HeaderText="Curent Status">
                                                    ...
                                                    <asp:GridView ID="gvSecRec" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Total Amount">
                                                                ...
                                                                <FooterTemplate>
                                                                    <asp:Label ID="lblgvApamtsrec" runat="server" Style="text-align: right"></asp:Label>
                                                                </FooterTemplate>
                                                                <FooterStyle HorizontalAlign="Right" Font-Bold="true" Width="80px" />
                                                            </asp:TemplateField>
                                                            <%-- <asp:TemplateField HeaderText="Curent Status">
                                                    ...
                                                    <asp:GridView ID="gvThRec" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Total Amount">
                                                                ...
                                                                <FooterTemplate>
                                                                    <asp:Label ID="lblgvApamtthrec" runat="server" Style="text-align: right"></asp:Label>
                                                                </FooterTemplate>
                                                                <FooterStyle HorizontalAlign="Right" Font-Bold="true" Width="80px" />
                                                            </asp:TemplateField>
                                                            <%-- <asp:TemplateField HeaderText="Curent Status">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HyperLink ID="HyInprPrintosappReq" runat="server" Target="_blank" ToolTip="Print Req Info" CssClass="btn btn-default btn-xs"><span class="fa fa-print"></span>
                                                                    </asp:HyperLink>
