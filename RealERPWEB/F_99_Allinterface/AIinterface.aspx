                ...
                <div class="card mt-4">
                        ...
                        <div class="divPnl">
                            <asp:Panel ID="pnlAllProject" runat="server" Visible="false">
                                ...
                                <div class="table-responsive mt-2">
                                    <asp:GridView ID="gvInterface" runat="server" AutoGenerateColumns="False" CssClass=" table-striped  table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Order Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblordertype" runat="server" CssClass='<%#Convert.ToString(DataBinder.Eval(Container.DataItem, "ordertype")) =="Pilot" ? "badge badge-pill badge-info":" " %>'
                                            ...
                                            <asp:TemplateField HeaderText="Hour">
                                                <ItemTemplate>
                                                    <asp:Label ID="tblinhour" runat="server" Width="80px"
                            ...
                            <asp:Panel ID="pnlStatus" runat="server" Visible="false">
                                ...
                                <div class="row mt-2">
                                    <asp:GridView ID="gv_BatchList" runat="server" AutoGenerateColumns="False" CssClass=" table-striped  table-bordered grvContentarea"
                                ...
                                <div class="table-responsive mt-2">
                                    <asp:GridView ID="gvAssingJob" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblgvroletypedesc" runat="server" Width="60px"
                                                        CssClass='<%# (Convert.ToString(DataBinder.Eval(Container.DataItem, "roletype"))=="95001") ? "badge badge-pill badge-success"://done
                                                                    (Convert.ToString(DataBinder.Eval(Container.DataItem, "roletype"))=="95002") ? "badge badge-pill badge-danger"://hold
                                                                    (Convert.ToString(DataBinder.Eval(Container.DataItem, "roletype"))=="95003") ? "badge badge-pill badge-primary":"adge badge-pill badge-danger"//start
                                            ...
                                            <asp:TemplateField HeaderText="Per Hour">
                                                <ItemTemplate>
                            ...
                            <asp:Panel ID="pnlProduction" runat="server" Visible="false">
                                ...
                                <div class="table-responsive mt-2">
                                    <asp:GridView ID="gv_Production" runat="server" AutoGenerateColumns="False" CssClass=" table-striped  table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="AnnatorID">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ass. Qty">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="DoneQTY">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ass.Balance">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Skip QTY">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="PedictionTime" Visible="false">
                                                <ItemTemplate>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                ...
                                <div class="table-responsive mt-2">
                                    <asp:GridView ID="gv_QCQA" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="RoleType ">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="SkipQTY" Visible="false">
                                                <ItemTemplate>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="gv_Delivery" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="other type" Visible="false">
                                                <ItemTemplate>

                                                    <asp:Label ID="tblgvdelicurrencydesc" runat="server" Height="16px"
                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "currencydesc"))%>'
                                                        Width="80px"></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="DataSetType">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblgvdelidatasettype" runat="server" Height="16px"
                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "datasetdesc")) %>'
                                                        Width="150px"></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            ...
                                            <asp:TemplateField HeaderText="Project Type ">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblgvdelivelocitytype" runat="server" Height="16px"
                                                        Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "projecttypedesc")) %>'
                                                        Width="150px"></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                ...
                                <asp:GridView ID="gv_Invoice" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Invoice Print">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="lnkbtnmapiping" runat="server"  Target="_blank" CssClass="btn btn-default btn-xs"><span class="fa fa-street-view fa-xl"></span></asp:HyperLink>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Code" Visible="false">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblgvconsircode" runat="server" Font-Bold="True" Height="16px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "sircode")) %>'>
                                                </asp:Label>
                                                <asp:Label ID="lblgvconprjid" runat="server" Font-Bold="True" Height="16px"
                                                 ...
                                                 <asp:Label ID="lblconinvno" runat="server" Font-Bold="True" Height="16px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "invno")) %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        ...
                                        <asp:TemplateField HeaderText="Voucher No">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvconvounum" runat="server" Width="120px"
                                        ...
                                        <asp:TemplateField HeaderText="Invoice Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvconinvoicedate" runat="server" Width="120px"
                                                    Text='<%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "invoicedate")).ToString("dd-MMM-yyyy") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        ...
                                        <asp:TemplateField HeaderText="Customer Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvconcustomer" runat="server" Width="250px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "customer")) %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                        ...
                                        <asp:TemplateField HeaderText="Project Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvconprojectname" runat="server" Width="200px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "projectname")) %>'>
                                                </asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Data Set">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvcondataset" runat="server" Width="90px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "dataset")) %>'>
                                                </asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvconsubjects" runat="server" Width="90px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "subjects")) %>'>
                                                </asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="QTY">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvconqty" runat="server" Width="60px"
                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "qty")).ToString("#,##0;(#,##0); ") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        ...
                                        <asp:TemplateField HeaderText="Rate">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvcontotalrate" runat="server" Width="60px"
                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "totalrate")).ToString("#,##0.00;(#,##0.00); ") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        ...
                                        <asp:TemplateField HeaderText="Total Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvcontotalamount" runat="server" Width="70px"
                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "totalamount")).ToString("#,##0;(#,##0); ") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        ...
                                        <asp:TemplateField HeaderText="Information" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvconnationality" runat="server" Width="70px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "nationality")) %>'>
                                                </asp:Label>
                                                <asp:Label ID="lblgvconcity" runat="server" Width="70px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "city")) %>'>
                                                </asp:Label>
                                                <asp:Label ID="lblgvconaddres" runat="server" Width="70px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "addres")) %>'>
                                                </asp:Label>
                                                <asp:Label ID="lblgvconnotes" runat="server" Width="70px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "notes")) %>'>
                                                </asp:Label>
                                                <asp:Label ID="lblgvconcurrency" runat="server" Width="70px"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "currency")) %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        ...
                                        <asp:TemplateField HeaderText="Invoice Print">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="lnkbtnacollect" runat="server" Target="_blank" CssClass="btn btn-default btn-xs"><span class="fa fa-check"></span></asp:HyperLink>
                                                <asp:LinkButton runat="server" ID="btninvoicecollectprint" ><i class="fa fa-print fa-xl"></i></asp:LinkButton>
                                        ...
                                        <asp:TemplateField HeaderText="Create Date" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvcollinvoicedate" runat="server" Width="100px"
                                                    Text='<%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "invoicedate")).ToString("dd-MMM-yyyy") %>'>
                                                </asp:Label>
                                                <asp:Label ID="lblgvcollduedate" runat="server" Width="100px"
                                                    Text='<%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "duedate")).ToString("dd-MMM-yyyy") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    ...
                    <div id="pnlSidebar" class="card pnlSidebarCl" runat="server" visible="false">
                                ...
                                <div class="well">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6">
                                            <div class="form-group">
                                                <asp:Label ID="Label43" runat="server">Order Type</asp:Label>
                                                <asp:TextBox ID="lblprjordertype" runat="server" CssClass="form-control" Enabled="false" ReadOnly="true"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6">
                                            <div class="form-group">
                                                <asp:Label runat="server" ID="lable111">Total Qty</asp:Label>
                                                <asp:TextBox ID="lbltotalprjqty" runat="server" CssClass="form-control" Enabled="false" ReadOnly="true"></asp:TextBox>

                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6">
                                            <div class="form-group">
                                                <asp:Label ID="Label44" runat="server">Total Hour</asp:Label>
                                                <asp:TextBox ID="lblprjhour" runat="server" CssClass="form-control" Enabled="false" ReadOnly="true"></asp:TextBox>
                                    ...
                                    <asp:GridView ID="gv_gridBatch" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Delivery Date">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lbltotal" runat="server" Font-Bold="True" Font-Size="14px"
                                            ...
                                            <asp:TemplateField HeaderText="QTY">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="tblsumPrjqty" runat="server" ForeColor="Black" Font-Size="14px"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Time(H:M)">
                                                <ItemTemplate>
                        ...
                        <div class="modal-content" runat="server" id="pnlAssginUser" visible="false">
                            ...
                            <asp:Label runat="server" Visible="false" ID="lblfromuser"></asp:Label>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:GridView ID="GridVirtual" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Ann.ID">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ass. Type">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ass. QTY">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="tblsumValoquantity" runat="server" Width="100px" ForeColor="Black" Font-Bold="True" Font-Size="14px" Style="text-align: right"></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            </asp:TemplateField>
