                            ...
                            <div class=" btn-group" role="group" aria-label="Button group with nested dropdown">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop4" style="">
                                        ...
                                        <asp:HyperLink ID="HyperLink7" runat="server" Target="_blank" NavigateUrl="~/F_70_Services/QuotationEntry?Type=Entry" CssClass="dropdown-item" Style="padding: 0 10px">
                                            Quotation Entry</asp:HyperLink>
                                                ...
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvTotal" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Quoted <br>Amount">

                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbldatetime" runat="server" Style="text-align: right;"
                                                                ...
                                                                <FooterTemplate>
                                                                    <asp:Label ID="lblgvFAmt" runat="server" BackColor="Transparent"
                                                                        ...
                                                                        Width="150px" Style="text-align: right"></asp:Label>
                                                                </FooterTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                        ...
                                        <asp:Panel ID="pnlChecked" runat="server" Visible="false">
                                            <div class="row">
                                                ...
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvChecked" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea" ShowFooter="True"
                                        ...
                                        <asp:Panel ID="pnlApproval" runat="server" Visible="false">
                                            <div class="row">
                                                ...
                                                <div class="table-responsive col-lg-12">
                                                    ...
                                                    <asp:GridView ID="gvApproval" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea" ShowFooter="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Quotation Id">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="boolisEdit" runat="server" Visible="false"
                                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "isEdit")) %>'
                                                                    Width="100px"></asp:Label>
                                                                <asp:Label ID="boolismatreq" runat="server" Visible="false"
                                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "ismatreq")) %>'
                                                                    Width="100px"></asp:Label>
                                                                <asp:Label ID="boolislisuno" runat="server" Visible="false"
                                                        ...
                                                        <asp:TemplateField HeaderText="Material<br>Requisition">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblmatreq" runat="server"
                                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "descval")) %>'
                                                                    Width="150px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Sub<br>Contractor">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSubCon" runat="server"
                                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "lisudescval")) %>'
                                                                    Width="150px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkMatReq" ToolTip="Generate Material Requisition" OnClick="lnkMatReq_Click" runat="server"
                                                                                CssClass="dropdown-item ">Material Requisition</asp:LinkButton>
                                                                        </li>
                                                                        <li class="mt-2">
                                                                            <asp:LinkButton ID="lnkSubCon" ToolTip="Generate Sub Contractor" OnClick="lnkSubCon_Click" runat="server"
                                                                                CssClass="dropdown-item ">Sub Contractor</asp:LinkButton>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </ItemTemplate>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body mt-3">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <asp:Label ID="lblQuotation" runat="server" Visible="false"></asp:Label>
