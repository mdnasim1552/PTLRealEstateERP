...
{
    public partial class LandGenCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((Label)this.Master.FindControl("lblTitle")).Text = "Land Development Information Code";
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "GETLANDCODEBOOK", "",
                                    "", "", "", "", "", "", "", "");
        ...
        protected void grvacc_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            string Type = ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "54" & gcode2 != "000") ? "53%"
                ...
                : ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "54" & gcode2 == "000") ? "53%"
                : ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "55" & gcode2 == "000") ? "54%"
                : ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "56" & gcode2 == "000") ? "55%"
                : ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "57" & gcode2 == "000") ? "56%" : "";
            ...
            if (gcode != "00000")
            {
                ...
                DataSet ds1 = da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "GETLINFOLIST", Type, "", "", "", "", "", "", "", "");
                ddl3.DataTextField = "gdesc";
                ddl3.DataValueField = "gcod";
                ddl3.DataSource = ds1;
                ddl3.DataBind();
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK", "LANDCBINSERTUPPRINF", tgcod,
        ...
        protected void grvacc_DataBind()
        {
            try
            {
                ...
                this.grvacc.Columns[2].HeaderText = ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "54") ? "Zone"
                : ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "55") ? "District"
                : ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "56") ? "Thana/Police Station"
                : ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "57") ? "Moaza" : "";
                ...
                this.grvacc.Columns[2].Visible = ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "54") ? true
                    ...
                    : ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "57") ? true : false;
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK", "GETLANDCODEBOOKDETAIL", tempddl1,
                            tempddl2, catgrory, "", "", "", "", "", "");
