...
{
    public partial class RptMonMarTarget : System.Web.UI.Page
    {
        ...
        protected void Get_Info()
        {
            ...
            DataSet ds1 = MktData.GetTransInfo(comcod, "SP_REPORT_EMP_KPI", "RPTMARPROINFO", mPGNo, CurDate1,
                          "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
        ...
        protected void lbtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            bool result = false;
            result = MktData.UpdateTransInfo(comcod, "SP_ENTRY_PROJECTCOMFCHART", "INSORUPEMPSTDKPI02B", monpgno, date, "", "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        protected void gvPrjInfo_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string prono = this.lblCurNo1.Text.Trim().Substring(0, 2) + this.txtCurDate.Text.Trim().Substring(6, 4) + this.lblCurNo1.Text.Trim().Substring(2, 2) + this.txtCurNo2.Text.Trim();
