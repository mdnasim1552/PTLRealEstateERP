<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptEmpEvaSheet04.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.RptEmpEvaSheet04" %>
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvEmpEval" runat="server" AllowPaging="True" Width="200px"
                        ...
                        CssClass="table table-striped table-hover table-bordered grvContentarea" OnRowDataBound="gvEmpEval_RowDataBound" OnPageIndexChanging="gvEmpEval_PageIndexChanging" OnRowCreated="gvEmpEval_RowCreated">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Employee Name">
                                ...
                                <FooterTemplate>
                                    <table style="width: 100%;">
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblTotal" runat="server" Font-Bold="True" Font-Size="12px" Text="Total"></asp:Label>
                                            </td>

                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblgrndTotal" runat="server" Font-Bold="True" Font-Size="12px" Text="Grand Total"></asp:Label>
                                            </td>
                            ...
                            <asp:TemplateField HeaderText="Advance Collection">
                                <ItemTemplate>
                                ...
                                <FooterTemplate>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblFtamt4" runat="server" Style="text-align: right; color: black;" Width="70px"></asp:Label>
                                            </td>

                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblFgrandtamt" runat="server" Style="text-align: right; color: black;" Width="70px"></asp:Label>
                                            </td>
                            ...
                            <asp:TemplateField HeaderText="Advance Collection">
                                ...
                                <FooterTemplate>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblFamt4" runat="server" Style="text-align: right; color: black;" Width="70px"></asp:Label>
                                            </td>

                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblFgrandamt" runat="server" Style="text-align: right; color: black;" Width="70px"></asp:Label>
                                            </td>
                    ...
                    <div class="modal-dialog row">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <%--<asp:LinkButton ID="lnkClose" runat="server" CssClass="btn btn-default" OnClick="lnkClose_Click">Close</asp:LinkButton>--%>                                <%--<button type="button" class="btn btn-primary">Save changes</button>--%>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade AsitModal" id="exampleModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog row">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <%--  Discussion--%><%--<fieldset class="scheduler-border fieldset_B">
                ...
                <div class="modal fade AsitModal" id="exampleModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog row">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <%--<asp:LinkButton ID="lnkClose" runat="server" CssClass="btn btn-default" OnClick="lnkClose_Click">Close</asp:LinkButton>--%>                                <%--<fieldset class="scheduler-border fieldset_B">
                ...
                <div class="modal fade AsitModal" id="exampleModal6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog row">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <%--<button type="button" class="btn btn-primary">Save changes</button>--%><%--Collection--%>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade AsitModal" id="SalesModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog row">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <%--<button type="button" class="btn btn-primary">Save changes</button>--%><%--Visit --%>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade AsitModal" id="CollectionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog row">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <%--</span>--%><%--<asp:LinkButton ID="lnkClose" runat="server" CssClass="btn btn-default" OnClick="lnkClose_Click">Close</asp:LinkButton>--%>
                            </div>
                        </div>
                    </div>
                </div>
