<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EmpKpiEntry04All.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.EmpKpiEntry04All" %>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 pading5px">
                                ...
                                <asp:DropDownList ID="ddldepartment" runat="server" AutoPostBack="True"
                                    TabIndex="11" CssClass="ddlPage" style="width:150px;" OnSelectedIndexChanged="ddldepartment_SelectedIndexChanged">
                                </asp:DropDownList>
                                ...
                                <asp:TextBox ID="txtSrchSalesTeam" runat="server" TabIndex="3" CssClass=" smltxtBox60px"></asp:TextBox>
                                ...
                                <asp:DropDownList ID="ddlemplist" runat="server" CssClass="ddlPage" style="width:300px;"
                                    TabIndex="5" AutoPostBack="True" OnSelectedIndexChanged="ddlemplist_SelectedIndexChanged">
                                </asp:DropDownList>                            
                                <asp:LinkButton ID="lnkok" runat="server" Text="Ok" CssClass="btn btn-primary  okBtn "  TabIndex="9" OnClick="lnkok_Click"></asp:LinkButton>
                    ...
                    <div class="pull-right">
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="grvGpa" runat="server" AutoGenerateColumns="False"
                                ShowFooter="False" Width="150px" CssClass="table-striped table-hover table-bordered grvContentarea last_bold" OnRowDataBound="grvGpa_RowDataBound" >
                                <RowStyle />
                                <Columns>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 formBtn ">
                                    <div class="pull-left">
                                        ...
                                        <asp:LinkButton ID="lbtnAddClient" runat="server" CssClass="btn  btn-primary primaryBtn" Style="margin: 0 5px; padding: 2px 5px" NavigateUrl="#" OnClick="lbtnAddClient_Click"><span class="glyphicon glyphicon-indent-left"></span>Add Client</asp:LinkButton>



                                    </div>
                                    <div class="pull-right">
                                        <asp:LinkButton ID="lnkbtnAdd" runat="server" CssClass="btn  btn-primary primaryBtn" Style="margin: 0 5px;" OnClick="lnkbtnAdd_Click"><span class="flaticon-add118"></span> Add</asp:LinkButton>
                                        ...
                                        <asp:HyperLink ID="lnkbtnDelete" runat="server" CssClass="btn  btn-primary primaryBtn" Style="margin: 0 5px;" NavigateUrl="#"><span class="flaticon-deleted1 text-danger "></span>Delete</asp:HyperLink>
