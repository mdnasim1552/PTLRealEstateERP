...
{
    public partial class ClientCodeBook : System.Web.UI.Page
    {
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            //        bool result = this.da.UpdateTransInfo("0000", "dbo_kpi.SP_ENTRY_CODEBOOK_NEW", "GRPACCOUNTUPDATE", sircode2.Substring(0, 2), sircode, Desc, txtsirtype, txtsirtdesc, txtsirunit, txtsirval, userid, curcode, empcode,
            //            "", "", "", "", "");
            //        this.ShowInformation();
            //        if (result)
            //        {
            ...
            try
            {
                ...
                bool result = this.da.UpdateTransInfo(comcod, "dbo_kpi.SP_ENTRY_CODEBOOK_NEW", "INSORUPCLIENTINFO", proscod, Desc, Address, Phone, Email, active, "", imgpath, "", "", "", "", "", "", "");
                this.grvacc.EditIndex = -1;
                this.ShowInformation();
        ...
        private void ShowInformation()
        {
            ...
            DataSet ds1 = this.da.GetTransInfo(comcod, "dbo_kpi.SP_ENTRY_CODEBOOK_NEW", "GETCLIENTSINFO", wrkcom,
