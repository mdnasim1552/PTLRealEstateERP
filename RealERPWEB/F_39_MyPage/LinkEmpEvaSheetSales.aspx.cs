...
namespace RealERPWEB.F_39_MyPage
{
    ...
    public partial class LinkEmpEvaSheetSales : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Employee KPI Evaluation Sheet(Sales)";
                ...
                this.lblvalymon.Text = this.Request.QueryString["ymon"].ToString();
        ...
        private void ShowEmpData()
        {
            ...
            string YmonID = this.Request.QueryString["ymonid"].ToString();
            Hashtable hst = (Hashtable)Session["tblLogin"];
        ...
        private void FooterCal()
        {
            ...
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFamt4")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(amt5)", "")) ? 0 : dt.Compute("sum(amt5)", ""))).ToString("#,##0;(#,##0); ");
        ...
        protected void gvEmpEval_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string deptcode = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "secid")).ToString();
                ...
                DateTime date = Convert.ToDateTime(this.Request.QueryString["ymonid"].ToString().Substring(4, 2) + "/" + "01/" + this.Request.QueryString["ymonid"].ToString().Substring(0, 4));
                string edate = date.AddMonths(1).AddDays(-1).ToString("dd-MMM-yyyy");
                hlnkempname.NavigateUrl = "~/F_39_MyPage/LinkEmpKpiEntry04.aspx?Type=Mgt&deptcode=" + deptcode + "&empid=" + empid + "&monedate=" + edate;
                ...
                //  /LinkEmpKpiEntry04.aspx?Type=Mgt&deptcode=012400101002&empid=010100101021&monedate=31-Mar-2016


                //  hlnkempname.NavigateUrl = "~/F_21_Kpi/RptEmpMonthWiseEva.aspx?Type=Mgt";
                // Index.NavigateUrl = "~/F_05_MyPage/EmpKpiEntry04.aspx?Type=Mgt"; 
        ...
        private void PrintGroupWiseEmpEva()
        {
            ...
            date.Text = "Month: " + this.lblvalymon.Text;
        ...
        protected void lnkprintsales_Click(object sender, EventArgs e)
        {
            ...
            rptDate.Text = "Month : " + this.lblvalymon.Text;
        ...
        protected void lnkprint2_Click(object sender, EventArgs e)
        {
            ...
            //IEnumerable<RealEntity.C_47_Kpi.EClassClientDis> data = lst;
