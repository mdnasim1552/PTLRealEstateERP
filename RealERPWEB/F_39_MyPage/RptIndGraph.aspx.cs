...
{
    public partial class RptIndGraph : System.Web.UI.Page
    {
        ...
        private void GetIniEmpList()
        {
            ...
            List<RealEntity.C_47_Kpi.EClassEmpCode2> lst3 = objUser.GetEmpCode2(srchEmp, userid, deptcode, yearmon);
        ...
        private void ShowEmpMonGrap()
        {
            ...
            // string CallType = (deptcode == "010100101001") ? "GRAPHWKWISESALES" : "GRAPHDAYWISE";
            DataSet ds1 = KpiData.GetTransInfo(comcod, "SP_REPORT_EMP_KPI03", CallType, deptcode, ymon, Empid, Date);
        ...
        private void ShowEmpYearlyGraphGen()
        {
            ...
            // DataSet ds1 = KpiData.GetTransInfo(comcod, "SP_REPORT_EMP_KPI03", CallType, Empid, frmdate, todate);
            Session["tblempmoneva"] = lst;
            this.Data_Bind();
            this.FooterCalCulation();
