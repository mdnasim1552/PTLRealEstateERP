<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptMIS02.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.RptMIS02" %>
                                    ...
                                    <asp:GridView ID="gvevaoproject" runat="server" AllowPaging="True" OnPageIndexChanging="gvevaoproject_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Reference ">
                                                <ItemTemplate>
                                                    <asp:Label ID="lgvref" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "refno")) %>'
                                ...
                                <asp:GridView ID="gvEmpEval" runat="server" AllowPaging="True" Width="200px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Target">
                                            ...
                                            <FooterTemplate>
                                                <asp:Label ID="lblgvFtar" runat="server" Style="text-align: right; color: black;" Width="60px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemStyle HorizontalAlign="right" />
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Actual">
                                            ...
                                            <FooterTemplate>
                                                <asp:Label ID="lblgvFact" runat="server" Style="text-align: right; color: black;" Width="60px"></asp:Label>
                                            </FooterTemplate>
                                            <ItemStyle HorizontalAlign="right" />
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                        </asp:TemplateField>
                            ...
                            <asp:View ID="ViewEmpHistory" runat="server">
                                <asp:GridView ID="gvemphis" runat="server" AllowPaging="True" OnPageIndexChanging="gvemphis_PageIndexChanging"
                                    ...
                                    <Columns>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lgvempnamehis" runat="server"
                                                    Text='<%# "<B>"+ Convert.ToString(DataBinder.Eval(Container.DataItem, "actdesc")) + "</B>"+
                                                                         (DataBinder.Eval(Container.DataItem, "prono").ToString().Trim().Length>0 ? 
                                                                         (Convert.ToString(DataBinder.Eval(Container.DataItem, "actdesc")).Trim().Length>0 ?  "<br>" : "")+                                                             
                                                                         "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+ 
                                                                         Convert.ToString(DataBinder.Eval(Container.DataItem, "prono")).Trim(): "") 
                                        ...
                                        <asp:TemplateField HeaderText="Reference #">
                                            <ItemTemplate>
                                                <asp:Label ID="lgvrefnoihis" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "refno")) %>'
                                ...
                                <asp:GridView ID="gvindemphis" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Activities">
                                         ...
                                         <asp:TemplateField HeaderText="Reference #">
                                            <ItemTemplate>
                                                <asp:Label ID="lgvrefnoinhis" runat="server"
