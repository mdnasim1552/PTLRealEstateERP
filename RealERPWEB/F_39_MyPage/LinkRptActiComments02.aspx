<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkRptActiComments02.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.LinkRptActiComments02" %>
                       ...
                       <asp:GridView ID="gvPersonalInfo" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Note">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblgvcomments" runat="server" BackColor="Transparent"  BorderStyle="None" 
