...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EmpKpiEntry03.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.EmpKpiEntry03" %>
                                ...
                                <asp:TemplateField HeaderText="Activities">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lgvActivi" runat="server"
                                              Text='<%# "<B>"+ Convert.ToString(DataBinder.Eval(Container.DataItem, "prono1")) + "</B>"+
                                                                         (DataBinder.Eval(Container.DataItem, "actdesc").ToString().Trim().Length>0 ? 
                                                                         (Convert.ToString(DataBinder.Eval(Container.DataItem, "prono1")).Trim().Length>0 ?  "<br>" : "")+                                                             
                                                                         "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+ 
                                 ...
                                 <asp:TemplateField HeaderText="Refrence #">

                                    <ItemTemplate>
                                        <asp:Label ID="lblgvrefno" runat="server" BackColor="Transparent"
                                            BorderStyle="None"
                                            Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "refno"))%>'
                                            Width="90px" Font-Size="11px" style="text-align:right"></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Finish">
                                    ...
                                    <ItemTemplate>
                                         <asp:TextBox ID="txtacDate" runat="server" BackColor="Transparent"
                                            BorderStyle="None"
                                            Text='<%# (Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "acdat")).ToString("dd-MMM-yyyy")=="01-Jan-1900")?""
                                                                    :Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "acdat")).ToString("dd-MMM-yyyy")%>'
                                            Width="65px" Font-Size="11px"></asp:TextBox>
