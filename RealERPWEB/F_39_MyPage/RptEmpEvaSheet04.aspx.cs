...
{
    public partial class RptEmpEvaSheet04 : System.Web.UI.Page
    {
        ...
        private void ShowEmpData()
        {
            ...
            DataSet ds = KpiData.GetTransInfo(comcod, "SP_REPORT_EMP_KPI", "SHOWKPISTATUSALLCR", YmonID, "", empid, teamwgroup, deptcode);
            ViewState["tbEmpEval"] = ds.Tables[0];
        ...
        private void FooterCal()
        {
            ...
            double tamt1 = 0.00, tamt2 = 0.00, tamt3 = 0.00, tamt4 = 0.00, amt1 = 0.00, amt2 = 0.00, amt3 = 0.00, amt4 = 0.00;

            tamt1 = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(tamt1)", "")) ? 0 : dt.Compute("sum(tamt1)", "")));
            tamt2 = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(tamt2)", "")) ? 0 : dt.Compute("sum(tamt2)", "")));
            tamt3 = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(tamt3)", "")) ? 0 : dt.Compute("sum(tamt3)", "")));
            tamt4 = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(tamt4)", "")) ? 0 : dt.Compute("sum(tamt4)", "")));
            amt1 = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(amt1)", "")) ? 0 : dt.Compute("sum(amt1)", "")));
            amt2 = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(amt2)", "")) ? 0 : dt.Compute("sum(amt2)", "")));
            amt3 = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(amt3)", "")) ? 0 : dt.Compute("sum(amt3)", "")));
            amt4 = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(amt4)", "")) ? 0 : dt.Compute("sum(amt4)", "")));
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFtamt1")).Text = tamt1.ToString("#,##0;(#,##0); ");
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFtamt2")).Text = tamt2.ToString("#,##0;(#,##0); ");
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFtamt3")).Text = tamt3.ToString("#,##0;(#,##0); ");
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFtamt4")).Text = tamt4.ToString("#,##0;(#,##0); ");
            ...
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFamt1")).Text = amt1.ToString("#,##0;(#,##0); ");
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFamt2")).Text = amt2.ToString("#,##0;(#,##0); ");
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFamt3")).Text = amt3.ToString("#,##0;(#,##0); ");
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFamt4")).Text = amt4.ToString("#,##0;(#,##0); ");
            ...
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFgrandtamt")).Text = (tamt1 + tamt2 + tamt3 + tamt4).ToString("#,##0;(#,##0); ");
            ((Label)this.gvEmpEval.FooterRow.FindControl("lblFgrandamt")).Text = (amt1 + amt2 + amt3 + amt4).ToString("#,##0;(#,##0); ");

            // ((Label)this.gvEmpEval.FooterRow.FindControl("lblFamt4")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(amt6)", "")) ? 0 : dt.Compute("sum(amt6)", ""))).ToString("#,##0;(#,##0); ");
        ...
        protected void gvEmpEval_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlnkempname.NavigateUrl = "~/F_05_MyPage/RptEmpMonthWiseEva04.aspx?Type=Mgt";
        ...
        private void PrintGroupWiseEmpEva()
        {
            ...
            if (ds2 == null) { return; }
            ReportDocument rptAppMonitor = new RealERPRPT.R_62_Mis.rptGrpwiseEmpEva04();
        ...
        private void PrintEmpEva()
        {
            ...
            ReportDocument rptAppMonitor = new RealERPRPT.R_62_Mis.rptCREmpEva();
            TextObject txtCompName = rptAppMonitor.ReportDefinition.ReportObjects["txtCompName"] as TextObject;
            txtCompName.Text = comnam;
        ...
        public void SetReportParameters(LocalReport rt)
        {
            ...
            string reportname = "Employee KPI Evaluation Sheet For The Month of " + this.ddlyearmon.SelectedItem.ToString();
