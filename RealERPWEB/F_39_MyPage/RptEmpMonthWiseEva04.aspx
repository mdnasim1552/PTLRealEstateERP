<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptEmpMonthWiseEva04.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.RptEmpMonthWiseEva04" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var url = "../S_05_MyPage/RptEmpMonthWiseEva03.asmx/PrintRptMonEva04";
        var prntVal = 'PDF';
        var empid = '';
        var frmdate = '';
        var todate = '';
        ...
        function GetEmpMonEva() {
            ...
            var tblmoneeva = objmonempeva.GetEmpMonEva04(empid, frmdate, todate);
        ...
        function displayTable(tblmoneeva) {
            var i = 0, curdueper = 0.00, predueper = 0.00, retper = 0.00, advcollper = 0.00, othper = 0.00
            var ttamt1 = 0.00;
            var ttamt2 = 0.00;
            var ttamt3 = 0.00;
            var ttamt4 = 0.00;
            ...
            $("#grvMonthempeva").append(" <thead class=grvHeader style=" + "font-weight:bolder;" + ">" +
                "<tr><th style='width:30px;'></th><th style='width:70px;'></th><th  colspan='5' >Target</th>" +
                 "<th colspan='5' >Actual</th><th style='width:70px;'></th><th style='width:70px;'></th></tr>" +
                 "<tr><th style='width:30px;'>SL</th><th style='width:70px;'>MONTH</th><th style='width:80px;'>Curent Dues</th><th style='width:80px;'>Over Dues</th>" +
                        "<th style='width:70px;'>Return</th><th style='width:70px;'>Advance Coll</th><th style='width:70px;'>Others</th> "+
                        "<th style='width:80px;'>Curent Dues</th><th style='width:80px;'>Over Dues</th><th style='width:70px;'>Return</th><th style='width:70px;'>Advance Coll</th><th style='width:70px;'>Others</th>" +
            ...
            $.each(tblmoneeva, function (index, arval) {
                ...
                taamt5 += arval.amt5;
                taamt6 += arval.amt6;
                curdueper = (ttamt1 == 0) ? 0.00 : ((taamt1 / ttamt1) * 100).toLocaleString('en-US', { minimumFractionDigits: 2 });
                predueper = (ttamt2 == 0) ? 0.00 : ((taamt2 / ttamt2) * 100).toLocaleString('en-US', { minimumFractionDigits: 2 });
                retper = (ttamt3 == 0) ? 0.00 : ((taamt3 / ttamt3) * 100).toLocaleString('en-US', { minimumFractionDigits: 2 });
                advcollper = (ttamt4 == 0) ? 0.00 : ((taamt4 / ttamt4) * 100).toLocaleString('en-US', { minimumFractionDigits: 2 });
                othper = (ttamt5 == 0) ? 0.00 : ((taamt5 / ttamt5) * 100).toLocaleString('en-US', { minimumFractionDigits: 2 });
            ...
            $("#grvMonthempeva").append(" <tfoot class=grvHeader><tr><td style=text-align:center;></td>" + "<td style=text-align:right;font-weight:bold;>" + "TOTAL" + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtamt1 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtamt2 + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtamt3 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtamt4 + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtamt5 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtaamt1 + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtaamt2 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtaamt3 + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtaamt4 + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + sumtaamt5 + "</td><td></td><td></td></tr>"



                  + "<tr><td style=text-align:center;></td>" + "<td style=text-align:right;font-weight:bold;>" + "%" + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "</td>" 
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + curdueper + " %" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + predueper + " %" + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + retper + " %" + "</td>" + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + advcollper + " %" + "</td>"
                    + "<td style=text-align:right;font-weight:bold;" + ">" + "&nbsp" + othper + " %" + "</td><td></td><td></td></tr>"
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1 pading5px">
                                         ...
                                         <a class="btn btn-primary primaryBtn" href='<%=this.ResolveUrl("~/F_21_Kpi/RptEmpMonthWiseEvaDet.aspx?Type=Mgt")%>' target="_blank" style="margin: 10px 0 0 5px; line-height: 18px;">NEXT</a>
