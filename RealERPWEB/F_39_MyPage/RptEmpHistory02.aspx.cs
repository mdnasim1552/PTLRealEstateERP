...
{
    public partial class RptEmpHistory02 : System.Web.UI.Page
    {
        public UserManagerKPI objUser = new UserManagerKPI();
        //UserManager userManager = new UserManager();
        UserManagerMIS userManager = new UserManagerMIS();
        ...
        protected void lbtnOk_Click(object sender, EventArgs e)
        {
            ...
            lst = userManager.GetEmpHistory02(empid, frmdate, todate);
        ...
        {
            List<RealEntity.C_39_MyPage.EClassMIS.EClassEmpHistory02> lst = (List<RealEntity.C_39_MyPage.EClassMIS.EClassEmpHistory02>)Session["tblemphis"];
        ...
        protected void lnkprint_Click(object sender, EventArgs e)
        {
            ...
            ReportDocument rptAppMonitor = new RealERPRPT.R_39_MyPage.rptIndEmpHistoryMar();
