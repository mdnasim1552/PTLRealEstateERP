...
{
    public partial class EmpKpiEntry03 : System.Web.UI.Page
    {
        ...
        private void ShowEmpData()
        {
            ...
            DataSet ds = KpiData.GetTransInfo(comcod, "dbo_kpi.SP_ENTRY_EMP_KPI_ENTRY", "SHOWEMPACTIVITIES02", empid);
        ...
        private DataTable HiddenSameData(DataTable dt1)
        {
            ...
            string prono = dt1.Rows[0]["prono"].ToString();
            for (int j = 1; j < dt1.Rows.Count; j++)
            {
                if (dt1.Rows[j]["prono"].ToString() == prono)
                {
                    dt1.Rows[j]["prono1"] = "";
                    dt1.Rows[j]["refno"] = "";
                }
                prono = dt1.Rows[j]["prono"].ToString();
            }
            return dt1;
        ...
        protected void gvempkpi_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlnkgvcomments.NavigateUrl = "~/F_05_MyPage/LinkActiComments02.aspx?empid=" + empid + "&prono=" + prono + "&refno=" + refno + "&actcode=" + actcode + "&actdesc=" + actdesc + "&date=" + date; ;
