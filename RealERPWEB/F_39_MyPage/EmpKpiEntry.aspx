<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EmpKpiEntry.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.EmpKpiEntry" %>
                ...
                <fieldset class="scheduler-border fieldset_B">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 pading5px">
                                <asp:DropDownList ID="ddlClient" runat="server" AutoPostBack="True" CssClass="form-control  inputTxt"
                                    TabIndex="5">
                                </asp:DropDownList>
                            </div>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Panel ID="PnlProject" runat="server">
                                                                <div class="col-md-3 pading5px asitCol3">
                                                                    <asp:TextBox ID="txtProSearch" Visible="false" runat="server" CssClass="inputTxt inputName smltxtBox" TabIndex="10"></asp:TextBox>
                                                            ...
                                                            <asp:Panel ID="PnlUnit" runat="server">
                                                                <div class="col-md-3 pading5px asitCol3">
                                                                    ...
                                                                    <div class="colMdbtn">
                                                                        <asp:LinkButton ID="imgSearchUnit" runat="server" Visible="false" CssClass="btn btn-primary srearchBtn" OnClick="imgSearchUnit_Click" TabIndex="11"><span class="glyphicon glyphicon-search asitGlyp"> </span></asp:LinkButton>
