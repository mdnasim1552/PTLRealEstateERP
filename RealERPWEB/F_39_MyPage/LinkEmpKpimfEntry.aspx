<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkEmpKpimfEntry.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.LinkEmpKpimfEntry" %>
                ...
                <fieldset class="scheduler-border fieldset_B">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 pading5px asitCol3">
                                <asp:RadioButtonList ID="rbtnlist" runat="server"  RepeatDirection="Horizontal" Visible="false"
                                    CssClass="btn btn-primary  primarygrdBtn">
                                    <asp:ListItem  Value="810100601003" Enabled="false">&nbsp;&nbsp;Offer &nbsp;&nbsp;</asp:ListItem>
                                    <asp:ListItem  Value="810100601004" Enabled="false">&nbsp;&nbsp;Visit &nbsp;&nbsp;</asp:ListItem>
                                    <asp:ListItem Selected="True" Value="810100601005" Enabled="false">&nbsp;&nbsp;Call &nbsp;&nbsp;</asp:ListItem>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 pading5px asitCol3">
                                ...
                                <asp:Label ID="lblClientName" runat="server" CssClass=" lblTxt lblName" Text="Client Name"></asp:Label>
                                <asp:TextBox ID="txtClient" runat="server" TabIndex="3" CssClass=" inputtextbox" ></asp:TextBox>
                                <div class="colMdbtn">
                                    <asp:LinkButton ID="btnClient" runat="server" OnClick="btnClient_Click" TabIndex="4" CssClass="btn btn-primary srearchBtn"><span class="glyphicon glyphicon-search asitGlyp"></span></asp:LinkButton>
                                </div>

                            </div>
                            <div class="col-md-3 pading5px asitCol3">
                                <asp:DropDownList ID="ddlClient" runat="server" AutoPostBack="True" CssClass="ddlPage235 inputTxt"
                                    TabIndex="5">
                                </asp:DropDownList>
                            </div>
                       ...
                       <div class="clearfix"></div>
                        ...
                        <div class="table-responsive">
                                    <asp:GridView ID="gvclient" runat="server"
                                        ...
                                        CssClass="table table-striped table-hover table-bordered grvContentarea" Width="814px">
                                        <PagerSettings NextPageText="Next" PreviousPageText="Previous" Position="Top"
                                            Mode="NumericFirstLast" />
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Product Description">
                                                <ItemTemplate>
                                                    <asp:Label ID="lgvprodescription" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "prodesc")) %>'
