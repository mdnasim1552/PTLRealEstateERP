<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkIndGraph.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.LinkIndGraph" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-md-4 pading5px">
                                        <asp:Label ID="lblempname" runat="server" CssClass="lblTxt lblName" Text="Employee Name:"></asp:Label>
                                        <asp:Label ID="lblvalempname" runat="server" CssClass="inputlblVal" Style="width:250px;"></asp:Label>
                                     ...
                                     <div class="col-md-4 pading5px">
                                        ...
                                        <asp:Label ID="lblvaldepartment" runat="server" CssClass="inputlblVal" Style="width:200px;"></asp:Label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-4 pading5px">
                                        <asp:Label ID="lbldesignation" runat="server" CssClass="lblTxt lblName" Text="Designation:"></asp:Label>
                                        <asp:Label ID="lblvaldesignation" runat="server" CssClass="inputlblVal" Style="width:250px;"></asp:Label>
                                           </div>
                                         <div class="col-md-4 pading5px">
                                        <asp:Label ID="lbljoiningdate" runat="server" CssClass="smLbl_to" Text=" Joining Date:"></asp:Label>
                                        <asp:Label ID="lblvaljoiningdate" runat="server" CssClass="inputlblVal" Style="width:200px;"></asp:Label>
