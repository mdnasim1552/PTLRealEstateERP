...
{
    public partial class EmpKpiEntry04All : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.lbtnAddClient.Visible = (this.ddldepartment.SelectedValue.ToString() == "010100101001");
                this.GetIniEmpList();
                this.ShowGpa();
            }
        }
        ...
        private void GetDepartment()
        {
            ...
            hst["deptcode"] = this.ddldepartment.SelectedValue.ToString();
            hst["deptname"] = this.ddldepartment.SelectedItem.Text;
        ...
        protected void gvEmpWlist_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (kpigrp == "810100601003" || kpigrp == "810100601004" || kpigrp == "810100601005")
                {
                    ...
                    string comcod = ASTUtility.Left(this.Getcomcod(), 1);
                    if (comcod == "7" || comcod == "8")
                        hlnkgvwrkdesc.NavigateUrl = "~/F_39_MyPage/LinkEmpKpimfEntry.aspx?Type=Mgt&empid=" + this.ddlemplist.SelectedValue.ToString() + "&kpigrp=" + kpigrp;
                    else
                        hlnkgvwrkdesc.NavigateUrl = "~/F_39_MyPage/LinkEmpKpiEntry.aspx?Type=Mgt&empid=" + this.ddlemplist.SelectedValue.ToString() + "&kpigrp=" + kpigrp;
                ...
                else if (kpigrp == "810100603001" || kpigrp == "810100603002" || kpigrp == "810100603003" || kpigrp == "810100603004" || kpigrp == "810100603005" || kpigrp == "810100603006" || kpigrp == "810100603901")
                {
                    ...
                    hlnkgvwrkdesc.NavigateUrl = "~/F_39_MyPage/LinkEmpKpiEntryLeg.aspx?Type=Mgt&empid=" + this.ddlemplist.SelectedValue.ToString() + "&kpigrp=" + kpigrp;
        ...
        protected void lbtnAddClient_Click(object sender, EventArgs e)
        {
            ...
            ((LinkButton)this.Master.FindControl("lnkPrint")).Text = "";
            ((Label)this.Master.FindControl("lblprintstk")).Text = @"<script>window.open('../F_39_MyPage/ClientCodeBook.aspx', target='blank');</script>";
        }
