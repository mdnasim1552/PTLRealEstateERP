<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptEmpMonthWiseEva03.aspx.cs" Inherits="RealERPWEB.F_39_MyPage.RptEmpMonthWiseEva03" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="../Script_own/S_05_MyPage/RptEmpMonthWiseEva03.js"></script>
     ...
     <script type="text/javascript">
        ...
        var url = "../S_05_MyPage/RptEmpMonthWiseEva03.asmx/PrintRpt";
        var prntVal = 'PDF';
        var empid = '';
        var frmdate = '';
        var todate = '';
        ...
        function displayTable(tblmoneeva) {
            ...
            $("#grvMonthempeva").append(" <thead class=grvHeader style=" + "font-weight:bolder;" + ">" +
                 "<tr><th style='width:30px;'>SL</th><th style='width:70px;'>MONTH</th><th style='width:80px;'>TARGET</th><th style='width:80px;'>ACTUAL</th> <th style='width:80px;'>MARKS</th> <th style='width:80px;'>GPA</th></tr>" +
                "</thead>");
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1 pading5px">
                                          <a class="btn btn-primary primaryBtn" href='<%=this.ResolveUrl("~/F_05_MyPage/RptMIS02.aspx?Type=IndEmpHistory")%>' target="_blank" style="margin: 10px 0 0 5px; line-height: 18px;">NEXT</a>
