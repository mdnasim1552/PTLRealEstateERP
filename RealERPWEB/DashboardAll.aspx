<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="DashboardAll.aspx.cs" Inherits="RealERPWEB.DashboardAll" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <link href="assets/assets/css/animations.css" rel="stylesheet" />
    <link href="assets/assets/css/animate-custom.css" rel="stylesheet" />
        ...
        <ContentTemplate>--%>
            ...
            <div class="container moduleItemWrpper" >
                <div class="contentPart">
                    ...
                    <div class="row pt-page-moveFromRight bakimg">
                       

                        <div id='wrap' class="col-md-3"  style="background-image:url(Image1/consfinal.jpg); background-repeat:no-repeat;background-size:100% 100%;">
                        
                            <div class="col-md-12">
                                
                                 <div class="clock" id="clock"></div>
                                <div style="margin-top:-50px;">
                                     <div class='six small-12 columns contact-box space' style="margin-top: 10px;margin-left:72px;">
                                                <div >
                                        ...
                                        <div class="row">
                                                ...
                                                <div class='color-80'>
                                                 ...
                                                 <div class='color-80' style="padding-bottom: 0px;padding-top:0">
                                                    <%--<asp:LinkButton ID="lnkabp" runat="server" OnClick="lnkabp_Click"  style="padding-top:0px;">
                                                      ...
                                                      <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=05")%>" style="padding-top:0px;">
                                            ...
                                            <div class='six small-12 columns contact-box space' style="margin-bottom:4px;">
                                                <div class="color-con">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    ...
                                                    <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=07")%>" style="padding-top:0px;">
                                                          
                                                        <span class='box-title boxtex boxdsh'>2. Tender</span>
                                                         <br/> 
                                                ...
                                                <div class='color-80'>
                                                 ...
                                                 <div class='color-80' style="padding-bottom: 0px;padding-top:0">
                                                    ...
                                                    <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=04")%>" target="_self" style="padding-top:0px;">
                                            ...
                                            <div class='six small-12 columns contact-box space' style="margin-bottom:4px;">
                                                <div class="color-con">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    ...
                                                    <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=08")%>" target="_self" style="padding-top:0px;">
                                                ...
                                                <div class='color-80'>
                                                 ...
                                                 <div class='color-80' style="padding-bottom: 0px;padding-top:0">
                                                    ...
                                                    <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=09")%>" target="_self" style="padding-top:0px;">
                                            ...
                                            <div class='six small-12 columns contact-box space' style="margin-bottom:4px;">
                                                <div class="color-con">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    ...
                                                    <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=12")%>" style="padding-top:0px;">
                                                ...
                                                <div class='color-80'>
                                                 ...
                                                 <div class='color-80' style="padding-bottom: 0px;padding-top:0">
                                                    <a href="<%=this.ResolveUrl("~/F_99_Allinterface/RptPurInterface.aspx?Type=Report&comcod=")%>" target="_self" style="padding-top:0px;">
                                            ...
                                            <div class='six small-12 columns contact-box space' style="margin-bottom:4px;">
                                                <div class="color-con">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    <a href="<%=this.ResolveUrl("~/F_99_Allinterface/SubContractorBillInterface.aspx?Type=Report&comcod=")%>" target="_self" style="padding-top:0px;">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="color-80">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0"> 
                                                    <a href="<%=this.ResolveUrl("~/F_99_Allinterface/RptEngInterface.aspx")%>" target="_self" style="padding-top:0px;">
                                                ...
                                                <div class='color-con'>
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    ...
                                                    <a href="<%=this.ResolveUrl("~/F_15_DPayReg/BillRegInterface.aspx?Type=Report&comcod=")%>" target="_self" style="padding-top:0px;">
                                                ...
                                                <div class="color-80">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    ...
                                                    <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=16")%>" style="padding-top:0px;">
                                                ...
                                                <div class="color-80">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    ...
                                                    <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=29")%>" style="padding-top:0px;">
                                                ...
                                                <div class='color-con'>
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    <a href="<%=this.ResolveUrl("~/F_99_Allinterface/AccountInterface.aspx?Type=Report&comcod=")%>" target="_self" style="padding-top:0px;">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="color-das"">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    ...
                                                    <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=33")%>" style="padding-top:0px;">
                                                ...
                                                <div class="color-das">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    <%--<asp:LinkButton  ID="lnkconp" OnClick="lnkconp_Click"  runat="server"   style="padding-top:0px;">
                                                       ...
                                                       <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=35")%>" style="padding-top:0px;">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="color-das"">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                   ...
                                                   <%-- <a href="<%=this.ResolveUrl("~/StepofOperation.aspx?moduleid=04")%>"  target="_blank" style="padding-top:0px;">
                                                ...
                                                <div class="color-das">
                                                 ...
                                                 <div  style="padding-bottom: 0px;padding-top:0">
                                                    <a href="<%=this.ResolveUrl("~/HRMAllInOne.aspx")%>" target="_self" style="padding-top:0px;">
