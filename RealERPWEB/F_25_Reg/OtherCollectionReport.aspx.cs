...
{
    public partial class OtherCollectionReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ((Label)this.Master.FindControl("lblTitle")).Text = "Other's Collection Report ";
                this.Master.Page.Title = "Other's Collection Report ";
        ...
        {
            this.ShowOthersCollection();
        }

        private void ShowOthersCollection()
        {
            Session.Remove("tblOthers");
            ...
            DataSet ds1 = BgdData.GetTransInfo(comcod, "SP_REPORT_SALSMGT03", "TRANSACTIONSTATEMENTOTHERS", date1, date2, "", "", "", "", "", "", "");
            if (ds1 == null)
                return;

            Session["tblOthers"] = ds1.Tables[0];
            this.Data_Bind();
        ...
        private void Data_Bind()
        {
            ...
            this.grvTrnDatWise.DataSource = dt;
        ...
        {
            this.grvTrnDatWise.PageIndex = e.NewPageIndex;
            this.Data_Bind();
        }
    }
}