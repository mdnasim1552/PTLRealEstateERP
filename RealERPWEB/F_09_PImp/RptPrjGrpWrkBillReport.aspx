...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptPrjGrpWrkBillReport.aspx.cs" Inherits="RealERPWEB.F_09_PImp.RptPrjGrpWrkBillReport" %>
        ...
        <ContentTemplate>
            ...
            <div class="container moduleItemWrpper">
               ...
               <asp:MultiView ID="MultiView1" runat="server">
                        ...
                        <asp:View ID="billstatus" runat="server">
                                     ...
                                     <asp:TemplateField HeaderText="Head">
                                            <ItemTemplate>
                                                <asp:Label ID="lblhead" runat="server"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "rsirgrpdesc")) %>'
                     ...
                     <asp:View ID="billqty" runat="server">
                         <asp:GridView ID="gvbillqty" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ShowFooter="True" AllowPaging="true" OnPageIndexChanging="gvbillqty_PageIndexChanging">
                                    <PagerSettings Position="Top" />
                                    <RowStyle />
                               <Columns>
                                     ...
                                     <asp:TemplateField HeaderText="Head">
                                            <ItemTemplate>
                                                <asp:Label ID="lblheadqty" runat="server"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "rsirgrpdesc")) %>'
                                                    Width="200px"></asp:Label>
                                            </ItemTemplate>
                                          ...
                                          <asp:TemplateField HeaderText="Work Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblresdescqty" runat="server"
                                                    Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "rsirdesc")) %>'
                                                    Width="300px"></asp:Label>
                                            </ItemTemplate>
                                               <FooterTemplate>
                                                <asp:Label ID="lgvFgsirdesc" runat="server" Font-Bold="True" Font-Size="12px"
                                                    Style="text-align: right" Width="300px"></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle HorizontalAlign="Right" />
                                        ...
                                        <asp:TemplateField HeaderText="Actual Qty">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvbillqty" runat="server"
                                 ...
                                 <asp:TemplateField HeaderText="Daviation">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgvdaviation" runat="server"
                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "daviation")).ToString("#,##0.00;(#,##0.00); ") %>'
                                                    Width="100px"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFgvdaviation" runat="server" Font-Bold="True" Font-Size="12px"
                                                    Style="text-align: right" Width="90px"></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle HorizontalAlign="Right" />
                                            <ItemStyle HorizontalAlign="Right" />
