<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="PurLabRequisition.aspx.cs" Inherits="RealERPWEB.F_09_PImp.PurLabRequisition" %>
            ...
            <div class="card card-fluid mb-1 mt-2">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-1" style="margin-top: 22px;">
                            <asp:LinkButton ID="lbtnOk" runat="server" CssClass="btn btn-sm btn-primary" OnClick="lbtnOk_Click" TabIndex="11" Visible="true">Ok</asp:LinkButton>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlfloorno" runat="server" CssClass="chzn-select form-control  form-control-sm" OnSelectedIndexChanged="ddlfloorno_SelectedIndexChanged" TabIndex="12" AutoPostBack="True">
                                ...
                                <div class="col-md-1" style="margin-top: 22px;">
                                    <div class="form-group">
                                        <asp:LinkButton ID="lbtnSelect" runat="server" OnClick="lbtnSelect_Click" CssClass="btn btn-primary btn-sm"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddltrade" runat="server" CssClass="chzn-select form-control  form-control-sm" TabIndex="12">
                                                </asp:DropDownList>
