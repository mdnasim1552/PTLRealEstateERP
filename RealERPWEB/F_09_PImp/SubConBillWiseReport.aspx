<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="SubConBillWiseReport.aspx.cs" Inherits="RealERPWEB.F_09_PImp.SubConBillWiseReport" %>
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            ...
                            <div class="table table-responsive">
                                <asp:GridView ID="gvSubBill" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ShowFooter="True" OnSelectedIndexChanging="gvSubBill_SelectedIndexChanging" OnRowDataBound="gvSubBill_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Bill Date">
                                            ...
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFBillDate" runat="server" Font-Bold="True" Font-Size="12px"
                                        ...
                                        <asp:TemplateField HeaderText="Journal Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="lgvjournal" runat="server" Style="text-align: right"
                                                    Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "directamt")).ToString("#,##0.00;(#,##0.00); ") %>'
                                                    Width="70px"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFjournal" runat="server" Font-Bold="True"
                                        ...
                                        <asp:TemplateField HeaderText="Paid Amount">
                                            ...
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFpaidAmt" runat="server" Font-Bold="True"
                                                    Font-Size="12px" ForeColor="Black" Style="text-align: right"></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle Font-Bold="True" HorizontalAlign="Right" />
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                        ...
                                        <asp:TemplateField HeaderText="Balance">
                                            ...
                                            <FooterTemplate>
                                                <asp:Label ID="lgvFbalance" runat="server" Font-Bold="True"
                                                    Font-Size="12px" ForeColor="Black" Style="text-align: right"></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle Font-Bold="True" HorizontalAlign="Right" />
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
