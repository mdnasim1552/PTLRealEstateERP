<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="PurIssueWorkWiseEntry.aspx.cs" Inherits="RealERPWEB.F_09_PImp.PurIssueWorkWiseEntry" %>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-md-3 pading5px">
                                                ...
                                                <asp:DropDownList ID="ddlcatagory" OnSelectedIndexChanged="ddlcatagory_OnSelectedIndexChanged" runat="server" CssClass="ddlPage chzn-select  inputTxtinputTxt" Width="185px" TabIndex="12" AutoPostBack="True">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3 pading5px ">
                                            ...
                                            <asp:Label ID="lblfloorno" runat="server" CssClass=" smLbl_to" Text="Division"></asp:Label>
                                            ...
                                            <asp:LinkButton ID="LinkButton1" runat="server" Style="float: none; margin-top: -40px;" OnClick="lbtnSelect_Click" CssClass="btn btn-primary primaryBtn"
                                                TabIndex="17">Select</asp:LinkButton>

                                              <div class="col-md-2 pading5px" style="float: left;">
                                               
                                                <asp:Label ID="lblPage" runat="server" CssClass="lblTxt smLbl_to" Text="Page"></asp:Label>

                                                <asp:DropDownList ID="ddlpagesize" runat="server" AutoPostBack="True" CssClass="ddlPage" Style="width:109px;" OnSelectedIndexChanged="ddlpagesize_SelectedIndexChanged" TabIndex="18" >
