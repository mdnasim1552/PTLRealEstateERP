...
{
    public partial class RptPrjGrpWrkBillReport : System.Web.UI.Page
    {
        ...
        private DataTable HiddenSameData(DataTable dt)
        {
            ...
            switch (type)
            {
                ...
                case "BillQty":
                    ...
                    rsirgrp = dt.Rows[0]["rsirgrp"].ToString();



                    for (int j = 1; j < dt.Rows.Count; j++)
                    {
                        if (dt.Rows[j]["rsirgrp"].ToString() == rsirgrp)
                        {
                            dt.Rows[j]["rsirgrpdesc"] = "";
                        }

                        rsirgrp = dt.Rows[j]["rsirgrp"].ToString();
                    }
        ...
        private void GetBillQty()
        {
            ...
            DataSet ds1 = BgdData.GetTransInfo(comcod, "SP_REPORT_IMPEXECUTION", "GETPRJQTYWISEBILL", todate, pactcode, "", "", "", "", "", "", "");
            if (ds1 == null)
                return;
            //Session["tblconsddetails"] = HiddenSameData(ds1.Tables[0]);

            DataTable dt = HiddenSameData(ds1.Tables[0]);
            Session["billstatus"] = dt;
        ...
        private void GetBillStatus()
        {
            ...
            DataSet ds1 = BgdData.GetTransInfo(comcod, "SP_REPORT_IMPEXECUTION", "GETPRJGROUPWISEBILL", frmdate, todate, pactcode, "", "", "", "", "", "");
            if (ds1 == null)
                return;
            //Session["tblconsddetails"] = HiddenSameData(ds1.Tables[0]);
        ...
        private void Data_Bind()
        {
            ...
            switch (type)
            {
                ...
                case "BillStatus":
                    ...
                    break;
                case "BillQty":
                    this.gvbillqty.PageSize = Convert.ToInt32(this.ddlpagesize.SelectedValue.ToString());
                    this.gvbillqty.DataSource = dt;
                    this.gvbillqty.DataBind();
                    this.FooterCalculation(dt);
                    break;
        ...
        private void FooterCalculation(DataTable dt)
        {
            ...
            switch (type)
            {
                ...
                case "BillStatus":
                    ...
                    ((Label)this.gvbillstatus.FooterRow.FindControl("lgvFgvbilamt")).Text = Convert.ToDouble((Convert.IsDBNull(dt.Compute("sum(billamt)", "")) ? 0.00 :
        ...
        private void BillStatusPrint()
        {
            ...
            var rptlist = dt.DataTableToList<RealEntity.C_09_PIMP.EClassOrder.SubConGrpWBill>();

            LocalReport Rpt1a = new LocalReport();

            Rpt1a = RealERPRDLC.RptSetupClass1.GetLocalReport("R_09_PIMP.RptGrpWiseBill", rptlist, null, null);
        ...
        private void BillQtyPrint()
        {
            ...
            var rptlist = dt.DataTableToList<RealEntity.C_09_PIMP.EClassOrder.ProjwRptBillQty>();

            LocalReport Rpt1a = new LocalReport();

            Rpt1a = RealERPRDLC.RptSetupClass1.GetLocalReport("R_09_PIMP.RptProjWBillQty", rptlist, null, null);
            Rpt1a.EnableExternalImages = true;
            Rpt1a.SetParameters(new ReportParameter("comnam", comnam));
            Rpt1a.SetParameters(new ReportParameter("comadd", comadd));
            Rpt1a.SetParameters(new ReportParameter("FDate", daterange));
        ...
        protected void gvbillqty_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {

            this.gvbillqty.PageIndex = e.NewPageIndex;
            this.Data_Bind();
        }
    }
}