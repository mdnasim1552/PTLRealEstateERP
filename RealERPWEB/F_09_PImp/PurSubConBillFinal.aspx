<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="PurSubConBillFinal.aspx.cs" Inherits="RealERPWEB.F_09_PImp.PurSubConBillFinal" %>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row form-group">
                ...
                <div class="col-lg-1">
                    <asp:Label ID="lbldateTo" runat="server" Text="Ref No" Visible="true"></asp:Label>
                    <asp:TextBox ID="txtCBillRefNo" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                </div>
                <div class="col-lg-2">
                    <asp:Label ID="lblRefNo2" runat="server" Font-Bold="True" Text="Bill No" Visible="true"></asp:Label>
                    <div class="row">
                        <asp:Label ID="lblCurNo1" runat="server" CssClass="form-control form-control-sm col-6"></asp:Label>
                        <asp:Label ID="lblCurNo2" runat="server" CssClass="form-control form-control-sm col-6"></asp:Label>
                    </div>
                </div>
                <div class="col-lg-3">
                    <asp:Label ID="Label1" runat="server" Text="Project Name" CssClass="lblTxt lblName"></asp:Label>
                    <asp:DropDownList ID="ddlProjectName" runat="server"
                        AutoPostBack="True" CssClass="chzn-select form-control form-control-sm   chzn-select" OnSelectedIndexChanged="ddlProjectName_SelectedIndexChanged1">
                    </asp:DropDownList>
                </div>
                <div class="col-lg-3">
                    ...
                    <asp:DropDownList ID="ddlSubName" runat="server" OnSelectedIndexChanged="ddlSubName_SelectedIndexChanged"
                        AutoPostBack="True" CssClass="chzn-select form-controlform-control-sm   chzn-select">
                    </asp:DropDownList>
                </div>
            ...
            <div class="row form-group">
                <div class="col-lg-2">
                    <asp:Label ID="lblPreList" runat="server" CssClass="lblTxt lblName">Previous List :          
               <asp:LinkButton ID="ibtnPreBillList" runat="server" OnClick="ibtnPreBillList_Click" TabIndex="2"><i class="fa fa-search"> </i></asp:LinkButton>
                    </asp:Label>
                    <asp:DropDownList ID="ddlPrevBillList" runat="server"
                        AutoPostBack="True" CssClass="chzn-select form-control form-control-sm  ">
                    </asp:DropDownList>
                </div>

                <div class="col-lg-1">
                    <asp:Label ID="lblPage" runat="server" Text="Size:" Visible="False"></asp:Label>
                ...
                <div class="col-lg-2 mt20">
                    <asp:CheckBox ID="ChkTopSheet" runat="server" CssClass="mt20" AutoPostBack="True" Visible="false" Text="Top Sheet" />
                ...
                <div class="row form-group">
                    <div class="col-lg-3">
                        <asp:Label ID="lblRAList" runat="server"
                            Text="R/A List"></asp:Label>
                        <asp:DropDownList ID="ddlRAList" runat="server"
                            AutoPostBack="True" CssClass=" form-control form-control-sm chzn-select ">
                        </asp:DropDownList>
                    </div>

                    <div class="col-lg-2">
                        <asp:LinkButton ID="lbtnSelectRes" runat="server" CssClass="btn btn-primary btn-sm mt20" OnClick="lbtnSelectRes_Click">Select</asp:LinkButton>
            ...
            <asp:GridView ID="gvSubBill" runat="server" AllowPaging="True" CssClass=" table-striped table-hover table-bordered grvContentarea"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ref No">
                        <FooterTemplate>
                            <asp:LinkButton ID="lbtnTotal" runat="server"
                                OnClick="lbtnTotal_Click" CssClass="btn  btn-primary  btn-sm">Total</asp:LinkButton>
                        </FooterTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Con. Qty">
                        <ItemTemplate>
                            <asp:TextBox ID="txtgvconqty" runat="server" Style="text-align: right" CssClass="form-control form-control-sm"
                    ...
                    <asp:TemplateField HeaderText="Rate">
                        <ItemTemplate>
                            <asp:TextBox ID="lgvSubRate" runat="server" Style="text-align: right; " CssClass="form-control form-control"
            ...
            <asp:Panel ID="PnlProRemarks" runat="server" Visible="False">
                <div class="form-group row">
                    <div class="col-lg-2">
                        ...
                        <asp:TextBox ID="txtpercentage" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                    </div>
                    <div class="col-lg-1">

                        <asp:LinkButton ID="lbtnDepost" runat="server" OnClick="lbtnDepost_Click">Amt</asp:LinkButton>
                        <asp:TextBox ID="txtSDAmount" runat="server" CssClass=" form-control form-control-sm"></asp:TextBox>
                    </div>

                    <div class="col-lg-1">
                        <asp:Label ID="lbldeduction" runat="server" Text="Deduction:"></asp:Label>
                        <asp:TextBox ID="txtDedAmount" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                    </div>
                    <div class="col-lg-1">

                        <asp:Label ID="lblpenalty" runat="server" Text="Penalty:"></asp:Label>
                        <asp:TextBox ID="txtPenaltyAmount" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                    </div>
                    <div class="col-lg-1">
                        <asp:Label ID="lblAdvanced" runat="server" Text="Penalty:"></asp:Label>
                        <asp:TextBox ID="txtAdvanced" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                    </div>
                    <div class="col-lg-1">
                        <asp:Label ID="lblReward" runat="server" Text="Penalty:"></asp:Label>
                        <asp:TextBox ID="txtreward" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                    </div>
                    <div class="col-lg-1">
                        <asp:Label ID="lblnettotal" runat="server"
                            Text="Net Total:"></asp:Label>
                                 <asp:Label ID="lblvalnettotal" runat="server" ></asp:Label>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <asp:Label ID="lblAdvpay" runat="server"
                            Text="Advanced Payment"></asp:Label>
                        <asp:TextBox ID="txtadvpay" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                    </div>

                    <div class="col-lg-1">

                        <a href="<%=this.ResolveUrl ("~/F_09_PImp/RptConTractorBillAll")%>" target="_blank" class="btn btn-info btn-sm mt20" >Details<span class="fa fa-history"></span></a>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-2 ">
                        ...
                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="form-control form-control-sm" TextMode="MultiLine" Style="height: 50px;"></asp:TextBox>
                    ...
                    <div class="col-lg-2">
                        ...
                        <asp:DropDownList ID="ddlbilltype" runat="server"
                            CssClass="form-control form-control-sm" Style="width: 115px; background-color: orange">
                        </asp:DropDownList>
