<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptSunConOverAll.aspx.cs" Inherits="RealERPWEB.F_09_PImp.RptSunConOverAll" %>
                        ...
                        <fieldset class="scheduler-border fieldset_B">
                           ...
                           <div class="table table-responsive">
                                <asp:GridView ID="gvSubBill" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ShowFooter="True" OnRowDataBound="gvSubBill_RowDataBound">
