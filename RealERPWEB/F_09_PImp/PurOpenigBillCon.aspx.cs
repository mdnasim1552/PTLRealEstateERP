...
{
    public partial class PurOpenigBillCon : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //((Label)this.Master.FindControl("lblTitle")).Text = "Sub-Contractor Bill Opening";
        ...
        private void GetContractor()
        {
            ...
            DataSet ds1 = MktData.GetTransInfo(comcod, "SP_ENTRY_OPENINGINVABILL", "GETCONTRACTOR", Supplier, "", "", "", "", "", "", "", "");
            this.ddlSupplier.DataTextField = "csirdesc";
            this.ddlSupplier.DataValueField = "csircode";
        ...
        private void ShowOpenBill()
        {
            ...
            DataSet ds4 = MktData.GetTransInfo(comcod, "SP_ENTRY_OPENINGINVABILL", "SHOWCONOPENINGBILL", pactcode, ssircode, "", "", "", "", "", "", "");
        ...
        private string GetBILLNo()
        {
            ...
            string comcod = this.GetCompCode();
            DataSet ds3 = MktData.GetTransInfo(comcod, "SP_ENTRY_OPENINGINVABILL", "GETOPENCNBILLNO", "", "", "", "", "", "", "", "", "");
        ...
        protected void gvMoney_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool result = MktData.UpdateTransInfo(comcod, "SP_ENTRY_OPENINGINVABILL", "DELETEOPNCONBILLNO", billno, "", "", "", "", "", "", "", "", "", "", "", "", "", "");
        ...
        protected void lbtnUpdateMoney_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in dt1.Rows)
            {
                ...
                result = MktData.UpdateTransInfo(comcod, "SP_ENTRY_OPENINGINVABILL", "INSERTORUPCONOBILL", billno, billdate, pactcode, ssircode, billref, mrno, chlnno, billamt, rmrks, "", "", "", "", "", "");
