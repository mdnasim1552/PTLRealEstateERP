...
<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="LinkSubContractorSd02.aspx.cs" Inherits="RealERPWEB.F_09_PImp.LinkSubContractorSd02" %>
                                ...
                                <asp:GridView ID="gvSubBill" runat="server" AutoGenerateColumns="False" CssClass=" table-striped table-hover table-bordered grvContentarea"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Nature of Work">
                                            <ItemTemplate>
                                                <asp:Label ID="lgvPrjnature" runat="server"
