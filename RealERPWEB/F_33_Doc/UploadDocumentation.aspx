<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="UploadDocumentation.aspx.cs" Inherits="RealERPWEB.F_33_Doc.UploadDocumentation" ValidateRequest="false" UnobtrusiveValidationMode="None" %>
        ...
        <ContentTemplate>
            <div class="RealProgressbar">
                ...
                <div class="card-body">
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <p class="text-right">
                                                <asp:LinkButton ID="lnk_save" ValidationGroup="group1" CssClass="btn btn-success btn-sm mt-1" runat="server" OnClick="lnk_save_Click">Save</asp:LinkButton>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card mt-3" style="overflow:scroll;max-height:618px;">
                                <div class="card-header bg-light" style="padding:11px;">
                                    <div>
                                        <asp:RadioButtonList ID="datatype" runat="server" AutoPostBack="True"
                                            ...
                                            <asp:ListItem>Uniting Metric</asp:ListItem>
