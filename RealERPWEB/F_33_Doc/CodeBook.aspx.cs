...
{
    public partial class CodeBook : System.Web.UI.Page
    {

        ProcessAccess da = new ProcessAccess("ASITDOC");
        ...
        protected void Load_CodeBooList()
        {
            ...
            try
            {
                ...
                DataSet dsone = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "GETCODE", "",
                                "", "", "", "", "", "", "", "");
        ...
        protected void grvacc_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string comcod = this.GetCompCode();
            string ccodee1 = ((Label)grvacc.Rows[e.RowIndex].FindControl("lblgrcode")).Text.Trim();
            string ccodee2 = ((TextBox)grvacc.Rows[e.RowIndex].FindControl("txtgrcode")).Text.Trim();

            string Desc = ((TextBox)grvacc.Rows[e.RowIndex].FindControl("txtgvDesc")).Text.Trim();
            string tccode = ccodee1.Substring(0, 2) + ccodee2.Substring(0, 2) + ASTUtility.Right(ccodee2, 3);
            string cdesc = ((TextBox)this.grvacc.Rows[e.RowIndex].FindControl("txtgvDesc")).Text.Trim();

            bool result = da.UpdateTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "INSRTUPDATECODE", tccode,
                           cdesc, "", "", "", "", "", "", "", "", "", "", "", "", "");
            ...
            {
                string eventtype = "Code Book";
                string eventdesc = "Update CodeBook";
                string eventdesc2 = tccode;
        ...
        protected void lnkPrint_Click(object sender, EventArgs e)
        {
            ...
            //ReportDocument rptAccCode = new EntertainmentRPT.R_21_Acc.rptOthersAccCode();
        ...
        {
            string comcod = this.GetCompCode();
            string tempddl1 = ((this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2) == "00") ? "%" : (this.ddlOthersBook.SelectedValue.ToString()).Substring(0, 2);
            string tempddl2 = this.ddlOthersBookSegment.SelectedValue.ToString().Trim();

            DataSet ds1 = this.da.GetTransInfo(comcod, "SP_ENTRY_CODEBOOK02", "SHOWCODEINFO", tempddl1,
                            tempddl2, "", "", "", "", "", "", "");
