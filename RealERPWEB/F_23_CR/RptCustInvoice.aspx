<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="RptCustInvoice.aspx.cs" Inherits="RealERPWEB.F_23_CR.RptCustInvoice" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2 asitCol2 pading5px">
                                        <asp:DropDownList ID="ddlCustName" runat="server" CssClass=" ddlPage" Width="310px" TabIndex="5">
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-4 asitCol4 pading5px">
                                        ...
                                        <asp:Label ID="lbltoDate" runat="server" CssClass="smLbl_to" Text="Date:"></asp:Label>

                                        <asp:TextBox ID="txttodate" runat="server" BorderStyle="None"
                                            CssClass="inputtextbox"  TabIndex="7"></asp:TextBox>
