                            ...
                            <div class="card-body">
                                <asp:MultiView ID="MultiView1" runat="server">
                                    ...
                                    <asp:View ID="ViewmonthlycollSchedule" runat="server">
                                        ...
                                        <h6>Accounts ERP Data</h6>
                                        <hr />
                                        <div class="table table-responsive">
                                            <asp:GridView ID="gvAccMonColSch" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvmoncollsch_RowDataBound" CssClass=" table-striped table-bordered grvContentarea"
                                                ShowFooter="False">
                                                <RowStyle />
                                                <Columns>
                                        ...
                                        <div class="table table-responsive">
                                            <asp:GridView ID="gvAccTotAmt" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvmoncollsch_RowDataBound" CssClass=" table-striped table-bordered grvContentarea"
                                                ShowFooter="False">
                                                <RowStyle />
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lgvcdate" runat="server" Text=""
                                                                Width="70px"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" />
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                    ...
                                                    <asp:TemplateField HeaderText="">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lgvcustname" runat="server"
                                                                Text="Total Amount" Font-Bold="true"
                                                                Width="200px"></asp:Label>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:Label ID="lgvTotalnagad" runat="server" Font-Bold="True" Font-Size="12px"
                                                    ...
                                                    <asp:TemplateField HeaderText="">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lgvudesc" runat="server" Text=""
                                                                Width="100px"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" />
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                    ...
                                                    <asp:TemplateField HeaderText="">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lgvschdesc" runat="server" Text=""
                                                                Width="100px"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" />
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" />
