                            ...
                            <div class="card-body">
                                <asp:MultiView ID="MultiView1" runat="server">
                                            ...
                                            <asp:GridView ID="gvmoncollsch" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvmoncollsch_RowDataBound" CssClass=" table-striped table-bordered grvContentarea"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lgvusircode" runat="server" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "usircode"))%>'
                                    ...
                                    <asp:View ID="ViewMonthyCollection" runat="server">
                                        <div class="table table-responsive">
                                            <asp:GridView ID="gvmoncoll" runat="server" AutoGenerateColumns="false" CssClass="table-striped table-bordered" OnRowDataBound="gvmoncoll_RowDataBound" OnPageIndexChanging="gvmoncoll_PageIndexChanging"
                                                ShowFooter="True">
                                                <RowStyle />
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Sl">
