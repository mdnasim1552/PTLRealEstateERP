...
{
    public partial class EntryFixAssetITStock : System.Web.UI.Page
    {
        ...
        protected void Load_Project_From_Combo()
        {
            ...
            string comcod = hst["comcod"].ToString();
            string fproject = "%";
            DataSet ds1 = purData.GetTransInfo(comcod, "SP_ENTRY_FIXEDASSET_INFO03", "GET_From_Dept_ASSETNFO", fproject, "", "", "", "", "", "", "", "");
            if (ds1 == null)
                return;

            this.ddlfrmDept.DataTextField = "actdesc";
            this.ddlfrmDept.DataValueField = "actcode";
            this.ddlfrmDept.DataSource = ds1.Tables[0];
            this.ddlfrmDept.DataBind();
        ...
        protected void lbtnOk_Click(object sender, EventArgs e)
        {
            ...
            if (lbtnOk.Text.Trim() == "Ok")
            {
                ...
                if (this.ddlPrevISSList.Items.Count > 0)
                {
                    ...
                    this.ddlprjlistfrom_SelectedIndexChanged(null, null);
                    this.ddltoDept.SelectedValue = ds.Tables[1].Rows[0]["ttpactcode"].ToString();
                    Session["sessionforgrid"] = dt1;
                    this.grvacc_DataBind();
        ...
        protected void lnkPrint_Click(object sender, EventArgs e)
        {
            ...
            string prjfrm = "Transfer From: " + this.ddlfrmDept.SelectedItem.Text.Trim().Substring(13);
            string prjto = "Transfer To: " + this.ddltoDept.SelectedItem.Text.Trim().Substring(13);
