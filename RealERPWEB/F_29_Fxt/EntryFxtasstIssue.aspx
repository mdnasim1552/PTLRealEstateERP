<%@ Page Title="" Language="C#" MasterPageFile="~/ASITMaster.Master" AutoEventWireup="true" CodeBehind="EntryFxtasstIssue.aspx.cs" Inherits="RealERPWEB.F_29_Fxt.EntryFxtasstIssue" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-md-8   pading5px  asitCol8">
                                         ...
                                         <asp:Label ID="Label1" runat="server" CssClass="smLbl_to" Text="Issue No :"></asp:Label>
                                          <asp:TextBox ID="txtIssueNo" runat="server" CssClass="inputTxt inputDateBox" TabIndex="3" ReadOnly="true"></asp:TextBox>   
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-md-4 pading5px" >
                                       ...
                                       <asp:DropDownList ID="ddldeptName" runat="server" Width="350px" CssClass="chzn-select ddlPage" TabIndex="6" AutoPostBack="true">
                                        </asp:DropDownList>
                     ...
                     <asp:Panel ID="pnlgrd" runat="server" Visible="False">
                        <div class="form-group">
                            <div class="col-md-4  pading5px">                                                                                              
                                ...
                                <asp:DropDownList ID="ddlreslist" runat="server" Width="350px" CssClass="chzn-select ddlPage"></asp:DropDownList>
                                

                            </div>
                             <div class="col-md-1 pading5px">
                            <asp:LinkButton ID="lnkselect" runat="server" CssClass="btn btn-primary " OnClick="lnkselect_Click">Add</asp:LinkButton>
                             </div>
                        </div>
                        </asp:Panel>
                        </div>
                   ...
                   <div class="table table-responsive">                      
                    <asp:GridView ID="gvEmpIssue" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered grvContentarea"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText=" Floor">
                                ...
                                <FooterTemplate>
                                <asp:LinkButton ID="TblTotal" runat="server" CssClass="btn btn-primary primaryBtn" OnClick="TblTotal_Click" >Total</asp:LinkButton>
                                </FooterTemplate>
                                </asp:TemplateField>
